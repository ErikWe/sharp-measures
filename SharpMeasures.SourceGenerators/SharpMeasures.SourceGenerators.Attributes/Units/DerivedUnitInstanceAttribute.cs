...
public sealed class DerivedUnitInstanceAttribute : Attribute
{
    ...
    /// <param name="instanceNames">The names of the instances of other units from which this instance is derived. The order must match that of <paramref name="signature"/>.</param>
    public DerivedUnitInstanceAttribute(string name, string plural, Type[] signature, string[] instanceNames)
    {
        Name = name;
        Plural = plural;
