...
{
    /// <summary>The biased quantity that the unit describes.</summary>
    public Type BiasedQuantity { get; }
    /// <summary>The unbiased quantity that the unit describes, or <see langword="null"/> if none exists.</summary>
    ...
    /// <param name="biasedQuantity">The biased quantity that the unit describes.</param>
    /// <param name="unbiasedQuantity">The unbiased quantity that the unit describes.</param>
