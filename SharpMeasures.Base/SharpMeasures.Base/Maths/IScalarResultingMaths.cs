...
public interface IScalarResultingMaths<TResult> where TResult : IScalarQuantity<TResult>
{
    ...
    public abstract TResult Square<TSquareRoot>(TSquareRoot squareRoot) where TSquareRoot : IScalarQuantity;
    ...
    public abstract TResult Cube<TCubeRoot>(TCubeRoot cubeRoot) where TCubeRoot : IScalarQuantity;
    ...
    public abstract TResult SquareRoot<TSquare>(TSquare square) where TSquare : IScalarQuantity;
    ...
    public abstract TResult CubeRoot<TCube>(TCube cube) where TCube : IScalarQuantity;

    /// <summary>Computes the magnitude of <paramref name="vector"/>.</summary>
    ...
    public abstract TResult Magnitude2<TVector>(TVector vector) where TVector : IVector2Quantity;
    ...
    public abstract TResult Magnitude3<TVector>(TVector vector) where TVector : IVector3Quantity;
    ...
    public abstract TResult Magnitude4<TVector>(TVector vector) where TVector : IVector4Quantity;

    /// <summary>Computes the square of the magnitude of <paramref name="vector"/>.</summary>
    ...
    public abstract TResult SquaredMagnitude2<TVector>(TVector vector) where TVector : IVector2Quantity;

    /// <summary>Computes the square of the magnitude of <paramref name="vector"/>.</summary>
    /// <typeparam name="TVector">The three-dimensional vector quantity for which the squared magnitude is computed.</typeparam>
    /// <param name="vector">The squared magnitude of this <typeparamref name="TVector"/> is computed.</param>
    public abstract TResult SquaredMagnitude3<TVector>(TVector vector) where TVector : IVector3Quantity;

    /// <summary>Computes the square of the magnitude of <paramref name="vector"/>.</summary>
    /// <typeparam name="TVector">The four-dimensional vector quantity for which the squared magnitude is computed.</typeparam>
    /// <param name="vector">The squared magnitude of this <typeparamref name="TVector"/> is computed.</param>
    public abstract TResult SquaredMagnitude4<TVector>(TVector vector) where TVector : IVector4Quantity;
