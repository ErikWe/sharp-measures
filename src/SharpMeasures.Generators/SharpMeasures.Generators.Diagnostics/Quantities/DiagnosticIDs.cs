...
public static partial class DiagnosticIDs
{
    ...
    public const string InvalidExpressionForConstant = $"{Prefix}{Numbering.Hundreds.Quantities}25";
    public const string QuantityConvertibleToSelf = $"{Prefix}{Numbering.Hundreds.Quantities}26";
