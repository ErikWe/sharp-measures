...
public abstract class AValidator<TContext, TDefinition> : IValidator<TContext, TDefinition> where TContext : IValidationContext
{
    public abstract IValidityWithDiagnostics Validate(TContext context, TDefinition definition);
}

public abstract class AActionableValidator<TContext, TDefinition> : AValidator<TContext, TDefinition>, IActionableValidator<TContext, TDefinition> where TContext : IValidationContext
{
