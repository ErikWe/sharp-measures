...
public sealed record class SimpleProcessingContext : IProcessingContext
{
...
public interface IProcesser<in TContext, in TDefinition, TProduct> where TContext : IProcessingContext
{
    public abstract IOptionalWithDiagnostics<TProduct> Process(TContext context, TDefinition definition);
}

public interface IActionableProcesser<in TContext, in TDefinition, TProduct> : IProcesser<TContext, TDefinition, TProduct> where TContext : IProcessingContext
{
...
public interface IReprocesser<in TContext, in TDefinition, TProduct> where TContext : IProcessingContext
{
    public abstract IOptionalWithDiagnostics<TProduct> Reprocess(TContext context, TDefinition definition, TProduct product);
}

public interface IActionableReprocesser<in TContext, in TDefinition, TProduct> : IReprocesser<TContext, TDefinition, TProduct> where TContext : IProcessingContext
{
