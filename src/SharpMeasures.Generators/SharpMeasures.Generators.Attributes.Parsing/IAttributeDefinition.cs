...
public interface IOpenAttributeDefinition<out TDefinition, TLocations> : IAttributeDefinition<TLocations> where TDefinition : IOpenAttributeDefinition<TDefinition, TLocations> where TLocations : IAttributeLocations
{
