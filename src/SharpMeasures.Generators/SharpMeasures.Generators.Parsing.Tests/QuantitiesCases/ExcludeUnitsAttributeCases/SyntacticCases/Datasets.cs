...
internal static class Datasets
{
    ...
    public sealed class ParserSources : ATestDataset<IConstructiveSyntacticAttributeParser<IRawExcludeUnits>>
    {
        protected override IEnumerable<IConstructiveSyntacticAttributeParser<IRawExcludeUnits>> GetSamples() => new[]
        {
            DependencyInjection.GetRequiredService<IConstructiveSyntacticAttributeParser<IRawExcludeUnits>>()
        };
    }
}
