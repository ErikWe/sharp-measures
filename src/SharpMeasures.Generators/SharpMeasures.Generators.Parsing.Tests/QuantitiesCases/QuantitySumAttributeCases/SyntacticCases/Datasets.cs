...
internal static class Datasets
{
    ...
    public sealed class ParserSources : ATestDataset<IConstructiveSyntacticAttributeParser<IRawQuantitySum>>
    {
        protected override IEnumerable<IConstructiveSyntacticAttributeParser<IRawQuantitySum>> GetSamples() => new[]
        {
            DependencyInjection.GetRequiredService<IConstructiveSyntacticAttributeParser<IRawQuantitySum>>()
        };
    }
}
