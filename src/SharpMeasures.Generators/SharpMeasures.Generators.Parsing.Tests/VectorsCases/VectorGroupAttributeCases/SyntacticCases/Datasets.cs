...
internal static class Datasets
{
    ...
    public sealed class ParserSources : ATestDataset<IConstructiveSyntacticAttributeParser<IRawVectorGroup>>
    {
        protected override IEnumerable<IConstructiveSyntacticAttributeParser<IRawVectorGroup>> GetSamples() => new[]
        {
            DependencyInjection.GetRequiredService<IConstructiveSyntacticAttributeParser<IRawVectorGroup>>()
        };
    }
}
