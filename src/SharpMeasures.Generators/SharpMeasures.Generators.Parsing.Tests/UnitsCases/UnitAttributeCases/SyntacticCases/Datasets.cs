...
internal static class Datasets
{
    ...
    public sealed class ParserSources : ATestDataset<IConstructiveSyntacticAttributeParser<IRawUnit>>
    {
        protected override IEnumerable<IConstructiveSyntacticAttributeParser<IRawUnit>> GetSamples() => new[]
        {
            DependencyInjection.GetRequiredService<IConstructiveSyntacticAttributeParser<IRawUnit>>()
        };
    }
}
