...
internal abstract record class AModifiedUnitInstanceSyntax : AUnitInstanceSyntax, IModifiedUnitInstanceSyntax
{
    ...
    protected AModifiedUnitInstanceSyntax(Location attributeName, Location name, Location pluralForm, Location originalUnitInstance) : base(attributeName, name, pluralForm)
    {
