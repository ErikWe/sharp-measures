...
public class Subtract_Unhandled_TScalar
{
    private static Unhandled Target<TScalar>(Unhandled x, TScalar y) where TScalar : IScalarQuantity => Unhandled.Subtract(x, y);
