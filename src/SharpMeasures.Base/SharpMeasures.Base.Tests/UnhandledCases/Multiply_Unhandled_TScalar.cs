...
public class Multiply_Unhandled_TScalar
{
    private static Unhandled Target<TScalar>(Unhandled x, TScalar y) where TScalar : IScalarQuantity => Unhandled.Multiply(x, y);
