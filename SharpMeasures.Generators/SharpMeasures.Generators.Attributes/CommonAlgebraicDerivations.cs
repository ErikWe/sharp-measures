...
{
    /// <summary>Multiplication of two items, { A ⋅ B }.</summary>
    public const string Multiplication = "{0} * {1}";

    /// <summary>Division of the first item by the second, { A / B }.</summary>
    public const string Division = "{0} / {1}";

    /// <summary>Addition of two items, { A + B }.</summary>
    public const string Addition = "{0} + {1}";

    /// <summary>Subtraction of the second item from the first, { A - B }.</summary>
