...
public interface IQuantityProcess : IAttributeDefinition
{
    ...
    new public abstract IQuantityProcessLocations Locations { get; }
}

public interface IQuantityProcessLocations : IAttributeLocations
{
