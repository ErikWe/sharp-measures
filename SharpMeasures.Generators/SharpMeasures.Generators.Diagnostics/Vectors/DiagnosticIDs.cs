...
public static partial class DiagnosticIDs
{
    ...
    public const string VectorNameAndDimensionConflict = $"{Prefix}{Numbering.Hundreds.Vectors}24";
    public const string VectorGroupNameSuggestsDimension = $"{Prefix}{Numbering.Hundreds.Vectors}25";
