...
public class Antidirectional
{
    ...
    private static string DefaultsText => """
        ...
        [ConvertibleQuantity(typeof(Position3), ConversionDirection = QuantityConversionDirection.Antidirectional)]
    ...
    private static string SpecifiedBehaviourText(string behaviour) => $$"""
        ...
        [ConvertibleQuantity(typeof(Position3), ConversionDirection = QuantityConversionDirection.Antidirectional, CastOperatorBehaviour = ConversionOperatorBehaviour.{{behaviour}})]
        [SharpMeasuresVector(typeof(UnitOfLength))]
        public partial class Displacement3 { }
