//HintName: Temperature_Common.g.cs
//----------------------
// <auto-generated>
    ...
    global::System.IEquatable<global::Temperature>
{
    ...
    /// <remarks>In most cases, expressing the magnitude in a certain <see cref="global::UnitOfTemperature"/> should be preferred. This is achieved through <see cref="InUnit(global::UnitOfTemperature)"/>.</remarks>
    ...
    /// a certain <see cref="global::UnitOfTemperature"/>.</remarks>
    public Temperature(global::SharpMeasures.Scalar magnitude)
    {
        Magnitude = magnitude;
    }

    /// <summary>Constructs a new <see cref="global::Temperature"/> representing { <paramref name="magnitude"/> }, expressed in <paramref name="unitOfTemperature"/>.</summary>
    /// <param name="magnitude">The magnitude represented by the constructed <see cref="global::Temperature"/>, expressed in <paramref name="unitOfTemperature"/>.</param>
    /// <param name="unitOfTemperature">The <see cref="global::UnitOfTemperature"/> in which the magnitude, <paramref name="magnitude"/>, is expressed.</param>
    ...
    /// <summary>Produces a description of <see langword="this"/> containing the type and the magnitude expressed in an arbitrary unit.</summary>
    public override string ToString() => $"{Magnitude.Value}";
