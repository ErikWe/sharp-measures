    ...
    global::System.IEquatable<global::Length>
{
    ...
    /// <remarks>In most cases, expressing the magnitude in a certain <see cref="global::UnitOfLength"/> should be preferred. This is achieved through <see cref="InUnit(global::UnitOfLength)"/>.</remarks>
    ...
    /// a certain <see cref="global::UnitOfLength"/>.</remarks>
    public Length(global::SharpMeasures.Scalar magnitude)
    {
        Magnitude = magnitude;
    }

    /// <summary>Constructs a new <see cref="global::Length"/> representing { <paramref name="magnitude"/> }, expressed in <paramref name="unitOfLength"/>.</summary>
    /// <param name="magnitude">The magnitude represented by the constructed <see cref="global::Length"/>, expressed in <paramref name="unitOfLength"/>.</param>
    /// <param name="unitOfLength">The <see cref="global::UnitOfLength"/> in which the magnitude, <paramref name="magnitude"/>, is expressed.</param>
