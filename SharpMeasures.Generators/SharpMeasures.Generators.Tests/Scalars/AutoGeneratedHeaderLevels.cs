...
public class AutoGeneratedHeaderLevels
{
    ...
    private static Task Verify(string level) => GeneratorVerifier.Construct<SharpMeasuresGenerator>(Text, Options(level)).AssertNoDiagnosticsReported().VerifyMatchingSourceNames("Length.Common.g.cs");
    ...
    private static AnalyzerConfigOptionsProvider Options(string level)
    {
