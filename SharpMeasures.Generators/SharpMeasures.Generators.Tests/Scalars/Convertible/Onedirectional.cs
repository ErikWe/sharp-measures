...
public class Onedirectional
{
    ...
    private static string UnbiasedScalarText => """
        ...
        [ConvertibleQuantity(typeof(Length), ConversionDirection = QuantityConversionDirection.Onedirectional)]
    ...
    private static string BiasedScalarText => """
        ...
        [ConvertibleQuantity(typeof(Temperature), ConversionDirection = QuantityConversionDirection.Onedirectional)]
