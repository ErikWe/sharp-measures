...
public class DuplicateUnitPluralForm
{
    ...
    private static GeneratorVerifier AssertAlias()
    {
        ...
        return AssertExactlyDuplicateUnitPluralFormDiagnostics(AliasText).AssertDiagnosticsLocation(expectedLocation, AliasText);
    }
    ...
    private static GeneratorVerifier AssertBiased()
    {
        ...
        return AssertExactlyDuplicateUnitPluralFormDiagnostics(BiasedText).AssertDiagnosticsLocation(expectedLocation, BiasedText);
    }
    ...
    private static GeneratorVerifier AssertDerived()
    {
        ...
        return AssertExactlyDuplicateUnitPluralFormDiagnostics(Derivedtext).AssertDiagnosticsLocation(expectedLocation, Derivedtext);
    }
    ...
    private static GeneratorVerifier AssertPrefixed()
    {
        ...
        return AssertExactlyDuplicateUnitPluralFormDiagnostics(PrefixedText).AssertDiagnosticsLocation(expectedLocation, PrefixedText);
    }
    ...
    private static GeneratorVerifier AssertScaled()
    {
        ...
        return AssertExactlyDuplicateUnitPluralFormDiagnostics(ScaledText).AssertDiagnosticsLocation(expectedLocation, ScaledText);
    }
}
