...
internal readonly record struct DataModel
{
    ...
    public DataModel(DefinedType unit, NamedType quantity, bool biasTerm, FixedUnitInstanceDefinition? fixedUnitInstance, IEnumerable<UnitInstanceAliasDefinition> unitInstanceAliases, IEnumerable<DerivedUnitInstanceDefinition> derivedUnitInstances,
        IEnumerable<BiasedUnitInstanceDefinition> biasedUnitInstances, IEnumerable<PrefixedUnitInstanceDefinition> prefixedUnitInstances, IEnumerable<ScaledUnitInstanceDefinition> scaledUnitInstances, IReadOnlyDictionary<string, IDerivableUnit> derivationsByID, SourceBuildingContext sourceBuildingContext)
    {
        Unit = unit;
        Quantity = quantity;
