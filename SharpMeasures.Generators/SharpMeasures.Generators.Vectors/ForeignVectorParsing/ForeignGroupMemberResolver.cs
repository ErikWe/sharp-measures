...
public static class ForeignGroupMemberResolver
{
    public static Optional<IResolvedVectorType> Resolve(IVectorGroupMemberType vectorType, IUnitPopulation unitPopulation, IVectorPopulation vectorPopulation)
    {
        ...
        return new ResolvedVectorType(vectorType.Type, MinimalLocation.None, vectorType.Definition.Dimension, unit.Type.AsNamedType(), scalar, implementSum!.Value, implementDifference!.Value,
    ...
    private static NamedType? ResolveDifference(IVectorGroupMemberType vectorType, IVectorPopulation vectorPopulation)
    {
    ...
    private static IReadOnlyList<T> CollectItems<T>(IVectorGroupMemberType vectorType, IVectorPopulation vectorPopulation, Func<IVectorGroupMemberType, IEnumerable<T>> memberItemsDelegate, Func<IVectorGroupType, IEnumerable<T>> groupItemsDelegate,
    ...
    private static IReadOnlyList<string> ResolveUnitInstanceInclusions(IVectorGroupMemberType vectorType, IVectorPopulation vectorPopulation, IUnitType unit)
    {
