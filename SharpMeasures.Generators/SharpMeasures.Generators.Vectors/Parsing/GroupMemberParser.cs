...
{
    protected override RawGroupMemberType ProduceResult(DefinedType type, RawSharpMeasuresVectorGroupMemberDefinition definition, IEnumerable<RawDerivedQuantityDefinition> derivations, IEnumerable<RawProcessedQuantityDefinition> processes,
