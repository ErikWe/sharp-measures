...
internal abstract class AUnitDiagnostics<TRawDefinition> : IUnitProcessingDiagnostics<TRawDefinition>
    where TRawDefinition : IRawUnitDefinition
{
    ...
    public Diagnostic DuplicateUnitPluralForm(IUnitProcessingContext context, TRawDefinition definition)
    {
