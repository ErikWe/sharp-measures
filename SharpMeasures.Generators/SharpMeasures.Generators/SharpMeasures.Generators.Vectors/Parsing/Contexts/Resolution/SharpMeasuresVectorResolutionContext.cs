...
internal record class SharpMeasuresVectorResolutionContext : SimpleProcessingContext, ISharpMeasuresVectorResolutionContext
{
    ...
    public SharpMeasuresVectorResolutionContext(DefinedType type, IRawUnitPopulation unitPopulation, IRawScalarPopulation scalarPopulation, IUnresolvedVectorPopulationWithData vectorPopulation) : base(type)
    {
