...
internal record class RawSpecializedScalarType : IRawScalarType
{
    public DefinedType Type { get; }
    public MinimalLocation TypeLocation { get; }

    public RawSpecializedSharpMeasuresScalarDefinition ScalarDefinition { get; }
    ...
    public RawSpecializedScalarType(DefinedType scalarType, MinimalLocation scalarLocation, RawSpecializedSharpMeasuresScalarDefinition scalarDefinition,
