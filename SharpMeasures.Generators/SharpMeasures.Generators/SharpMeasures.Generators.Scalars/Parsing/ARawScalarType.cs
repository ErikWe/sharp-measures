...
internal abstract record class ARawScalarType
{
    ...
    public IEnumerable<RawConvertibleQuantityDefinition> ConvertibleScalars => convertibleScalars;
    ...
    private EquatableEnumerable<RawConvertibleQuantityDefinition> convertibleScalars { get; }
    ...
    protected ARawScalarType(DefinedType type, MinimalLocation typeLocation, IEnumerable<RawDerivedQuantityDefinition> derivations,
        IEnumerable<RawScalarConstantDefinition> constants, IEnumerable<RawConvertibleQuantityDefinition> convertibleScalars, IEnumerable<RawUnitListDefinition> baseInclusions,
        IEnumerable<RawUnitListDefinition> baseExclusions, IEnumerable<RawUnitListDefinition> unitInclusions, IEnumerable<RawUnitListDefinition> unitExclusions)
    {
        ...
        this.convertibleScalars = convertibleScalars.AsEquatable();
