...
internal static class Execution
{
    ...
    {
        if (data.ConvertibleScalars.Count is 0)
        {
            return;
        }
        ...
        context.AddSource($"{data.Scalar.Name}_Convertible.g.cs", SourceText.From(source, Encoding.UTF8));
    }
    ...
    private class Composer
    {
        ...
        {
            foreach (ConvertibleScalarDefinition definition in Data.ConvertibleScalars)
            {
