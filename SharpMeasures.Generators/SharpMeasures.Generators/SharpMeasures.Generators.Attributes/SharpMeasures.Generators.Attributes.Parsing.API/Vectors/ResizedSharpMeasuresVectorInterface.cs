...
public class ResizedSharpMeasuresVectorInterface : IAssociatedVectorInterface
{
    ...
    public ResizedSharpMeasuresVectorInterface(NamedType vectorType, NamedType associatedVector, int dimension, IEnumerable<IncludeUnitsInterface> includedUnits,
