...
{
    public abstract Diagnostic? NullDefaultUnit(IProcessingContext context, IDefaultUnitDefinition definition);
    public abstract Diagnostic? EmptyDefaultUnit(IProcessingContext context, IDefaultUnitDefinition definition);
    public abstract Diagnostic? SetDefaultSymbolButNotUnit(IProcessingContext context, IDefaultUnitDefinition definition);
    public abstract Diagnostic? SetDefaultUnitButNotSymbol(IProcessingContext context, IDefaultUnitDefinition definition);
}

public static class DefaultUnitProcesser
{
    public static IResultWithDiagnostics<(string? Name, string? Symbol)> Process(IProcessingContext context, IDefaultUnitProcessingDiagnostics diagnostics, IDefaultUnitDefinition definition)
    {
