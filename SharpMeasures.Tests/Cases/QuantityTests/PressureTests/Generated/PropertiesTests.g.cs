...
public class PropertiesTests
{
    ...
    public void IsNaN(Pressure quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(PressureDataset))]
    public void IsZero(Pressure quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(PressureDataset))]
    public void IsPositive(Pressure quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(PressureDataset))]
    public void ISNegative(Pressure quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(PressureDataset))]
    public void IsFinite(Pressure quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(PressureDataset))]
    public void IsInfinity(Pressure quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(PressureDataset))]
    public void IsPositiveInfinity(Pressure quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(PressureDataset))]
    public void IsNegativeInfinity(Pressure quantity)
    {
