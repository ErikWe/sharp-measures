...
public class EqualityTests
{
    ...
    {
        Pressure quantity = new(0);
        Pressure? nullQuantity = null;

        Assert.False(quantity.Equals(nullQuantity));
    }

    [Theory]
    [ClassData(typeof(GenericDataset<PressureDataset, PressureDataset>))]
    public void Method(Pressure quantity1, Pressure quantity2)
    {
    ...
    {
        Pressure quantity = new(0);
        Pressure? nullQuantity1 = null;
        Pressure? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<PressureDataset, PressureDataset>))]
    public void Operator(Pressure quantity1, Pressure quantity2)
    {
