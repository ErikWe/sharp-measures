...
{
    [Theory]
    [ClassData(typeof(GenericDataset<AccelerationDataset, Vector3Dataset>))]
    public void Vector3_Method_ShouldMatchMultiplication(Acceleration quantity, Vector3 vector)
    {
        Acceleration3 result = quantity.Multiply(vector);
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AccelerationDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Method_ShouldMatchMultiplication(Acceleration quantity, double x, double y, double z)
    {
        Acceleration3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AccelerationDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Method_ShouldMatchMultiplication(Acceleration quantity, Scalar x, Scalar y, Scalar z)
    {
        Acceleration3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AccelerationDataset, Vector3Dataset>))]
    public void Vector3_Operator_ShouldMatchMultiplication(Acceleration quantity, Vector3 vector)
    {
        Acceleration3 resultLHS = quantity * vector;
        Acceleration3 resultRHS = vector * quantity;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AccelerationDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Operator_ShouldMatchMultiplication(Acceleration quantity, double x, double y, double z)
    {
        Acceleration3 resultLHS = quantity * (x, y, z);
        Acceleration3 resultRHS = (x, y, z) * quantity;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AccelerationDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Operator_ShouldMatchMultiplication(Acceleration quantity, Scalar x, Scalar y, Scalar z)
    {
        Acceleration3 resultLHS = quantity * (x, y, z);
        Acceleration3 resultRHS = (x, y, z) * quantity;
