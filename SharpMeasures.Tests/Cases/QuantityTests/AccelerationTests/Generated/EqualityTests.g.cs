...
public class EqualityTests
{
    ...
    {
        Acceleration quantity = new(0);
        Acceleration? nullQuantity = null;
    ...
    public void Method(Acceleration quantity1, Acceleration quantity2)
    {
    ...
    {
        Acceleration quantity = new(0);
        Acceleration? nullQuantity1 = null;
        Acceleration? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AccelerationDataset, AccelerationDataset>))]
    public void Operator(Acceleration quantity1, Acceleration quantity2)
    {
