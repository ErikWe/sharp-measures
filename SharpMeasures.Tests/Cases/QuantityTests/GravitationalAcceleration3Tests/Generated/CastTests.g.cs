...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(GravitationalAcceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(GravitationalAcceleration3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(GravitationalAcceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(GravitationalAcceleration3Dataset))]
    public void ToVector3_ComponentsShouldMatch(GravitationalAcceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(GravitationalAcceleration3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(GravitationalAcceleration3 quantity)
    {
    ...
    {
        GravitationalAcceleration3 result = GravitationalAcceleration3.FromValueTuple((x, y, z));
    ...
    {
        GravitationalAcceleration3 result = (GravitationalAcceleration3)(x, y, z);
    ...
    {
        GravitationalAcceleration3 result = GravitationalAcceleration3.FromVector3(vector);
    ...
    {
        GravitationalAcceleration3 result = (GravitationalAcceleration3)vector;
