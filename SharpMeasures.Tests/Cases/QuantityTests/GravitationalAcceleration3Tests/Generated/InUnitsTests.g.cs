...
public class InUnitsTests
{
    ...
    {
        GravitationalAcceleration3 quantity = new(expected, unit);
    ...
    {
        GravitationalAcceleration3 quantity = new(expected, UnitOfAcceleration.StandardGravity);
    ...
    {
        GravitationalAcceleration3 quantity = new(expected, UnitOfAcceleration.MetrePerSecondSquared);
    ...
    {
        GravitationalAcceleration3 quantity = new(expected, UnitOfAcceleration.FootPerSecondSquared);
    ...
    {
        GravitationalAcceleration3 quantity = new(expected, UnitOfAcceleration.KilometrePerHourPerSecond);
    ...
    {
        GravitationalAcceleration3 quantity = new(expected, UnitOfAcceleration.MilePerHourPerSecond);
