...
{
    [Theory]
    [ClassData(typeof(GenericDataset<YankDataset, Vector3Dataset>))]
    public void Vector3_Method_ShouldMatchMultiplication(Yank quantity, Vector3 vector)
    {
        Yank3 result = quantity.Multiply(vector);
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<YankDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Method_ShouldMatchMultiplication(Yank quantity, double x, double y, double z)
    {
        Yank3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<YankDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Method_ShouldMatchMultiplication(Yank quantity, Scalar x, Scalar y, Scalar z)
    {
        Yank3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<YankDataset, Vector3Dataset>))]
    public void Vector3_Operator_ShouldMatchMultiplication(Yank quantity, Vector3 vector)
    {
        Yank3 resultLHS = quantity * vector;
        Yank3 resultRHS = vector * quantity;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<YankDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Operator_ShouldMatchMultiplication(Yank quantity, double x, double y, double z)
    {
        Yank3 resultLHS = quantity * (x, y, z);
        Yank3 resultRHS = (x, y, z) * quantity;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<YankDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Operator_ShouldMatchMultiplication(Yank quantity, Scalar x, Scalar y, Scalar z)
    {
        Yank3 resultLHS = quantity * (x, y, z);
        Yank3 resultRHS = (x, y, z) * quantity;
