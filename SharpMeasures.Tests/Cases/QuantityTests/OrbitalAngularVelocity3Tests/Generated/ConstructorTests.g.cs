...
public class ConstructorTests
{
    ...
    {
        OrbitalAngularVelocity3 quantity = OrbitalAngularVelocity3.Zero;

        Assert.Equal(0, quantity.Magnitude().Magnitude);
    }

    [Theory]
    [ClassData(typeof(GenericDataset<OrbitalAngularSpeedDataset, OrbitalAngularSpeedDataset, OrbitalAngularSpeedDataset>))]
    public void TupleComponents_ComponentsShouldBeEqual(OrbitalAngularSpeed x, OrbitalAngularSpeed y, OrbitalAngularSpeed z)
    {
        OrbitalAngularVelocity3 quantity = new((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<OrbitalAngularSpeedDataset, OrbitalAngularSpeedDataset, OrbitalAngularSpeedDataset>))]
    public void Components_ComponentMagnitudesShouldBeEqual(OrbitalAngularSpeed x, OrbitalAngularSpeed y, OrbitalAngularSpeed z)
    {
        OrbitalAngularVelocity3 quantity = new(x, y, z);
    ...
    {
        OrbitalAngularVelocity3 quantity = new((x, y, z), unit);

        Assert.Equal(x * unit.AngularSpeed.Magnitude, quantity.X, 2);
        Assert.Equal(y * unit.AngularSpeed.Magnitude, quantity.Y, 2);
        Assert.Equal(z * unit.AngularSpeed.Magnitude, quantity.Z, 2);
    }
    ...
    {
        OrbitalAngularVelocity3 quantity = new(vector, unit);

        Assert.Equal(vector.X * unit.AngularSpeed.Magnitude, quantity.X, 2);
        Assert.Equal(vector.Y * unit.AngularSpeed.Magnitude, quantity.Y, 2);
        Assert.Equal(vector.Z * unit.AngularSpeed.Magnitude, quantity.Z, 2);
    }
    ...
    {
        OrbitalAngularVelocity3 quantity = new(vector);
