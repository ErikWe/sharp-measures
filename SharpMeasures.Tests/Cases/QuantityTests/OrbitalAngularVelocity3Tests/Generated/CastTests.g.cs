...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(OrbitalAngularVelocity3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(OrbitalAngularVelocity3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(OrbitalAngularVelocity3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(OrbitalAngularVelocity3Dataset))]
    public void ToVector3_ComponentsShouldMatch(OrbitalAngularVelocity3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(OrbitalAngularVelocity3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(OrbitalAngularVelocity3 quantity)
    {
    ...
    {
        OrbitalAngularVelocity3 result = OrbitalAngularVelocity3.FromValueTuple((x, y, z));
    ...
    {
        OrbitalAngularVelocity3 result = (OrbitalAngularVelocity3)(x, y, z);
    ...
    {
        OrbitalAngularVelocity3 result = OrbitalAngularVelocity3.FromVector3(vector);
    ...
    {
        OrbitalAngularVelocity3 result = (OrbitalAngularVelocity3)vector;
