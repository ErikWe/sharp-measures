...
public class PropertiesTests
{
    ...
    public void IsNaN(ArealDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(ArealDensityDataset))]
    public void IsZero(ArealDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(ArealDensityDataset))]
    public void IsPositive(ArealDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(ArealDensityDataset))]
    public void ISNegative(ArealDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(ArealDensityDataset))]
    public void IsFinite(ArealDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(ArealDensityDataset))]
    public void IsInfinity(ArealDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(ArealDensityDataset))]
    public void IsPositiveInfinity(ArealDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(ArealDensityDataset))]
    public void IsNegativeInfinity(ArealDensity quantity)
    {
