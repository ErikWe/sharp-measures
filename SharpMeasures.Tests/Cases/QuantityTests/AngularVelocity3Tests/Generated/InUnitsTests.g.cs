...
public class InUnitsTests
{
    ...
    {
        AngularVelocity3 quantity = new(expected, unit);
    ...
    {
        AngularVelocity3 quantity = new(expected, UnitOfAngularVelocity.RadianPerSecond);
    ...
    {
        AngularVelocity3 quantity = new(expected, UnitOfAngularVelocity.DegreePerSecond);
    ...
    {
        AngularVelocity3 quantity = new(expected, UnitOfAngularVelocity.RevolutionPerSecond);
    ...
    {
        AngularVelocity3 quantity = new(expected, UnitOfAngularVelocity.RevolutionPerMinute);
