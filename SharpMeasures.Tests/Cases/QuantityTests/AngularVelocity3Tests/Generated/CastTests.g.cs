...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(AngularVelocity3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngularVelocity3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(AngularVelocity3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngularVelocity3Dataset))]
    public void ToVector3_ComponentsShouldMatch(AngularVelocity3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngularVelocity3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(AngularVelocity3 quantity)
    {
    ...
    {
        AngularVelocity3 result = AngularVelocity3.FromValueTuple((x, y, z));
    ...
    {
        AngularVelocity3 result = (AngularVelocity3)(x, y, z);
    ...
    {
        AngularVelocity3 result = AngularVelocity3.FromVector3(vector);
    ...
    {
        AngularVelocity3 result = (AngularVelocity3)vector;
