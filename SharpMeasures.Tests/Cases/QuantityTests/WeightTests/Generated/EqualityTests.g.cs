...
public class EqualityTests
{
    ...
    {
        Weight quantity = new(0);
        Weight? nullQuantity = null;

        Assert.False(quantity.Equals(nullQuantity));
    }

    [Theory]
    [ClassData(typeof(GenericDataset<WeightDataset, WeightDataset>))]
    public void Method(Weight quantity1, Weight quantity2)
    {
    ...
    {
        Weight quantity = new(0);
        Weight? nullQuantity1 = null;
        Weight? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<WeightDataset, WeightDataset>))]
    public void Operator(Weight quantity1, Weight quantity2)
    {
