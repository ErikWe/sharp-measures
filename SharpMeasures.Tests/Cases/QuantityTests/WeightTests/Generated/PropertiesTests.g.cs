...
public class PropertiesTests
{
    ...
    public void IsNaN(Weight quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WeightDataset))]
    public void IsZero(Weight quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WeightDataset))]
    public void IsPositive(Weight quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WeightDataset))]
    public void ISNegative(Weight quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WeightDataset))]
    public void IsFinite(Weight quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WeightDataset))]
    public void IsInfinity(Weight quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WeightDataset))]
    public void IsPositiveInfinity(Weight quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WeightDataset))]
    public void IsNegativeInfinity(Weight quantity)
    {
