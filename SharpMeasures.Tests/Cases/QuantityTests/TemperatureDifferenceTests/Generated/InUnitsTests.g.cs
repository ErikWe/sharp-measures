...
public class InUnitsTests
{
    ...
    {
        TemperatureDifference quantity = new(expected, unit);
    ...
    {
        TemperatureDifference quantity = new(expected, UnitOfTemperature.Kelvin);
    ...
    {
        TemperatureDifference quantity = new(expected, UnitOfTemperature.Celsius);
    ...
    {
        TemperatureDifference quantity = new(expected, UnitOfTemperature.Rankine);
    ...
    {
        TemperatureDifference quantity = new(expected, UnitOfTemperature.Fahrenheit);
