...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(SpinAngularMomentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpinAngularMomentum3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(SpinAngularMomentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpinAngularMomentum3Dataset))]
    public void ToVector3_ComponentsShouldMatch(SpinAngularMomentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpinAngularMomentum3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(SpinAngularMomentum3 quantity)
    {
    ...
    {
        SpinAngularMomentum3 result = SpinAngularMomentum3.FromValueTuple((x, y, z));
    ...
    {
        SpinAngularMomentum3 result = (SpinAngularMomentum3)(x, y, z);
    ...
    {
        SpinAngularMomentum3 result = SpinAngularMomentum3.FromVector3(vector);
    ...
    {
        SpinAngularMomentum3 result = (SpinAngularMomentum3)vector;
