...
public class EqualityTests
{
    ...
    {
        SpatialFrequency quantity = new(0);
        SpatialFrequency? nullQuantity = null;
    ...
    public void Method(SpatialFrequency quantity1, SpatialFrequency quantity2)
    {
    ...
    {
        SpatialFrequency quantity = new(0);
        SpatialFrequency? nullQuantity1 = null;
        SpatialFrequency? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<SpatialFrequencyDataset, SpatialFrequencyDataset>))]
    public void Operator(SpatialFrequency quantity1, SpatialFrequency quantity2)
    {
