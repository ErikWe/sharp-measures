...
public class ConstructorTests
{
    ...
    public void TupleScalars_Unit_ComponentMagnitudesShouldBeEqual(Scalar x, Scalar y, Scalar z, UnitOfMomentum unit)
    {
        ...
        Assert.Equal(x * unit.Momentum.Magnitude, quantity.MagnitudeX, 2);
        Assert.Equal(y * unit.Momentum.Magnitude, quantity.MagnitudeY, 2);
        Assert.Equal(z * unit.Momentum.Magnitude, quantity.MagnitudeZ, 2);
    }
    ...
    public void Vector3_Unit_ComponentMagnitudesShouldBeEqual(Vector3 vector, UnitOfMomentum unit)
    {
        ...
        Assert.Equal(vector.MagnitudeX * unit.Momentum.Magnitude, quantity.MagnitudeX, 2);
        Assert.Equal(vector.MagnitudeY * unit.Momentum.Magnitude, quantity.MagnitudeY, 2);
        Assert.Equal(vector.MagnitudeZ * unit.Momentum.Magnitude, quantity.MagnitudeZ, 2);
    }
