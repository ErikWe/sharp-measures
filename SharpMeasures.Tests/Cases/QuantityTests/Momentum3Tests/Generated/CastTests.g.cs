...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(Momentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Momentum3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(Momentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Momentum3Dataset))]
    public void ToVector3_ComponentsShouldMatch(Momentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Momentum3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(Momentum3 quantity)
    {
    ...
    {
        Momentum3 result = Momentum3.FromValueTuple((x, y, z));
    ...
    {
        Momentum3 result = (Momentum3)(x, y, z);
    ...
    {
        Momentum3 result = Momentum3.FromVector3(vector);
    ...
    {
        Momentum3 result = (Momentum3)vector;
