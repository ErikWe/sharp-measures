...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(Unhandled3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Unhandled3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(Unhandled3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Unhandled3Dataset))]
    public void ToVector3_ComponentsShouldMatch(Unhandled3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Unhandled3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(Unhandled3 quantity)
    {
    ...
    {
        Unhandled3 result = Unhandled3.FromValueTuple((x, y, z));
    ...
    {
        Unhandled3 result = (Unhandled3)(x, y, z);
    ...
    {
        Unhandled3 result = Unhandled3.FromVector3(vector);
    ...
    {
        Unhandled3 result = (Unhandled3)vector;
