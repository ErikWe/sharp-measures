...
public class EqualityTests
{
    ...
    {
        VolumetricFlowRate quantity = new(0);
        VolumetricFlowRate? nullQuantity = null;
    ...
    public void Method(VolumetricFlowRate quantity1, VolumetricFlowRate quantity2)
    {
    ...
    {
        VolumetricFlowRate quantity = new(0);
        VolumetricFlowRate? nullQuantity1 = null;
        VolumetricFlowRate? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<VolumetricFlowRateDataset, VolumetricFlowRateDataset>))]
    public void Operator(VolumetricFlowRate quantity1, VolumetricFlowRate quantity2)
    {
