...
public class InUnitsTests
{
    ...
    {
        Position3 quantity = new(expected, unit);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Metre);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Femtometre);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Picometre);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Nanometre);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Micrometre);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Millimetre);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Centimetre);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Decimetre);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Kilometre);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.AstronomicalUnit);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.LightYear);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Parsec);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Kiloparsec);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Megaparsec);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Gigaparsec);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Inch);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Foot);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Yard);
    ...
    {
        Position3 quantity = new(expected, UnitOfLength.Mile);
