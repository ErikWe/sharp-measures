...
public class CrossTests
{
    ...
    {
        Utility.QuantityTests.CrossTests.Vector3_ShouldMatchDefinition<Position3, Position3, Vector3>(quantity, vector);
    }
    ...
    {
        Utility.QuantityTests.CrossTests.Vector3_ShouldMatchDefinition<Position3, Unhandled3, Unhandled3>(quantity, vector);
    }
    ...
    public void Generic_NullFactory_ShouldThrowArgumentNull()
    {
        ...
        Assert.Throws<ArgumentNullException>(() => Position3.Zero.Cross(Vector3.Zero, factory!));
    }
    ...
    public void Generic_NullFactor_ShouldThrowArgumentNull()
    {
        ...
        Assert.Throws<ArgumentNullException>(() => Position3.Zero.Cross(factor!, (x) => new Unhandled3(x)));
    }
