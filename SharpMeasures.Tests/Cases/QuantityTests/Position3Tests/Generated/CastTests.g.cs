...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(Position3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Position3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(Position3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Position3Dataset))]
    public void ToVector3_ComponentsShouldMatch(Position3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Position3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(Position3 quantity)
    {
    ...
    {
        Position3 result = Position3.FromValueTuple((x, y, z));
    ...
    {
        Position3 result = Position3.FromVector3(vector);
    ...
    {
        Position3 result = (Position3)vector;
