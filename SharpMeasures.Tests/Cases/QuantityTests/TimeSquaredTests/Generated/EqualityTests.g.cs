...
public class EqualityTests
{
    ...
    {
        TimeSquared quantity = new(0);
        TimeSquared? nullQuantity = null;
    ...
    public void Method(TimeSquared quantity1, TimeSquared quantity2)
    {
    ...
    {
        TimeSquared quantity = new(0);
        TimeSquared? nullQuantity1 = null;
        TimeSquared? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<TimeSquaredDataset, TimeSquaredDataset>))]
    public void Operator(TimeSquared quantity1, TimeSquared quantity2)
    {
