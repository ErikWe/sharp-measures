...
public class PropertiesTests
{
    ...
    public void IsNaN(TimeSquared quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TimeSquaredDataset))]
    public void IsZero(TimeSquared quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TimeSquaredDataset))]
    public void IsPositive(TimeSquared quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TimeSquaredDataset))]
    public void ISNegative(TimeSquared quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TimeSquaredDataset))]
    public void IsFinite(TimeSquared quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TimeSquaredDataset))]
    public void IsInfinity(TimeSquared quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TimeSquaredDataset))]
    public void IsPositiveInfinity(TimeSquared quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TimeSquaredDataset))]
    public void IsNegativeInfinity(TimeSquared quantity)
    {
