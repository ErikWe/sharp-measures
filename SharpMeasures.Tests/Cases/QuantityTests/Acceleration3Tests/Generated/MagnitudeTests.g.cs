...
public class MagnitudeTests
{
    ...
    public void Individual_MagnitudesShouldBeSameAsOriginal(Acceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Acceleration3Dataset))]
    public void Components_MagnitudesShouldBeEqual(Acceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Acceleration3Dataset))]
    public void Magnitude_ShouldBeSquareRootOfSumOfSquares(Acceleration3 quantity)
    {
        Acceleration magnitude = quantity.Magnitude();
    ...
    [Theory]
    [ClassData(typeof(Acceleration3Dataset))]
    public void Magnitude_Explicit_ShouldBeSquareRootOfSumOfSquares(Acceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Acceleration3Dataset))]
    public void SquaredMagnitude_Explicit_ShouldBeSumOfSquares(Acceleration3 quantity)
    {
