...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(Acceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Acceleration3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(Acceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Acceleration3Dataset))]
    public void ToVector3_ComponentsShouldMatch(Acceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Acceleration3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(Acceleration3 quantity)
    {
    ...
    {
        Acceleration3 result = Acceleration3.FromValueTuple((x, y, z));
    ...
    {
        Acceleration3 result = (Acceleration3)(x, y, z);
    ...
    {
        Acceleration3 result = Acceleration3.FromVector3(vector);
    ...
    {
        Acceleration3 result = (Acceleration3)vector;
