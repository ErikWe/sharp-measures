...
public class ConstructorTests
{
    ...
    public void TupleScalars_Unit_ComponentMagnitudesShouldBeEqual(Scalar x, Scalar y, Scalar z, UnitOfAcceleration unit)
    {
        ...
        Assert.Equal(x * unit.Acceleration.Magnitude, quantity.X, 2);
        Assert.Equal(y * unit.Acceleration.Magnitude, quantity.Y, 2);
        Assert.Equal(z * unit.Acceleration.Magnitude, quantity.Z, 2);
    }
    ...
    public void Vector3_Unit_ComponentMagnitudesShouldBeEqual(Vector3 vector, UnitOfAcceleration unit)
    {
        ...
        Assert.Equal(vector.X * unit.Acceleration.Magnitude, quantity.X, 2);
        Assert.Equal(vector.Y * unit.Acceleration.Magnitude, quantity.Y, 2);
        Assert.Equal(vector.Z * unit.Acceleration.Magnitude, quantity.Z, 2);
    }
