...
{
    [Theory]
    [ClassData(typeof(GenericDataset<LengthDataset, Vector3Dataset>))]
    public void Vector3_Method_ShouldMatchMultiplication(Length quantity, Vector3 vector)
    {
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<LengthDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Method_ShouldMatchMultiplication(Length quantity, double x, double y, double z)
    {
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<LengthDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Method_ShouldMatchMultiplication(Length quantity, Scalar x, Scalar y, Scalar z)
    {
        Displacement3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<LengthDataset, Vector3Dataset>))]
    public void Vector3_Operator_ShouldMatchMultiplication(Length quantity, Vector3 vector)
    {
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<LengthDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Operator_ShouldMatchMultiplication(Length quantity, double x, double y, double z)
    {
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<LengthDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Operator_ShouldMatchMultiplication(Length quantity, Scalar x, Scalar y, Scalar z)
    {
        Displacement3 resultLHS = quantity * (x, y, z);
        Displacement3 resultRHS = (x, y, z) * quantity;
