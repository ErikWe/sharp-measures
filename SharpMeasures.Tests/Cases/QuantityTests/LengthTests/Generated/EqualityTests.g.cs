...
public class EqualityTests
{
    ...
    {
        Length quantity = new(0);
        Length? nullQuantity = null;
    ...
    public void Method(Length quantity1, Length quantity2)
    {
    ...
    {
        Length quantity = new(0);
        Length? nullQuantity1 = null;
        Length? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<LengthDataset, LengthDataset>))]
    public void Operator(Length quantity1, Length quantity2)
    {
