...
public class InUnitsTests
{
    ...
    {
        GravitationalEnergy quantity = new(expected, unit);
    ...
    {
        GravitationalEnergy quantity = new(expected, UnitOfEnergy.Joule);
    ...
    {
        GravitationalEnergy quantity = new(expected, UnitOfEnergy.Kilojoule);
    ...
    {
        GravitationalEnergy quantity = new(expected, UnitOfEnergy.Megajoule);
    ...
    {
        GravitationalEnergy quantity = new(expected, UnitOfEnergy.Gigajoule);
    ...
    {
        GravitationalEnergy quantity = new(expected, UnitOfEnergy.KilowattHour);
    ...
    {
        GravitationalEnergy quantity = new(expected, UnitOfEnergy.Calorie);
    ...
    {
        GravitationalEnergy quantity = new(expected, UnitOfEnergy.Kilocalorie);
