...
public class PropertiesTests
{
    ...
    public void IsNaN(Momentum quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(MomentumDataset))]
    public void IsZero(Momentum quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(MomentumDataset))]
    public void IsPositive(Momentum quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(MomentumDataset))]
    public void ISNegative(Momentum quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(MomentumDataset))]
    public void IsFinite(Momentum quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(MomentumDataset))]
    public void IsInfinity(Momentum quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(MomentumDataset))]
    public void IsPositiveInfinity(Momentum quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(MomentumDataset))]
    public void IsNegativeInfinity(Momentum quantity)
    {
