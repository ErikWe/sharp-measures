...
public class EqualityTests
{
    ...
    {
        Force quantity = new(0);
        Force? nullQuantity = null;

        Assert.False(quantity.Equals(nullQuantity));
    }

    [Theory]
    [ClassData(typeof(GenericDataset<ForceDataset, ForceDataset>))]
    public void Method(Force quantity1, Force quantity2)
    {
    ...
    {
        Force quantity = new(0);
        Force? nullQuantity1 = null;
        Force? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<ForceDataset, ForceDataset>))]
    public void Operator(Force quantity1, Force quantity2)
    {
