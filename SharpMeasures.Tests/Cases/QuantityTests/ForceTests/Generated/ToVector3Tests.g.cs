...
{
    [Theory]
    [ClassData(typeof(GenericDataset<ForceDataset, Vector3Dataset>))]
    public void Vector3_Method_ShouldMatchMultiplication(Force quantity, Vector3 vector)
    {
        Force3 result = quantity.Multiply(vector);
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<ForceDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Method_ShouldMatchMultiplication(Force quantity, double x, double y, double z)
    {
        Force3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<ForceDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Method_ShouldMatchMultiplication(Force quantity, Scalar x, Scalar y, Scalar z)
    {
        Force3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<ForceDataset, Vector3Dataset>))]
    public void Vector3_Operator_ShouldMatchMultiplication(Force quantity, Vector3 vector)
    {
        Force3 resultLHS = quantity * vector;
        Force3 resultRHS = vector * quantity;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<ForceDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Operator_ShouldMatchMultiplication(Force quantity, double x, double y, double z)
    {
        Force3 resultLHS = quantity * (x, y, z);
        Force3 resultRHS = (x, y, z) * quantity;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<ForceDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Operator_ShouldMatchMultiplication(Force quantity, Scalar x, Scalar y, Scalar z)
    {
        Force3 resultLHS = quantity * (x, y, z);
        Force3 resultRHS = (x, y, z) * quantity;
