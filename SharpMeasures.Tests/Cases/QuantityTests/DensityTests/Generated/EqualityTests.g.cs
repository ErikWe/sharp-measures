...
public class EqualityTests
{
    ...
    {
        Density quantity = new(0);
        Density? nullQuantity = null;
    ...
    public void Method(Density quantity1, Density quantity2)
    {
    ...
    {
        Density quantity = new(0);
        Density? nullQuantity1 = null;
        Density? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<DensityDataset, DensityDataset>))]
    public void Operator(Density quantity1, Density quantity2)
    {
