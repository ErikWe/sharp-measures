...
public class PropertiesTests
{
    ...
    public void IsNaN(Density quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DensityDataset))]
    public void IsZero(Density quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DensityDataset))]
    public void IsPositive(Density quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DensityDataset))]
    public void ISNegative(Density quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DensityDataset))]
    public void IsFinite(Density quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DensityDataset))]
    public void IsInfinity(Density quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DensityDataset))]
    public void IsPositiveInfinity(Density quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DensityDataset))]
    public void IsNegativeInfinity(Density quantity)
    {
