...
public class PropertiesTests
{
    ...
    public void IsNaN(Area quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AreaDataset))]
    public void IsZero(Area quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AreaDataset))]
    public void IsPositive(Area quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AreaDataset))]
    public void ISNegative(Area quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AreaDataset))]
    public void IsFinite(Area quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AreaDataset))]
    public void IsInfinity(Area quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AreaDataset))]
    public void IsPositiveInfinity(Area quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AreaDataset))]
    public void IsNegativeInfinity(Area quantity)
    {
