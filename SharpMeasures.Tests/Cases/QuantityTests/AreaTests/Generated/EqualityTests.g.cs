...
public class EqualityTests
{
    ...
    public void Method(Area quantity1, Area quantity2)
    {
    ...
    {
        Area quantity = new(0);
        Area? nullQuantity1 = null;
        Area? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AreaDataset, AreaDataset>))]
    public void Operator(Area quantity1, Area quantity2)
    {
