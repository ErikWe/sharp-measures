...
public class InUnitsTests
{
    ...
    {
        PotentialEnergy quantity = new(expected, unit);
    ...
    {
        PotentialEnergy quantity = new(expected, UnitOfEnergy.Joule);
    ...
    {
        PotentialEnergy quantity = new(expected, UnitOfEnergy.Kilojoule);
    ...
    {
        PotentialEnergy quantity = new(expected, UnitOfEnergy.Megajoule);
    ...
    {
        PotentialEnergy quantity = new(expected, UnitOfEnergy.Gigajoule);
    ...
    {
        PotentialEnergy quantity = new(expected, UnitOfEnergy.KilowattHour);
    ...
    {
        PotentialEnergy quantity = new(expected, UnitOfEnergy.Calorie);
    ...
    {
        PotentialEnergy quantity = new(expected, UnitOfEnergy.Kilocalorie);
