...
public class PropertiesTests
{
    ...
    public void IsNaN(AngularSpeed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngularSpeedDataset))]
    public void IsZero(AngularSpeed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngularSpeedDataset))]
    public void IsPositive(AngularSpeed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngularSpeedDataset))]
    public void ISNegative(AngularSpeed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngularSpeedDataset))]
    public void IsFinite(AngularSpeed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngularSpeedDataset))]
    public void IsInfinity(AngularSpeed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngularSpeedDataset))]
    public void IsPositiveInfinity(AngularSpeed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngularSpeedDataset))]
    public void IsNegativeInfinity(AngularSpeed quantity)
    {
