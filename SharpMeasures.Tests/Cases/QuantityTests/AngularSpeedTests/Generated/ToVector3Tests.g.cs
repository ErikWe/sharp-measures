...
{
    [Theory]
    [ClassData(typeof(GenericDataset<AngularSpeedDataset, Vector3Dataset>))]
    public void Vector3_Method_ShouldMatchMultiplication(AngularSpeed quantity, Vector3 vector)
    {
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AngularSpeedDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Method_ShouldMatchMultiplication(AngularSpeed quantity, double x, double y, double z)
    {
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AngularSpeedDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Method_ShouldMatchMultiplication(AngularSpeed quantity, Scalar x, Scalar y, Scalar z)
    {
        AngularVelocity3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AngularSpeedDataset, Vector3Dataset>))]
    public void Vector3_Operator_ShouldMatchMultiplication(AngularSpeed quantity, Vector3 vector)
    {
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AngularSpeedDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Operator_ShouldMatchMultiplication(AngularSpeed quantity, double x, double y, double z)
    {
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AngularSpeedDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Operator_ShouldMatchMultiplication(AngularSpeed quantity, Scalar x, Scalar y, Scalar z)
    {
        AngularVelocity3 resultLHS = quantity * (x, y, z);
        AngularVelocity3 resultRHS = (x, y, z) * quantity;
