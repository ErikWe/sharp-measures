...
public class MagnitudeTests
{
    ...
    public void Individual_MagnitudesShouldBeSameAsOriginal(SpecificAngularMomentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpecificAngularMomentum3Dataset))]
    public void Components_MagnitudesShouldBeEqual(SpecificAngularMomentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpecificAngularMomentum3Dataset))]
    public void Magnitude_ShouldBeSquareRootOfSumOfSquares(SpecificAngularMomentum3 quantity)
    {
        SpecificAngularMomentum magnitude = quantity.Magnitude();
    ...
    [Theory]
    [ClassData(typeof(SpecificAngularMomentum3Dataset))]
    public void Magnitude_Explicit_ShouldBeSquareRootOfSumOfSquares(SpecificAngularMomentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpecificAngularMomentum3Dataset))]
    public void SquaredMagnitude_Explicit_ShouldBeSumOfSquares(SpecificAngularMomentum3 quantity)
    {
