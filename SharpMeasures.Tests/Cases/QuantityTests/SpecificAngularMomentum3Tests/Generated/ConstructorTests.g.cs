...
public class ConstructorTests
{
    ...
    public void TupleScalars_Unit_ComponentMagnitudesShouldBeEqual(Scalar x, Scalar y, Scalar z, UnitOfSpecificAngularMomentum unit)
    {
        ...
        Assert.Equal(x * unit.SpecificAngularMomentum.Magnitude, quantity.X, 2);
        Assert.Equal(y * unit.SpecificAngularMomentum.Magnitude, quantity.Y, 2);
        Assert.Equal(z * unit.SpecificAngularMomentum.Magnitude, quantity.Z, 2);
    }
    ...
    public void Vector3_Unit_ComponentMagnitudesShouldBeEqual(Vector3 vector, UnitOfSpecificAngularMomentum unit)
    {
        ...
        Assert.Equal(vector.X * unit.SpecificAngularMomentum.Magnitude, quantity.X, 2);
        Assert.Equal(vector.Y * unit.SpecificAngularMomentum.Magnitude, quantity.Y, 2);
        Assert.Equal(vector.Z * unit.SpecificAngularMomentum.Magnitude, quantity.Z, 2);
    }
