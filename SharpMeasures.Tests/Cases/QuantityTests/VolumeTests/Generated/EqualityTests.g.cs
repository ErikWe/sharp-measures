...
public class EqualityTests
{
    ...
    {
        Volume quantity = new(0);
        Volume? nullQuantity = null;

        Assert.False(quantity.Equals(nullQuantity));
    }

    [Theory]
    [ClassData(typeof(GenericDataset<VolumeDataset, VolumeDataset>))]
    public void Method(Volume quantity1, Volume quantity2)
    {
    ...
    {
        Volume quantity = new(0);
        Volume? nullQuantity1 = null;
        Volume? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<VolumeDataset, VolumeDataset>))]
    public void Operator(Volume quantity1, Volume quantity2)
    {
