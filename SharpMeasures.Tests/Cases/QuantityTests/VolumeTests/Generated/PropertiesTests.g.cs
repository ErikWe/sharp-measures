...
public class PropertiesTests
{
    ...
    public void IsNaN(Volume quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(VolumeDataset))]
    public void IsZero(Volume quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(VolumeDataset))]
    public void IsPositive(Volume quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(VolumeDataset))]
    public void ISNegative(Volume quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(VolumeDataset))]
    public void IsFinite(Volume quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(VolumeDataset))]
    public void IsInfinity(Volume quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(VolumeDataset))]
    public void IsPositiveInfinity(Volume quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(VolumeDataset))]
    public void IsNegativeInfinity(Volume quantity)
    {
