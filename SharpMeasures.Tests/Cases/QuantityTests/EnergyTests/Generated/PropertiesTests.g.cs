...
public class PropertiesTests
{
    ...
    public void IsNaN(Energy quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(EnergyDataset))]
    public void IsZero(Energy quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(EnergyDataset))]
    public void IsPositive(Energy quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(EnergyDataset))]
    public void ISNegative(Energy quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(EnergyDataset))]
    public void IsFinite(Energy quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(EnergyDataset))]
    public void IsInfinity(Energy quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(EnergyDataset))]
    public void IsPositiveInfinity(Energy quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(EnergyDataset))]
    public void IsNegativeInfinity(Energy quantity)
    {
