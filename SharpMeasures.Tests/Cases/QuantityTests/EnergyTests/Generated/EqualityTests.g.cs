...
public class EqualityTests
{
    ...
    {
        Energy quantity = new(0);
        Energy? nullQuantity = null;

        Assert.False(quantity.Equals(nullQuantity));
    }

    [Theory]
    [ClassData(typeof(GenericDataset<EnergyDataset, EnergyDataset>))]
    public void Method(Energy quantity1, Energy quantity2)
    {
    ...
    {
        Energy quantity = new(0);
        Energy? nullQuantity1 = null;
        Energy? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<EnergyDataset, EnergyDataset>))]
    public void Operator(Energy quantity1, Energy quantity2)
    {
