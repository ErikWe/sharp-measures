...
{
    [Theory]
    [ClassData(typeof(GenericDataset<SpinAngularMomentumDataset, Vector3Dataset>))]
    public void Vector3_Method_ShouldMatchMultiplication(SpinAngularMomentum quantity, Vector3 vector)
    {
        SpinAngularMomentum3 result = quantity.Multiply(vector);
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<SpinAngularMomentumDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Method_ShouldMatchMultiplication(SpinAngularMomentum quantity, double x, double y, double z)
    {
        SpinAngularMomentum3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<SpinAngularMomentumDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Method_ShouldMatchMultiplication(SpinAngularMomentum quantity, Scalar x, Scalar y, Scalar z)
    {
        SpinAngularMomentum3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<SpinAngularMomentumDataset, Vector3Dataset>))]
    public void Vector3_Operator_ShouldMatchMultiplication(SpinAngularMomentum quantity, Vector3 vector)
    {
        SpinAngularMomentum3 resultLHS = quantity * vector;
        SpinAngularMomentum3 resultRHS = vector * quantity;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<SpinAngularMomentumDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Operator_ShouldMatchMultiplication(SpinAngularMomentum quantity, double x, double y, double z)
    {
        SpinAngularMomentum3 resultLHS = quantity * (x, y, z);
        SpinAngularMomentum3 resultRHS = (x, y, z) * quantity;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<SpinAngularMomentumDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Operator_ShouldMatchMultiplication(SpinAngularMomentum quantity, Scalar x, Scalar y, Scalar z)
    {
        SpinAngularMomentum3 resultLHS = quantity * (x, y, z);
        SpinAngularMomentum3 resultRHS = (x, y, z) * quantity;
