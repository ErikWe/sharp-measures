...
public class EqualityTests
{
    ...
    {
        Power quantity = new(0);
        Power? nullQuantity = null;

        Assert.False(quantity.Equals(nullQuantity));
    }

    [Theory]
    [ClassData(typeof(GenericDataset<PowerDataset, PowerDataset>))]
    public void Method(Power quantity1, Power quantity2)
    {
    ...
    {
        Power quantity = new(0);
        Power? nullQuantity1 = null;
        Power? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<PowerDataset, PowerDataset>))]
    public void Operator(Power quantity1, Power quantity2)
    {
