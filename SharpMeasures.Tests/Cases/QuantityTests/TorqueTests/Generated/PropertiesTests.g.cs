...
public class PropertiesTests
{
    ...
    public void IsNaN(Torque quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TorqueDataset))]
    public void IsZero(Torque quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TorqueDataset))]
    public void IsPositive(Torque quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TorqueDataset))]
    public void ISNegative(Torque quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TorqueDataset))]
    public void IsFinite(Torque quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TorqueDataset))]
    public void IsInfinity(Torque quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TorqueDataset))]
    public void IsPositiveInfinity(Torque quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TorqueDataset))]
    public void IsNegativeInfinity(Torque quantity)
    {
