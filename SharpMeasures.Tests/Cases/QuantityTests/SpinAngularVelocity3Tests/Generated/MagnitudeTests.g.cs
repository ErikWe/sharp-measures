...
public class MagnitudeTests
{
    ...
    public void Individual_MagnitudesShouldBeSameAsOriginal(SpinAngularVelocity3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpinAngularVelocity3Dataset))]
    public void Components_MagnitudesShouldBeEqual(SpinAngularVelocity3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpinAngularVelocity3Dataset))]
    public void Magnitude_ShouldBeSquareRootOfSumOfSquares(SpinAngularVelocity3 quantity)
    {
        SpinAngularSpeed magnitude = quantity.Magnitude();
    ...
    [Theory]
    [ClassData(typeof(SpinAngularVelocity3Dataset))]
    public void Magnitude_Explicit_ShouldBeSquareRootOfSumOfSquares(SpinAngularVelocity3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpinAngularVelocity3Dataset))]
    public void SquaredMagnitude_Explicit_ShouldBeSumOfSquares(SpinAngularVelocity3 quantity)
    {
