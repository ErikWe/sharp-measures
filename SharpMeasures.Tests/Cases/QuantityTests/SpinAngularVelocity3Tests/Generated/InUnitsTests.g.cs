...
public class InUnitsTests
{
    ...
    {
        SpinAngularVelocity3 quantity = new(expected, unit);
    ...
    {
        SpinAngularVelocity3 quantity = new(expected, UnitOfAngularVelocity.RadianPerSecond);
    ...
    {
        SpinAngularVelocity3 quantity = new(expected, UnitOfAngularVelocity.DegreePerSecond);
    ...
    {
        SpinAngularVelocity3 quantity = new(expected, UnitOfAngularVelocity.RevolutionPerSecond);
    ...
    {
        SpinAngularVelocity3 quantity = new(expected, UnitOfAngularVelocity.RevolutionPerMinute);
