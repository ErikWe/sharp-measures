...
public class InUnitsTests
{
    ...
    {
        Work quantity = new(expected, unit);
    ...
    {
        Work quantity = new(expected, UnitOfEnergy.Joule);
    ...
    {
        Work quantity = new(expected, UnitOfEnergy.Kilojoule);
    ...
    {
        Work quantity = new(expected, UnitOfEnergy.Megajoule);
    ...
    {
        Work quantity = new(expected, UnitOfEnergy.Gigajoule);
    ...
    {
        Work quantity = new(expected, UnitOfEnergy.KilowattHour);
    ...
    {
        Work quantity = new(expected, UnitOfEnergy.Calorie);
    ...
    {
        Work quantity = new(expected, UnitOfEnergy.Kilocalorie);
