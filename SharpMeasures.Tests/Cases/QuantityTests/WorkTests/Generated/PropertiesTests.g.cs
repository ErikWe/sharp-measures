...
public class PropertiesTests
{
    ...
    public void IsNaN(Work quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WorkDataset))]
    public void IsZero(Work quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WorkDataset))]
    public void IsPositive(Work quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WorkDataset))]
    public void ISNegative(Work quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WorkDataset))]
    public void IsFinite(Work quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WorkDataset))]
    public void IsInfinity(Work quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WorkDataset))]
    public void IsPositiveInfinity(Work quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(WorkDataset))]
    public void IsNegativeInfinity(Work quantity)
    {
