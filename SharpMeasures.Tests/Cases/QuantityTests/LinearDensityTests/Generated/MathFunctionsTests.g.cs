...
public class MathFunctionsTests
{
    ...
    public void Absolute(LinearDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(LinearDensityDataset))]
    public void Floor(LinearDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(LinearDensityDataset))]
    public void Ceiling(LinearDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(LinearDensityDataset))]
    public void Round(LinearDensity quantity)
    {
