...
public class PropertiesTests
{
    ...
    public void IsNaN(LinearDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(LinearDensityDataset))]
    public void IsZero(LinearDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(LinearDensityDataset))]
    public void IsPositive(LinearDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(LinearDensityDataset))]
    public void ISNegative(LinearDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(LinearDensityDataset))]
    public void IsFinite(LinearDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(LinearDensityDataset))]
    public void IsInfinity(LinearDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(LinearDensityDataset))]
    public void IsPositiveInfinity(LinearDensity quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(LinearDensityDataset))]
    public void IsNegativeInfinity(LinearDensity quantity)
    {
