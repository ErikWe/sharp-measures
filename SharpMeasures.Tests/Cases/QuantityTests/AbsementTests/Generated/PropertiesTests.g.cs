...
public class PropertiesTests
{
    ...
    public void IsNaN(Absement quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AbsementDataset))]
    public void IsZero(Absement quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AbsementDataset))]
    public void IsPositive(Absement quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AbsementDataset))]
    public void ISNegative(Absement quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AbsementDataset))]
    public void IsFinite(Absement quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AbsementDataset))]
    public void IsInfinity(Absement quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AbsementDataset))]
    public void IsPositiveInfinity(Absement quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AbsementDataset))]
    public void IsNegativeInfinity(Absement quantity)
    {
