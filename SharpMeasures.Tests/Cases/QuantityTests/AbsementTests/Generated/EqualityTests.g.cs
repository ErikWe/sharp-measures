...
public class EqualityTests
{
    ...
    {
        Absement quantity = new(0);
        Absement? nullQuantity = null;
    ...
    public void Method(Absement quantity1, Absement quantity2)
    {
    ...
    {
        Absement quantity = new(0);
        Absement? nullQuantity1 = null;
        Absement? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AbsementDataset, AbsementDataset>))]
    public void Operator(Absement quantity1, Absement quantity2)
    {
