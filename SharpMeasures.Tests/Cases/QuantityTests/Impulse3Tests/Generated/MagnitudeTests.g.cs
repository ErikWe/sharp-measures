...
public class MagnitudeTests
{
    ...
    public void Individual_MagnitudesShouldBeSameAsOriginal(Impulse3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Impulse3Dataset))]
    public void Components_MagnitudesShouldBeEqual(Impulse3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Impulse3Dataset))]
    public void Magnitude_ShouldBeSquareRootOfSumOfSquares(Impulse3 quantity)
    {
        Impulse magnitude = quantity.Magnitude();
    ...
    [Theory]
    [ClassData(typeof(Impulse3Dataset))]
    public void Magnitude_Explicit_ShouldBeSquareRootOfSumOfSquares(Impulse3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Impulse3Dataset))]
    public void SquaredMagnitude_Explicit_ShouldBeSumOfSquares(Impulse3 quantity)
    {
