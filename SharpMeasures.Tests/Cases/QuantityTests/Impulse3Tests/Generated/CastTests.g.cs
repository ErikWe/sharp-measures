...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(Impulse3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Impulse3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(Impulse3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Impulse3Dataset))]
    public void ToVector3_ComponentsShouldMatch(Impulse3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Impulse3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(Impulse3 quantity)
    {
    ...
    {
        Impulse3 result = Impulse3.FromValueTuple((x, y, z));
    ...
    {
        Impulse3 result = (Impulse3)(x, y, z);
    ...
    {
        Impulse3 result = Impulse3.FromVector3(vector);
    ...
    {
        Impulse3 result = (Impulse3)vector;
