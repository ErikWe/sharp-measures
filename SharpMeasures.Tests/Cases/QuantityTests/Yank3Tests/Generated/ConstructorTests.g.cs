...
public class ConstructorTests
{
    ...
    public void TupleScalars_Unit_ComponentMagnitudesShouldBeEqual(Scalar x, Scalar y, Scalar z, UnitOfYank unit)
    {
        ...
        Assert.Equal(x * unit.Yank.Magnitude, quantity.X, 2);
        Assert.Equal(y * unit.Yank.Magnitude, quantity.Y, 2);
        Assert.Equal(z * unit.Yank.Magnitude, quantity.Z, 2);
    }
    ...
    public void Vector3_Unit_ComponentMagnitudesShouldBeEqual(Vector3 vector, UnitOfYank unit)
    {
        ...
        Assert.Equal(vector.X * unit.Yank.Magnitude, quantity.X, 2);
        Assert.Equal(vector.Y * unit.Yank.Magnitude, quantity.Y, 2);
        Assert.Equal(vector.Z * unit.Yank.Magnitude, quantity.Z, 2);
    }
