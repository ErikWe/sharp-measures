...
public class InUnitsTests
{
    ...
    {
        OrbitalAngularAcceleration3 quantity = new(expected, unit);
    ...
    {
        OrbitalAngularAcceleration3 quantity = new(expected, UnitOfAngularAcceleration.RadianPerSecondSquared);
