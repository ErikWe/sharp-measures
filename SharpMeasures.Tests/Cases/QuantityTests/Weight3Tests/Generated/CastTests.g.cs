...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(Weight3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Weight3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(Weight3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Weight3Dataset))]
    public void ToVector3_ComponentsShouldMatch(Weight3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Weight3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(Weight3 quantity)
    {
    ...
    {
        Weight3 result = Weight3.FromValueTuple((x, y, z));
    ...
    {
        Weight3 result = Weight3.FromVector3(vector);
