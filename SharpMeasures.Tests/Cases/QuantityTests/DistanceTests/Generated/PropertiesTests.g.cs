...
public class PropertiesTests
{
    ...
    public void IsNaN(Distance quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DistanceDataset))]
    public void IsZero(Distance quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DistanceDataset))]
    public void IsPositive(Distance quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DistanceDataset))]
    public void ISNegative(Distance quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DistanceDataset))]
    public void IsFinite(Distance quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DistanceDataset))]
    public void IsInfinity(Distance quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DistanceDataset))]
    public void IsPositiveInfinity(Distance quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(DistanceDataset))]
    public void IsNegativeInfinity(Distance quantity)
    {
