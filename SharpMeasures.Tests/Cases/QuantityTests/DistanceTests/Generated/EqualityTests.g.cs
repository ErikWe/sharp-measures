...
public class EqualityTests
{
    ...
    {
        Distance quantity = new(0);
        Distance? nullQuantity = null;
    ...
    public void Method(Distance quantity1, Distance quantity2)
    {
    ...
    {
        Distance quantity = new(0);
        Distance? nullQuantity1 = null;
        Distance? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<DistanceDataset, DistanceDataset>))]
    public void Operator(Distance quantity1, Distance quantity2)
    {
