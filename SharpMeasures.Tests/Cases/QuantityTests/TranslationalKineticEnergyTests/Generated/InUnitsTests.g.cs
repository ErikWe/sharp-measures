...
public class InUnitsTests
{
    ...
    {
        TranslationalKineticEnergy quantity = new(expected, unit);
    ...
    {
        TranslationalKineticEnergy quantity = new(expected, UnitOfEnergy.Joule);
    ...
    {
        TranslationalKineticEnergy quantity = new(expected, UnitOfEnergy.Kilojoule);
    ...
    {
        TranslationalKineticEnergy quantity = new(expected, UnitOfEnergy.Megajoule);
    ...
    {
        TranslationalKineticEnergy quantity = new(expected, UnitOfEnergy.Gigajoule);
    ...
    {
        TranslationalKineticEnergy quantity = new(expected, UnitOfEnergy.KilowattHour);
    ...
    {
        TranslationalKineticEnergy quantity = new(expected, UnitOfEnergy.Calorie);
    ...
    {
        TranslationalKineticEnergy quantity = new(expected, UnitOfEnergy.Kilocalorie);
