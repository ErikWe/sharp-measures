...
public class PropertiesTests
{
    ...
    public void IsNaN(Temperature quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TemperatureDataset))]
    public void IsZero(Temperature quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TemperatureDataset))]
    public void IsPositive(Temperature quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TemperatureDataset))]
    public void ISNegative(Temperature quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TemperatureDataset))]
    public void IsFinite(Temperature quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TemperatureDataset))]
    public void IsInfinity(Temperature quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TemperatureDataset))]
    public void IsPositiveInfinity(Temperature quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(TemperatureDataset))]
    public void IsNegativeInfinity(Temperature quantity)
    {
