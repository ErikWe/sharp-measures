...
public class EqualityTests
{
    ...
    public void Method(Time quantity1, Time quantity2)
    {
    ...
    {
        Time quantity = new(0);
        Time? nullQuantity1 = null;
        Time? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<TimeDataset, TimeDataset>))]
    public void Operator(Time quantity1, Time quantity2)
    {
