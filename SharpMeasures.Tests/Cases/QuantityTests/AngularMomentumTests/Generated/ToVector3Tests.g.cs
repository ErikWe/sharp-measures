...
{
    [Theory]
    [ClassData(typeof(GenericDataset<AngularMomentumDataset, Vector3Dataset>))]
    public void Vector3_Method_ShouldMatchMultiplication(AngularMomentum quantity, Vector3 vector)
    {
        AngularMomentum3 result = quantity.Multiply(vector);
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AngularMomentumDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Method_ShouldMatchMultiplication(AngularMomentum quantity, double x, double y, double z)
    {
        AngularMomentum3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AngularMomentumDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Method_ShouldMatchMultiplication(AngularMomentum quantity, Scalar x, Scalar y, Scalar z)
    {
        AngularMomentum3 result = quantity.Multiply((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AngularMomentumDataset, Vector3Dataset>))]
    public void Vector3_Operator_ShouldMatchMultiplication(AngularMomentum quantity, Vector3 vector)
    {
        AngularMomentum3 resultLHS = quantity * vector;
        AngularMomentum3 resultRHS = vector * quantity;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AngularMomentumDataset, DoubleDataset, DoubleDataset, DoubleDataset>))]
    public void DoubleTuple_Operator_ShouldMatchMultiplication(AngularMomentum quantity, double x, double y, double z)
    {
        AngularMomentum3 resultLHS = quantity * (x, y, z);
        AngularMomentum3 resultRHS = (x, y, z) * quantity;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AngularMomentumDataset, ScalarDataset, ScalarDataset, ScalarDataset>))]
    public void ScalarTuple_Operator_ShouldMatchMultiplication(AngularMomentum quantity, Scalar x, Scalar y, Scalar z)
    {
        AngularMomentum3 resultLHS = quantity * (x, y, z);
        AngularMomentum3 resultRHS = (x, y, z) * quantity;
