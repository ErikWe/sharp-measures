...
public class MagnitudeTests
{
    ...
    public void Individual_MagnitudesShouldBeSameAsOriginal(Torque3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Torque3Dataset))]
    public void Components_MagnitudesShouldBeEqual(Torque3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Torque3Dataset))]
    public void Magnitude_ShouldBeSquareRootOfSumOfSquares(Torque3 quantity)
    {
        Torque magnitude = quantity.Magnitude();
    ...
    [Theory]
    [ClassData(typeof(Torque3Dataset))]
    public void Magnitude_Explicit_ShouldBeSquareRootOfSumOfSquares(Torque3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Torque3Dataset))]
    public void SquaredMagnitude_Explicit_ShouldBeSumOfSquares(Torque3 quantity)
    {
