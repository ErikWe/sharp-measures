...
public class EqualityTests
{
    ...
    {
        Angle quantity = new(0);
        Angle? nullQuantity = null;
    ...
    public void Method(Angle quantity1, Angle quantity2)
    {
    ...
    {
        Angle quantity = new(0);
        Angle? nullQuantity1 = null;
        Angle? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<AngleDataset, AngleDataset>))]
    public void Operator(Angle quantity1, Angle quantity2)
    {
