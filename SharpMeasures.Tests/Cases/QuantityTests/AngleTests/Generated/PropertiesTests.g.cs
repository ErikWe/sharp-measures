...
public class PropertiesTests
{
    ...
    public void IsNaN(Angle quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngleDataset))]
    public void IsZero(Angle quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngleDataset))]
    public void IsPositive(Angle quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngleDataset))]
    public void ISNegative(Angle quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngleDataset))]
    public void IsFinite(Angle quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngleDataset))]
    public void IsInfinity(Angle quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngleDataset))]
    public void IsPositiveInfinity(Angle quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(AngleDataset))]
    public void IsNegativeInfinity(Angle quantity)
    {
