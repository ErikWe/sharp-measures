...
public class EqualityTests
{
    ...
    {
        Speed quantity = new(0);
        Speed? nullQuantity = null;
    ...
    public void Method(Speed quantity1, Speed quantity2)
    {
    ...
    {
        Speed quantity = new(0);
        Speed? nullQuantity1 = null;
        Speed? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<SpeedDataset, SpeedDataset>))]
    public void Operator(Speed quantity1, Speed quantity2)
    {
