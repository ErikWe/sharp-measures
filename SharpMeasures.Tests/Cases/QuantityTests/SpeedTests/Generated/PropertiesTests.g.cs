...
public class PropertiesTests
{
    ...
    public void IsNaN(Speed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpeedDataset))]
    public void IsZero(Speed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpeedDataset))]
    public void IsPositive(Speed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpeedDataset))]
    public void ISNegative(Speed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpeedDataset))]
    public void IsFinite(Speed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpeedDataset))]
    public void IsInfinity(Speed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpeedDataset))]
    public void IsPositiveInfinity(Speed quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpeedDataset))]
    public void IsNegativeInfinity(Speed quantity)
    {
