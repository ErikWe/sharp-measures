...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(SpinAngularAcceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpinAngularAcceleration3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(SpinAngularAcceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpinAngularAcceleration3Dataset))]
    public void ToVector3_ComponentsShouldMatch(SpinAngularAcceleration3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(SpinAngularAcceleration3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(SpinAngularAcceleration3 quantity)
    {
    ...
    {
        SpinAngularAcceleration3 result = SpinAngularAcceleration3.FromValueTuple((x, y, z));
    ...
    {
        SpinAngularAcceleration3 result = (SpinAngularAcceleration3)(x, y, z);
    ...
    {
        SpinAngularAcceleration3 result = SpinAngularAcceleration3.FromVector3(vector);
    ...
    {
        SpinAngularAcceleration3 result = (SpinAngularAcceleration3)vector;
