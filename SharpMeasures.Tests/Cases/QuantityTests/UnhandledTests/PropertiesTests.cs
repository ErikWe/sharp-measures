...
public class PropertiesTests
{
    ...
    public void IsNaN(Unhandled quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(UnhandledDataset))]
    public void IsZero(Unhandled quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(UnhandledDataset))]
    public void IsPositive(Unhandled quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(UnhandledDataset))]
    public void ISNegative(Unhandled quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(UnhandledDataset))]
    public void IsFinite(Unhandled quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(UnhandledDataset))]
    public void IsInfinity(Unhandled quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(UnhandledDataset))]
    public void IsPositiveInfinity(Unhandled quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(UnhandledDataset))]
    public void IsNegativeInfinity(Unhandled quantity)
    {
