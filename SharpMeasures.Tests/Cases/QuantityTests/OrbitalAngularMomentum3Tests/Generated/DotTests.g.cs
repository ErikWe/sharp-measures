...
public class DotTests
{
    ...
    {
        Utility.QuantityTests.DotTests.Vector3_ShouldBeSumOfSquares<OrbitalAngularMomentum3, OrbitalAngularMomentum, Vector3>(quantity, vector);
    }
    ...
    {
        Utility.QuantityTests.DotTests.Vector3_ShouldBeSumOfSquares<OrbitalAngularMomentum3, Unhandled, Unhandled3>(quantity, vector);
    }
    ...
    public void Generic_NullFactory_ShouldThrowArgumentNull()
    {
        ...
        Assert.Throws<ArgumentNullException>(() => OrbitalAngularMomentum3.Zero.Dot(Vector3.Zero, factory!));
    }
    ...
    public void Generic_NullFactor_ShouldThrowArgumentNull()
    {
        ...
        Assert.Throws<ArgumentNullException>(() => OrbitalAngularMomentum3.Zero.Dot(factor!, (x) => new Unhandled(x)));
    }
