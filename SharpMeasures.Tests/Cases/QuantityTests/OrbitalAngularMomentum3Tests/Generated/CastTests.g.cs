...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(OrbitalAngularMomentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(OrbitalAngularMomentum3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(OrbitalAngularMomentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(OrbitalAngularMomentum3Dataset))]
    public void ToVector3_ComponentsShouldMatch(OrbitalAngularMomentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(OrbitalAngularMomentum3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(OrbitalAngularMomentum3 quantity)
    {
    ...
    {
        OrbitalAngularMomentum3 result = OrbitalAngularMomentum3.FromValueTuple((x, y, z));
    ...
    {
        OrbitalAngularMomentum3 result = (OrbitalAngularMomentum3)(x, y, z);
    ...
    {
        OrbitalAngularMomentum3 result = OrbitalAngularMomentum3.FromVector3(vector);
    ...
    {
        OrbitalAngularMomentum3 result = (OrbitalAngularMomentum3)vector;
