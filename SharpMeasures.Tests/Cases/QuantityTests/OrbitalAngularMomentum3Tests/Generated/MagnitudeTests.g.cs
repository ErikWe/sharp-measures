...
public class MagnitudeTests
{
    ...
    [Theory]
    [ClassData(typeof(OrbitalAngularMomentum3Dataset))]
    public void Magnitude_ShouldBeSquareRootOfSumOfSquares(OrbitalAngularMomentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(OrbitalAngularMomentum3Dataset))]
    public void Magnitude_Explicit_ShouldBeSquareRootOfSumOfSquares(OrbitalAngularMomentum3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(OrbitalAngularMomentum3Dataset))]
    public void SquaredMagnitude_Explicit_ShouldBeSumOfSquares(OrbitalAngularMomentum3 quantity)
    {
