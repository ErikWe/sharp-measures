...
public class ConstructorTests
{
    ...
    {
        OrbitalAngularMomentum3 quantity = OrbitalAngularMomentum3.Zero;

        Assert.Equal(0, quantity.Magnitude().Magnitude);
    }

    [Theory]
    [ClassData(typeof(GenericDataset<OrbitalAngularMomentumDataset, OrbitalAngularMomentumDataset, OrbitalAngularMomentumDataset>))]
    public void TupleComponents_ComponentsShouldBeEqual(OrbitalAngularMomentum x, OrbitalAngularMomentum y, OrbitalAngularMomentum z)
    {
        OrbitalAngularMomentum3 quantity = new((x, y, z));
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<OrbitalAngularMomentumDataset, OrbitalAngularMomentumDataset, OrbitalAngularMomentumDataset>))]
    public void Components_ComponentMagnitudesShouldBeEqual(OrbitalAngularMomentum x, OrbitalAngularMomentum y, OrbitalAngularMomentum z)
    {
        OrbitalAngularMomentum3 quantity = new(x, y, z);
    ...
    {
        OrbitalAngularMomentum3 quantity = new((x, y, z), unit);
    ...
    {
        OrbitalAngularMomentum3 quantity = new(vector, unit);
    ...
    {
        OrbitalAngularMomentum3 quantity = new(vector);
