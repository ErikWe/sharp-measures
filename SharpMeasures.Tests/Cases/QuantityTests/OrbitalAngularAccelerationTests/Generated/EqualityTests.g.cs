...
public class EqualityTests
{
    ...
    {
        OrbitalAngularAcceleration quantity = new(0);
        OrbitalAngularAcceleration? nullQuantity = null;
    ...
    public void Method(OrbitalAngularAcceleration quantity1, OrbitalAngularAcceleration quantity2)
    {
    ...
    {
        OrbitalAngularAcceleration quantity = new(0);
        OrbitalAngularAcceleration? nullQuantity1 = null;
        OrbitalAngularAcceleration? nullQuantity2 = null;
    ...
    [Theory]
    [ClassData(typeof(GenericDataset<OrbitalAngularAccelerationDataset, OrbitalAngularAccelerationDataset>))]
    public void Operator(OrbitalAngularAcceleration quantity1, OrbitalAngularAcceleration quantity2)
    {
