...
public class PropertiesTests
{
    ...
    public void IsNaN(FrequencyDrift quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(FrequencyDriftDataset))]
    public void IsZero(FrequencyDrift quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(FrequencyDriftDataset))]
    public void IsPositive(FrequencyDrift quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(FrequencyDriftDataset))]
    public void ISNegative(FrequencyDrift quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(FrequencyDriftDataset))]
    public void IsFinite(FrequencyDrift quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(FrequencyDriftDataset))]
    public void IsInfinity(FrequencyDrift quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(FrequencyDriftDataset))]
    public void IsPositiveInfinity(FrequencyDrift quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(FrequencyDriftDataset))]
    public void IsNegativeInfinity(FrequencyDrift quantity)
    {
