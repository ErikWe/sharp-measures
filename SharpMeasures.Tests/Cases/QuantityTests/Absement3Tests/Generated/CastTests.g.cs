...
public class CastTests
{
    ...
    public void ToTuple_ComponentsShouldMatch(Absement3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Absement3Dataset))]
    public void CastToTuple_ComponentsShouldMatch(Absement3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Absement3Dataset))]
    public void ToVector3_ComponentsShouldMatch(Absement3 quantity)
    {
    ...
    [Theory]
    [ClassData(typeof(Absement3Dataset))]
    public void CastToVector3_ComponentsShouldMatch(Absement3 quantity)
    {
    ...
    {
        Absement3 result = Absement3.FromValueTuple((x, y, z));
    ...
    {
        Absement3 result = (Absement3)(x, y, z);
    ...
    {
        Absement3 result = Absement3.FromVector3(vector);
    ...
    {
        Absement3 result = (Absement3)vector;
