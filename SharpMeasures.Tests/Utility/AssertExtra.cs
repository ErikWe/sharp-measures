...
{
    public static void AssertEqualMagnitude(IScalarQuantity x, IScalarQuantity y)
    {
        Assert.Equal(x.Magnitude, y.Magnitude, 2);
    }

    public static void AssertEqualComponents(IVector3Quantity a, IVector3Quantity b)
    {
