...
{
    public static class MultiplyUnhandledTests
    {
        public static void Method_ShouldEqualScalar<TQuantity>(IQuantity<TQuantity> a, UnhandledQuantity b)
            where TQuantity : IQuantity
        {
            UnhandledQuantity result1 = a.Multiply(b);
            UnhandledQuantity result2 = a.MultiplyInto(b);
        ...
        {
            UnhandledQuantity2 result1 = a.MultiplyElementwise(b);
            UnhandledQuantity2 result2 = a.MultiplyIntoElementwise(b);
        ...
        public static void Method_ComponentsShouldEqualScalar<TComponent, TQuantity>(IQuantity2<TComponent, TQuantity> a, UnhandledQuantity b)
            ...
            where TQuantity : IQuantity2<TComponent, TQuantity>
        {
            UnhandledQuantity2 result1 = a.Multiply(b);
            UnhandledQuantity2 result2 = a.MultiplyInto(b);
        ...
        {
            UnhandledQuantity3 result1 = a.MultiplyElementwise(b);
            UnhandledQuantity3 result2 = a.MultiplyIntoElementwise(b);
        ...
        public static void Method_ComponentsShouldEqualScalar<TComponent, TQuantity>(IQuantity3<TComponent, TQuantity> a, UnhandledQuantity b)
            ...
            where TQuantity : IQuantity3<TComponent, TQuantity>
        {
            UnhandledQuantity3 result1 = a.Multiply(b);
            UnhandledQuantity3 result2 = a.MultiplyInto(b);
