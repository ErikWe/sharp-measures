    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>The components of the <see cref="Unhandled3"/>.</summary>
    ...
    public Unhandled3(Scalar x, Scalar y, Scalar z) : this(Unhandled.FromScalar(x), Unhandled.FromScalar(y), Unhandled.FromScalar(z)) { }

    /// <summary>Constructs a new <see cref="Unhandled3"/> with components of magnitudes (<paramref name="x"/>, <paramref name="y"/>, <paramref name="z"/>).</summary>
    /// <param name="x">The magnitude of the X-component of the <see cref="Unhandled3"/>.</param>
    /// <param name="y">The magnitude of the Y-component of the <see cref="Unhandled3"/>.</param>
    /// <param name="z">The magnitude of the Z-component of the <see cref="Unhandled3"/>.</param>
    public Unhandled3(double x, double y, double z) : this(Unhandled.FromDouble(x), Unhandled.FromDouble(y), Unhandled.FromDouble(z)) { }
    ...
    public override string ToString() => $"{Components} [undef]";
        ...
        where TFactorScalarQuantity : IScalarQuantity
    {
        ...
        return factory(Components * factor.Magnitude);
    }
        ...
        where TDivisorScalarQuantity : IScalarQuantity
    {
        ...
        return factory(Components / divisor.Magnitude);
    }
    ...
    /// <summary>Constructs the <see cref="Unhandled3"/> with components equal to the values of <paramref name="components"/>.</summary>
    public static explicit operator Unhandled3((double x, double y, double z) components) => FromValueTuple(components);
    ...
    /// <summary>Constructs the <see cref="Unhandled3"/> with components <paramref name="a"/>.</summary>
    public static explicit operator Unhandled3(Vector3 a) => FromVector3(a);
}