...
/// <summary>A three-dimensional vector, with X, Y, and Z components.</summary>
    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <param name="y">The Y-component of the <see cref="Vector3"/>.</param>
    /// <param name="z">The Z-component of the <see cref="Vector3"/>.</param>
    public Vector3(double x, double y, double z) : this(Scalar.FromDouble(x), Scalar.FromDouble(y), Scalar.FromDouble(z)) { }
    ...
    public Scalar SquaredMagnitude() => VectorMaths.Dot(this, this);
    ...
    public Scalar Dot(Vector3 factor) => new(VectorMaths.Dot(this, factor));
    ...
    /// <inheritdoc/>
    /// <exception cref="ArgumentNullException"/>
    public TProductVector3Quantity Cross<TProductVector3Quantity, TFactorVector3Quantity>(TFactorVector3Quantity factor,
    ...
    /// <inheritdoc/>
    /// <exception cref="ArgumentNullException"/>
    public TProductVector3Quantity Multiply<TProductVector3Quantity, TFactorScalarQuantity>(TFactorScalarQuantity factor,
        Func<Vector3, TProductVector3Quantity> factory)
        where TProductVector3Quantity : IVector3Quantity
        where TFactorScalarQuantity : IScalarQuantity
    {
        ...
        return factory(this * factor.Magnitude);
    }

    /// <inheritdoc/>
    /// <exception cref="ArgumentNullException"/>
    public TQuotientVector3Quantity Divide<TQuotientVector3Quantity, TDivisorScalarQuantity>(TDivisorScalarQuantity divisor,
        ...
        where TDivisorScalarQuantity : IScalarQuantity
    {
        ...
        return factory(this / divisor.Magnitude);
    }
    ...
    /// Func{Vector3, TProductVector3Quantity})"/>.</remarks>
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(Vector3 a, IScalarQuantity b) => a.Multiply(b, static (product) => new Unhandled3(product));
    ...
    /// Func{Vector3, TProductVector3Quantity})"/>.</remarks>
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(IScalarQuantity a, Vector3 b) => b.Multiply(a, static (product) => new Unhandled3(product));
    ...
    /// Func{Vector3, TQuotientVector3Quantity})"/>.</remarks>
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator /(Vector3 a, IScalarQuantity b) => a.Divide(b, static (quotient) => new Unhandled3(quotient));
    ...
    /// values (<see cref="X"/>, <see cref="Y"/>, <see cref="Z"/>).</summary>
    public static implicit operator (double x, double y, double z)(Vector3 a) => a.ToValueTuple();
    ...
    /// <summary>Constructs the <see cref="Vector3"/> with components equal to the values of <paramref name="components"/>.</summary>
    public static explicit operator Vector3((double x, double y, double z) components) => FromValueTuple(components);
}