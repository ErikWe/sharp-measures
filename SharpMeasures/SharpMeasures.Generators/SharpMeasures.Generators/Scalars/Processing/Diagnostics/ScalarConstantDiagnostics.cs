...
{
    public static Diagnostic UnrecognizedUnit(ScalarConstantProcessingContext context, ScalarConstantDefinition definition)
    {
    ...
    public static Diagnostic ConstantSharesNameWithUnit(ScalarConstantProcessingContext context, ScalarConstantDefinition definition)
    {
    ...
    public static Diagnostic ConstantMultiplesSharesNameWithUnitPlural(ScalarConstantProcessingContext context, ScalarConstantDefinition definition)
    {
