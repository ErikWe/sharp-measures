...
internal static class Execution
{
    ...
    private class Composer
    {
        ...
        private void ComposeTypeBlock(Indentation indentation)
        {
            ...
            Builder.AppendLine($"{indentation}public static {Data.Vector.Name} Zero {{ get; }} = ({ConstantTexts.Zeros(Data.Dimension)});");
            ...
            Builder.AppendLine($"{indentation}public static {Data.Vector.Name} operator -({Data.Vector.Name} a) => ({ConstantTexts.Upper.NegateA(Data.Dimension)});");
            AppendDocumentation(indentation, VectorDocumentationTags.Operators.Multiply_Scalar_LHS);
            Builder.AppendLine($"{indentation}public static {Data.Vector.Name} operator *({Data.Vector.Name} a, Scalar b) => ({ConstantTexts.Upper.MultiplyAScalar(Data.Dimension)});");
            AppendDocumentation(indentation, VectorDocumentationTags.Operators.Multiply_Scalar_RHS);
            Builder.AppendLine($"{indentation}public static {Data.Vector.Name} operator *(Scalar a, {Data.Vector.Name} b) => ({ConstantTexts.Upper.MultiplyBScalar(Data.Dimension)});");
            AppendDocumentation(indentation, VectorDocumentationTags.Operators.Divide_Scalar);
            Builder.AppendLine($"{indentation}public static {Data.Vector.Name} operator /({Data.Vector.Name} a, Scalar b) => ({ConstantTexts.Upper.DivideAScalar(Data.Dimension)});");
            AppendDocumentation(indentation, VectorDocumentationTags.Operators.Remainder_Scalar);
            Builder.AppendLine($"{indentation}public static {Data.Vector.Name} operator %({Data.Vector.Name} a, Scalar b) => ({ConstantTexts.Upper.RemainderAScalar(Data.Dimension)});");
            ...
            if (Data.Scalar is not null)
            {
                ...
                Builder.AppendLine($"public static implicit operator {Data.Vector.Name}(({Texts.Upper.Component}) components) => new({ConstantTexts.Upper.ComponentsAccess(Data.Dimension)});");
        ...
        private void ComposeComponentsAsScalars(Indentation indentation)
        {
            ...
            Builder.AppendLine($"{indentation}public Vector{Data.Dimension} Components => ({ConstantTexts.Upper.Name(Data.Dimension)});");
        }
        ...
        private void ComposeComponentsAsTypes(Indentation indentation, NamedType scalar)
        {
            ...
            AppendDocumentation(indentation, VectorDocumentationTags.Components);
            Builder.AppendLine($"{indentation}public Vector{Data.Dimension} Components => ({ConstantTexts.Upper.Magnitude(Data.Dimension)});");
        }
        ...
        private void ComposeConstructorsToScalars(Indentation indentation)
        {
            ...
            Builder.AppendLine($"{indentation}public {Data.Vector.Name}({ConstantTexts.Lower.Scalar(Data.Dimension)})");
        ...
        private void ComposeCommonConstructors(Indentation indentation)
        {
            ...
            Builder.AppendLine($"{indentation.Increased}: this({ConstantTexts.Upper.ComponentsAccess(Data.Dimension)}) {{ }}");

            Builder.AppendLine();

            AppendDocumentation(indentation, VectorDocumentationTags.Constructor_Unit_Scalars);
            Builder.AppendLine($"{indentation}public {Data.Vector.Name}({ConstantTexts.Lower.Scalar(Data.Dimension)}, {Data.Unit.Name} {UnitParameterName})");
            ...
            Builder.AppendLine($"{indentation.Increased}: this({ConstantTexts.Upper.ComponentsAccess(Data.Dimension)}, {UnitParameterName}) {{ }}");
        }
    ...
    private class SpecificTexts
    {
        ...
        public SpecificTexts(int dimension, NamedType? scalar, NamedType unitQuantity, string unitParameterName)
        {
            ...
            DeconstructHeaderBuilder = scalar is null
                ? ConstantTexts.Builders.DeconstructScalarHeader
        ...
        public class UpperTexts
        {
            ...
            public UpperTexts(int dimension, NamedType? scalar)
            {
                ...
                ComponentBuilder = scalar is null
                    ? ConstantTexts.Builders.Upper.Scalar
