...
internal static class Execution
{
    ...
    private class Composer
    {
        ...
        private void Compose()
        {
            ...
            AppendDocumentation(new Indentation(0), DocumentationTags.UnitHeader);
        ...
        {
            AppendDocumentation(indentation, DocumentationTags.Quantity);
            Builder.Append($"{indentation}public {Data.Quantity.Name} {Data.Quantity.Name} {{ get; }}{Environment.NewLine}");

            AppendDocumentation(indentation, DocumentationTags.Constructor);
            ...
            AppendDocumentation(indentation, DocumentationTags.WithPrefix_Binary);
        ...
        private void ComposeBiasedTypeBlock(Indentation indentation)
        {
            AppendDocumentation(indentation, DocumentationTags.Quantity);
            Builder.Append($"{indentation}public {Data.Quantity.Name} {Data.Quantity.Name} {{ get; }}{Environment.NewLine}");
            AppendDocumentation(indentation, DocumentationTags.Offset);
            ...
            Builder.Append(Environment.NewLine);
            AppendDocumentation(indentation, DocumentationTags.OffsetBy_Scalar);
            Builder.Append($"{indentation}public {Data.Unit.Name} OffsetBy(Scalar offset) => OffsetBy(offset.Value);{Environment.NewLine}");
            AppendDocumentation(indentation, DocumentationTags.OffsetBy_Double);
