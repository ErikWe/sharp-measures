...
public interface IUnitProcessingContext : IProcessingContext
{
    public abstract HashSet<string> ReservedUnits { get; }
    public abstract HashSet<string> ReservedUnitPlurals { get; }
}

public abstract class AUnitProcesser<TContext, TDefinition, TProduct> : AActionableProcesser<TContext, TDefinition, TProduct>
    ...
    where TProduct : IUnitDefinition
{
    ...
    protected AUnitProcesser(IUnitDiagnostics<TDefinition> diagnostics)
    {
