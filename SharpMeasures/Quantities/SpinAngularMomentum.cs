...
{
    /// <summary>Computes <see cref="SpinAngularMomentum"/> according to { <see cref="SpinAngularMomentum"/>
    /// = <paramref name="momentOfInertia"/> ∗ <paramref name="spinAngularSpeed"/> }.</summary>
