...
public readonly partial record struct SpinAngularMomentum
{
    ...
    public static SpinAngularMomentum From(MomentOfInertia momentOfInertia, SpinAngularSpeed spinAngularSpeed) => new(momentOfInertia.Magnitude * spinAngularSpeed.Magnitude);
}
