...
{
    /// <summary>Computes <see cref="RotationalKineticEnergy"/> according to { <see cref="RotationalKineticEnergy"/>
    /// = 1/2 ∗ <paramref name="momentOfInertia"/> ∗ <paramref name="angularSpeed"/>² }.</summary>
