...
{
    public class SurfaceDensity2 : IEquatable<SurfaceDensity2>, IQuantity2<SurfaceDensity>
    {
        ...
        public override bool Equals(object? obj) => Equals(obj as SurfaceDensity2);

        public override int GetHashCode() => (X, Y).GetHashCode();
        public override string ToString() => $"({X.KilogramsPerSquareMetre}, {Y.KilogramsPerSquareMetre}) [kg/(m^2)]";

        public static bool operator ==(SurfaceDensity2? a, SurfaceDensity2? b) => a?.Equals(b) ?? b is null;
        ...
        public static UnhandledQuantity2 operator *(SurfaceDensity2 a, IQuantity2 b) => new(a.X * b.XMagnitude, a.Y * b.YMagnitude);
        public static UnhandledQuantity2 operator /(SurfaceDensity2 a, IQuantity2 b) => new(a.X / b.XMagnitude, a.Y / b.YMagnitude);
