...
{
    public class Acceleration2 : IEquatable<Acceleration2>, IQuantity2<Acceleration>
    {
        ...
        public Acceleration2(Scalar x, Scalar y)
        {
            X = new Acceleration(x);
            Y = new Acceleration(y);
        }

        public Acceleration2(IQuantity x, IQuantity y)
        {
        ...
        public override bool Equals(object? obj) => Equals(obj as Acceleration2);

        public override int GetHashCode() => (X, Y).GetHashCode();
        public override string ToString() => $"({X.MetresPerSecondSquared}, {Y.MetresPerSecondSquared}) [m/(s^2)]";

        public static bool operator ==(Acceleration2? a, Acceleration2? b) => a?.Equals(b) ?? b is null;
        ...
        public static UnhandledQuantity2 operator *(Acceleration2 a, IQuantity2 b) => new(a.X * b.XMagnitude, a.Y * b.YMagnitude);
        public static UnhandledQuantity2 operator /(Acceleration2 a, IQuantity2 b) => new(a.X / b.XMagnitude, a.Y / b.YMagnitude);
