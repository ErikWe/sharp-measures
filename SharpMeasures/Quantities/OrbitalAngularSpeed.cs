...
{
    /// <summary>Computes average <see cref="OrbitalAngularSpeed"/> according to { <see cref="OrbitalAngularSpeed"/>
    /// = <paramref name="angle"/> / <paramref name="time"/> }, where <paramref name="angle"/> is the change in
