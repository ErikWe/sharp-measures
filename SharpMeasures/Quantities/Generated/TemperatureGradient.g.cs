    ...
    IGenericallyDivisibleScalarQuantity
{
    ...
    /// <summary>Division of the <see cref="Unhandled"/> quantity <paramref name="x"/> by the <see cref="TemperatureGradient"/> <paramref name="y"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    /// <param name="x">The <see cref="Unhandled"/> quantity, which is divided by the <see cref="TemperatureGradient"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="TemperatureGradient"/> by which the <see cref="Unhandled"/> quantity <paramref name="x"/> is divided.</param>
    public static Unhandled operator /(Unhandled x, TemperatureGradient y) => new(x.Magnitude / y.Magnitude);
