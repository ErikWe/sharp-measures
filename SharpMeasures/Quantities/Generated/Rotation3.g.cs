    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(Rotation3 a, IScalarQuantity b) => a.Multiply<Unhandled3, IScalarQuantity>(b, (x, y, z) => new Unhandled3(x, y, z));
    ...
    /// Func{double, double, double, TProductVector3Quantity})"/>.</remarks>
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(IScalarQuantity a, Rotation3 b) => b.Multiply<Unhandled3, IScalarQuantity>(a, (x, y, z) => new Unhandled3(x, y, z));
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator /(Rotation3 a, IScalarQuantity b) => a.Divide<Unhandled3, IScalarQuantity>(b, (x, y, z) => new Unhandled3(x, y, z));
    ...
    /// values (<see cref="X"/>, <see cref="Y"/>, <see cref="Z"/>), when expressed in SI units.</summary>
    public static explicit operator (double x, double y, double z)(Rotation3 a) => (a.X, a.Y, a.Z);
