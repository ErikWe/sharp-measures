...
/// </item>
/// </list>
/// The components of the measure can be retrieved as a <see cref="Vector3"/> using pre-defined properties, prefixed with 'In', followed by the desired <see cref="UnitOfAngle"/>.
/// </para>
/// </summary>
    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>Computes the square of the magnitude, or norm, of the vector quantity <see cref="Rotation3"/>.</summary>
    /// <remarks>For clarity, consider first extracting the magnitudes of the components in the desired <see cref="UnitOfAngle"/>.</remarks>
    public Scalar SquaredMagnitude() => Maths.Vectors.Dot(this, this);

    /// <summary>Normalizes the <see cref="Rotation3"/> - if expressed in SI units.</summary>
    ...
    /// <summary>Computes the transformation of the existing <see cref="Rotation3"/> by <paramref name="transform"/>, resulting in
    /// a new <see cref="Rotation3"/>.</summary>
    ...
    /// <summary>Produces a formatted string from the magnitudes of the components of the <see cref="Rotation3"/> (in SI units),
    ...
    /// <param name="a">Unary plus is applied to this instance of <see cref="Rotation3"/>.</param>
    public static Rotation3 operator +(Rotation3 a) => a;
    /// <summary>Negation, resulting in a <see cref="Rotation3"/> with components negated from that of <paramref name="a"/>.</summary>
    /// <param name="a">Negation is applied to this instance of <see cref="Rotation3"/>.</param>
    public static Rotation3 operator -(Rotation3 a) => new(-a.X, -a.Y, -a.Z);

    /// <summary>Multiplies the <see cref="Rotation3"/> by the <see cref="Unhandled"/> quantity <paramref name="factor"/>
    ...
    /// <summary>Multiplies the <see cref="Rotation3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiplies the <see cref="Unhandled"/> quantity <paramref name="b"/> by the <see cref="Rotation3"/> <paramref name="a"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="Rotation3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <param name="b">The remainder is retrieved from division of <see cref="Rotation3"/> <paramref name="a"/> by this value.</param>
    ...
    /// <summary>Scales the <see cref="Rotation3"/> by <paramref name="factor"/>.</summary>
    /// <param name="factor">The factor by which the <see cref="Rotation3"/> is scaled.</param>
    public Rotation3 Multiply(Scalar factor) => new(X * factor.Magnitude, Y * factor.Magnitude, Z * factor.Magnitude);
    /// <summary>Scales the <see cref="Rotation3"/> through division by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The divisor, by which the <see cref="Rotation3"/> is divided.</param>
    ...
    /// <summary>Multiples the <see cref="Rotation3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiples the quantity <paramref name="a"/> by the <see cref="Rotation3"/> <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="Rotation3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    /// <param name="a">The <see cref="Rotation3"/>, which is divided by <paramref name="b"/>.</param>
    ...
    /// <summary>Converts the <see cref="Rotation3"/> to a (<see langword="double"/>, <see langword="double"/>, <see langword="double"/>) with values
    ...
    /// <summary>Converts the <see cref="Rotation3"/> to the <see cref="Vector3"/> with components of
    ...
    /// <summary>Constructs the <see cref="Rotation3"/> with components equal to the values of <paramref name="components"/>,
    ...
    /// <summary>Converts <paramref name="a"/> to the <see cref="Rotation3"/> with components of equal magnitude,
    /// when expressed in SI units.</summary>
