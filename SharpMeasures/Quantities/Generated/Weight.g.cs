    ...
    IVector3MultiplicableScalarQuantity<Weight3, Vector3>
{
    ...
    /// <summary>Constructs a new <see cref="Weight"/>, with magnitude <paramref name="magnitude"/> in <see cref="UnitOfForce"/> <paramref name="unitOfForce"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="Weight"/>, in <see cref="UnitOfForce"/> <paramref name="unitOfForce"/>.</param>
    ...
    /// <summary>Produces a <see cref="Weight"/>, with magnitude equal to the absolute of the original magnitude.</summary>
    public Weight Absolute() => new(Math.Abs(Magnitude));
    /// <summary>Produces a <see cref="Weight"/>, with magnitude equal to the floor of the original magnitude.</summary>
    public Weight Floor() => new(Math.Floor(Magnitude));
    /// <summary>Produces a <see cref="Weight"/>, with magnitude equal to the ceiling of the original magnitude.</summary>
    public Weight Ceiling() => new(Math.Ceiling(Magnitude));
    /// <summary>Produces a <see cref="Weight"/>, with magnitude equal to the original magnitude, rounded to the nearest integer.</summary>
    ...
    /// <summary>Produces a <see cref="Scalar"/> with magnitude equal to that of the <see cref="Weight"/>, expressed in <see cref="UnitOfForce"/>
    ...
    /// <summary>Produces a <see cref="Scalar"/> from the magnitude of a <see cref="Weight"/>, expressed in <see cref="UnitOfForce"/>
    /// <paramref name="unitOfForce"/>.</summary>
    /// <param name="weight">The <see cref="Weight"/> to be expressed in <see cref="UnitOfForce"/> <paramref name="unitOfForce"/>.</param>
    /// <param name="unitOfForce">The <see cref="UnitOfForce"/> in which the magnitude is expressed.</param>
    private static Scalar InUnit(Weight weight, UnitOfForce unitOfForce) => new(weight.Magnitude / unitOfForce.Factor);
    ...
    /// <summary>Multiplies the <see cref="Unhandled"/> quantity <paramref name="y"/> by the <see cref="Weight"/> <paramref name="x"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    ...
    /// <param name="y">The remainder is retrieved from division of <see cref="Weight"/> <paramref name="x"/> by this value.</param>
    ...
    /// by <paramref name="y"/>.</summary>
    /// <param name="x">The <see cref="Weight"/>, which is divided by <paramref name="y"/> to produce a remainder.</param>
    /// <param name="y">The remainder is retrieved from division of the <see cref="Weight"/> <paramref name="x"/> by this value.</param>
    ...
    /// <summary>Multiplies the <see cref="Weight"/> with the <see cref="ValueTuple"/> <paramref name="components"/> to produce a <see cref="Weight3"/>.</summary>
    /// <param name="components">This <see cref="ValueTuple"/> is multiplied by the <see cref="Weight"/>.</param>
    ...
    /// <summary>Multiplies the <see cref="Weight"/> <parmref name="b"/> with the <see cref="ValueTuple"/> <paramref name="a"/> to produce a <see cref="Weight3"/>.</summary>
    ...
    /// <summary>Converts the <see cref="Weight"/> to a <see cref="double"/> with value <see cref="Magnitude"/>.</summary>
    public double ToDouble() => Magnitude;
    /// <summary>Converts the <see cref="Weight"/> to a <see cref="double"/> based on the magnitude of the <see cref="Weight"/> <paramref name="x"/>.</summary>
    public static implicit operator double(Weight x) => x.ToDouble();

    /// <summary>Converts the <see cref="Weight"/> to the <see cref="Scalar"/> of equivalent magnitude.</summary>
