...
/// <list type="bullet">
/// <item>
/// <code><see cref="Weight"/> a = 3 * <see cref="Weight.OneNewton"/>;</code>
/// </item>
/// <item>
    ...
    IVector3MultiplicableScalarQuantity<Weight3, Vector3>
{
    ...
    /// <summary>Division of the <see cref="Unhandled"/> quantity <paramref name="x"/> by the <see cref="Weight"/> <paramref name="y"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    /// <param name="x">The <see cref="Unhandled"/> quantity, which is divided by the <see cref="Weight"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="Weight"/> by which the <see cref="Unhandled"/> quantity <paramref name="x"/> is divided.</param>
    public static Unhandled operator /(Unhandled x, Weight y) => new(x.Magnitude / y.Magnitude);
