...
/// </item>
/// </list>
/// The magnitude of the measure can be retrieved using pre-defined properties, prefixed with 'In', followed by the desired <see cref="UnitOfJerk"/>.
/// </para>
/// </summary>
    ...
    IVector3MultiplicableScalarQuantity<Jerk3, Vector3>
{
    ...
    /// <summary>Constructs a new <see cref="Jerk"/>, with magnitude <paramref name="magnitude"/> in <see cref="UnitOfJerk"/> <paramref name="unitOfJerk"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="Jerk"/>, in <see cref="UnitOfJerk"/> <paramref name="unitOfJerk"/>.</param>
    ...
    /// <remarks>Consider preffering a constructor that requires a <see cref="UnitOfJerk"/> to be specified.</remarks>
    public Jerk(Scalar magnitude) : this(magnitude.Magnitude) { }
    /// <summary>Constructs a new <see cref="Jerk"/>, with magnitude <paramref name="magnitude"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="Jerk"/>.</param>
    /// <remarks>Consider preferring a constructor that requires a <see cref="UnitOfJerk"/> to be specified.</remarks>
    ...
    /// <summary>Produces a <see cref="Scalar"/> with magnitude equal to that of the <see cref="Jerk"/>, expressed in <see cref="UnitOfJerk"/>
    /// <paramref name="unitOfJerk"/>.</summary>
    ...
    /// <summary>Produces a <see cref="Scalar"/> from the magnitude of a <see cref="Jerk"/>, expressed in <see cref="UnitOfJerk"/>
    /// <paramref name="unitOfJerk"/>.</summary>
    /// <param name="jerk">The <see cref="Jerk"/> to be expressed in <see cref="UnitOfJerk"/> <paramref name="unitOfJerk"/>.</param>
    /// <param name="unitOfJerk">The <see cref="UnitOfJerk"/> in which the magnitude is expressed.</param>
    ...
    /// <summary>Multiplies the <see cref="Jerk"/> with the <see cref="ValueTuple"/> <paramref name="components"/> to produce a <see cref="Jerk3"/>.</summary>
    /// <param name="components">This <see cref="ValueTuple"/> is multiplied by the <see cref="Jerk"/>.</param>
    ...
    /// <summary>Multiplies the <see cref="Jerk"/> <parmref name="b"/> with the <see cref="ValueTuple"/> <paramref name="a"/> to produce a <see cref="Jerk3"/>.</summary>
    ...
    /// <summary>Converts the <see cref="Jerk"/> to a <see cref="double"/> with value <see cref="Magnitude"/>.</summary>
    public double ToDouble() => Magnitude;
    /// <summary>Converts the <see cref="Jerk"/> to a <see cref="double"/> based on the magnitude of the <see cref="Jerk"/> <paramref name="x"/>.</summary>
    public static implicit operator double(Jerk x) => x.ToDouble();

    /// <summary>Converts the <see cref="Jerk"/> to the <see cref="Scalar"/> of equivalent magnitude.</summary>
