    ...
    IVector3MultiplicableScalarQuantity<Yank3, Vector3>
{
    ...
    /// <summary>Produces a formatted string from the magnitude of the <see cref="Yank"/> (in SI units), and the SI base unit of the quantity.</summary>
    ...
    public static Unhandled operator *(Yank x, IScalarQuantity y) => x.Multiply<Unhandled, IScalarQuantity>(y, (m) => new Unhandled(m));
    ...
    public static Unhandled operator /(Yank x, IScalarQuantity y) => x.Divide<Unhandled, IScalarQuantity>(y, (m) => new Unhandled(m));
    ...
    /// <summary>Multiplies the <see cref="Yank"/> with the values of <paramref name="components"/> to produce a <see cref="Yank3"/>.</summary>
    ...
    /// <summary>Multiplies the <see cref="Yank"/> <paramref name="a"/> with the values of <paramref name="b"/> to produce a <see cref="Yank3"/>.</summary>
    ...
    /// <summary>Multiplies the <see cref="Yank"/> <parmref name="b"/> with the values of <paramref name="a"/> to produce a <see cref="Yank3"/>.</summary>
    ...
    /// <summary>Converts <paramref name="x"/> to the <see cref="Yank"/> of magnitude <paramref name="x"/>, when expressed
    /// in SI units.</summary>
    ...
    /// <summary>Converts <paramref name="x"/> to the <see cref="Yank"/> of equivalent magnitude, when expressed in SI units.</summary>
