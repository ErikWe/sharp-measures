...
/// <list type="bullet">
/// <item>
/// <code><see cref="Yank"/> a = 3 * <see cref="Yank.OneNewtonPerSecond"/>;</code>
/// </item>
/// <item>
/// <code><see cref="Yank"/> d = <see cref="Yank.From(Force, Time)"/>;</code>
/// </item>
/// </list>
    ...
    IVector3MultiplicableScalarQuantity<Yank3, Vector3>
{
    ...
    /// <summary>Division of the <see cref="Unhandled"/> quantity <paramref name="x"/> by the <see cref="Yank"/> <paramref name="y"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    /// <param name="x">The <see cref="Unhandled"/> quantity, which is divided by the <see cref="Yank"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="Yank"/> by which the <see cref="Unhandled"/> quantity <paramref name="x"/> is divided.</param>
    public static Unhandled operator /(Unhandled x, Yank y) => new(x.Magnitude / y.Magnitude);
