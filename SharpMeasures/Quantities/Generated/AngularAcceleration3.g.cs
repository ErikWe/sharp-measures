    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    public OrbitalAngularAcceleration3 AsOrbitalAngularAcceleration => new(X, Y, Z);
    ...
    /// equal magnitudes.</summary>
    public SpinAngularAcceleration3 AsSpinAngularAcceleration => new(X, Y, Z);
    ...
    /// values (<see cref="X"/>, <see cref="Y"/>, <see cref="Z"/>), when expressed in SI units.</summary>
    public static explicit operator (double x, double y, double z)(AngularAcceleration3 a) => (a.X, a.Y, a.Z);
