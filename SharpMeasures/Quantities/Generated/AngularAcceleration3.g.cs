...
/// <list type="bullet">
/// <item>
/// <code><see cref="AngularAcceleration3"/> a = (3, 5, 7) * <see cref="AngularAcceleration.OneRadianPerSecondSquared"/>;</code>
/// </item>
/// <item>
/// <code><see cref="AngularAcceleration3"/> d = <see cref="AngularAcceleration3.From(AngularVelocity3, Time)"/>; </code>
/// </item>
/// <item>
/// <code><see cref="AngularAcceleration3"/> e = <see cref="SpinAngularAcceleration3.AsAngularAcceleration"/>;</code>
/// </item>
/// </list>
    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>The X-component of the <see cref="AngularAcceleration3"/>.</summary>
    public AngularAcceleration X => new(MagnitudeX);
    /// <summary>The Y-component of the <see cref="AngularAcceleration3"/>.</summary>
    public AngularAcceleration Y => new(MagnitudeY);
    /// <summary>The Z-component of the <see cref="AngularAcceleration3"/>.</summary>
    public AngularAcceleration Z => new(MagnitudeZ);
    ...
    public AngularAcceleration3(double x, double y, double z, UnitOfAngularAcceleration unitOfAngularAcceleration) : 
    	this(x * unitOfAngularAcceleration.AngularAcceleration, y * unitOfAngularAcceleration.AngularAcceleration, z * unitOfAngularAcceleration.AngularAcceleration) { }
    ...
    public AngularAcceleration3(Vector3 components) : this(components.MagnitudeX, components.MagnitudeY, components.MagnitudeZ) { }
    /// <summary>Constructs a new <see cref="AngularAcceleration3"/> with components of magnitudes <paramref name="components"/>.</summary>
    /// <param name="components">The magnitudes of the components of the <see cref="AngularAcceleration3"/>.</param>
    ...
    /// <summary>Converts the <see cref="AngularAcceleration3"/> to an instance of the associated quantity <see cref="OrbitalAngularAcceleration3"/>, with components of
    /// equal magnitudes.</summary>
    public OrbitalAngularAcceleration3 AsOrbitalAngularAcceleration => new(MagnitudeX, MagnitudeY, MagnitudeZ);
    /// <summary>Converts the <see cref="AngularAcceleration3"/> to an instance of the associated quantity <see cref="SpinAngularAcceleration3"/>, with components of
    /// equal magnitudes.</summary>
    ...
    /// <summary>Computes the normalized <see cref="AngularAcceleration3"/> - if expressed in SI units.</summary>
    ...
    /// <summary>Computes the transformation of the <see cref="AngularAcceleration3"/> by <paramref name="transform"/>.</summary>
    ...
    /// <see cref="AngularAcceleration"/>.</summary>
    ...
    /// <see cref="AngularAcceleration3"/>.</summary>
    ...
    /// <summary>Produces a formatted string from the magnitudes of the components of the <see cref="AngularAcceleration3"/> in the default unit
    ...
    private static Vector3 InUnit(AngularAcceleration3 angularAcceleration3, UnitOfAngularAcceleration unitOfAngularAcceleration) 
    	=> angularAcceleration3.ToVector3() / unitOfAngularAcceleration.AngularAcceleration.Magnitude;
    ...
    public AngularAcceleration3 Negate() => new(-MagnitudeX, -MagnitudeY, -MagnitudeZ);
    /// <summary>Unary plus, resulting in the unmodified <paramref name="a"/>.</summary>
    /// <param name="a">Unary plus is applied to this <see cref="AngularAcceleration3"/>.</param>
    public static AngularAcceleration3 operator +(AngularAcceleration3 a) => a;
    /// <summary>Negation, resulting in a <see cref="AngularAcceleration3"/> with negated components from that of <paramref name="a"/>.</summary>
    /// <param name="a">Negation is applied to this <see cref="AngularAcceleration3"/>.</param>
    public static AngularAcceleration3 operator -(AngularAcceleration3 a) => new(-a.MagnitudeX, -a.MagnitudeY, -a.MagnitudeZ);

    /// <summary>Multiplicates the <see cref="AngularAcceleration3"/> by the <see cref="Unhandled"/> quantity <paramref name="factor"/>
    ...
    /// <summary>Multiplication of the <see cref="AngularAcceleration3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    public static Unhandled3 operator *(AngularAcceleration3 a, Unhandled b) => new(a.MagnitudeX * b.Magnitude, a.MagnitudeY * b.Magnitude, a.MagnitudeZ * b.Magnitude);
    /// <summary>Multiplication of the <see cref="Unhandled"/> quantity <paramref name="b"/> by the <see cref="AngularAcceleration3"/> <paramref name="a"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    public static Unhandled3 operator *(Unhandled a, AngularAcceleration3 b) => new(a.Magnitude * b.MagnitudeX, a.Magnitude * b.MagnitudeY, a.Magnitude * b.MagnitudeZ);
    /// <summary>Division of the <see cref="AngularAcceleration3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    public AngularAcceleration3 Remainder(double divisor) => new(MagnitudeX % divisor, MagnitudeY % divisor, MagnitudeZ % divisor);
    ...
    public AngularAcceleration3 Multiply(double factor) => new(MagnitudeX * factor, MagnitudeY * factor, MagnitudeZ * factor);
    /// <summary>Scales the <see cref="AngularAcceleration3"/> through division by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The divisor, by which the <see cref="AngularAcceleration3"/> is divided.</param>
    public AngularAcceleration3 Divide(double divisor) => new(MagnitudeX / divisor, MagnitudeY / divisor, MagnitudeZ / divisor);
    /// <summary>Produces a <see cref="AngularAcceleration3"/>, with each component equal to the remainder from division of the
    ...
    /// <param name="b">The remainder is produced from division of <see cref="AngularAcceleration3"/> <paramref name="a"/> by this value.</param>
    public static AngularAcceleration3 operator %(AngularAcceleration3 a, double b) => new(a.MagnitudeX % b, a.MagnitudeY % b, a.MagnitudeZ % b);
    ...
    public static AngularAcceleration3 operator *(double a, AngularAcceleration3 b) => new(a * b.MagnitudeX, a * b.MagnitudeY, a * b.MagnitudeZ);
    ...
    /// magnitude of the original component by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The remainder is produced from division by this value.</param>
    public AngularAcceleration3 Remainder(Scalar divisor) => new(MagnitudeX % divisor.Magnitude, MagnitudeY % divisor.Magnitude, MagnitudeZ % divisor.Magnitude);
    /// <summary>Scales the <see cref="AngularAcceleration3"/> by <paramref name="factor"/>.</summary>
    /// <param name="factor">The factor by which the <see cref="AngularAcceleration3"/> is scaled.</param>
    public AngularAcceleration3 Multiply(Scalar factor) => new(MagnitudeX * factor.Magnitude, MagnitudeY * factor.Magnitude, MagnitudeZ * factor.Magnitude);
    /// <summary>Scales the <see cref="AngularAcceleration3"/> through division by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The divisor, by which the <see cref="AngularAcceleration3"/> is divided.</param>
    public AngularAcceleration3 Divide(Scalar divisor) => new(MagnitudeX / divisor.Magnitude, MagnitudeY / divisor.Magnitude, MagnitudeZ / divisor.Magnitude);
    /// <summary>Produces a <see cref="AngularAcceleration3"/>, with each component equal to the remainder from division of the
    /// magnitude of the component of <paramref name="a"/> by <paramref name="b"/>.</summary>
    /// <param name="a">The <see cref="AngularAcceleration3"/>, the components of which are divided by <paramref name="b"/> to produce a remainder.</param>
    /// <param name="b">The remainder is produced from division of <see cref="AngularAcceleration3"/> <paramref name="a"/> by this value.</param>
    public static AngularAcceleration3 operator %(AngularAcceleration3 a, Scalar b) => new(a.MagnitudeX % b.Magnitude, a.MagnitudeY % b.Magnitude, a.MagnitudeZ % b.Magnitude);
    /// <summary>Scales the <see cref="AngularAcceleration3"/> <paramref name="a"/> by <paramref name="b"/>.</summary>
    /// <param name="a">The <see cref="AngularAcceleration3"/>, which is scaled by <paramref name="b"/>.</param>
    /// <param name="b">This value is used to scale the <see cref="AngularAcceleration3"/> <paramref name="a"/>.</param>
    public static AngularAcceleration3 operator *(AngularAcceleration3 a, Scalar b) => new(a.MagnitudeX * b.Magnitude, a.MagnitudeY * b.Magnitude, a.MagnitudeZ * b.Magnitude);
    ...
    /// <param name="a">This value is used to scale the <see cref="AngularAcceleration3"/> <paramref name="b"/>.</param>
    /// <param name="b">The <see cref="AngularAcceleration3"/>, which is scaled by <paramref name="a"/>.</param>
    public static AngularAcceleration3 operator *(Scalar a, AngularAcceleration3 b) => new(a.Magnitude * b.MagnitudeX, a.Magnitude * b.MagnitudeY, a.Magnitude * b.MagnitudeZ);
    /// <summary>Scales the <see cref="AngularAcceleration3"/> <paramref name="a"/> through division by <paramref name="b"/>.</summary>
    /// <param name="a">The <see cref="AngularAcceleration3"/>, which is divided by <paramref name="b"/>.</param>
    /// <param name="b">This value is used to divide the <see cref="AngularAcceleration3"/> <paramref name="a"/>.</param>
    public static AngularAcceleration3 operator /(AngularAcceleration3 a, Scalar b) => new(a.MagnitudeX / b.Magnitude, a.MagnitudeY / b.Magnitude, a.MagnitudeZ / b.Magnitude);
    ...
    /// <summary>Multiplication of the <see cref="AngularAcceleration3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(AngularAcceleration3 a, IScalarQuantity b) => a.Multiply(b, (x) => new Unhandled3(x));
    /// <summary>Multiplication of the quantity <paramref name="a"/> by the <see cref="AngularAcceleration3"/> <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// Func{ValueTuple{double, double, double}, TProductVector3Quantity})"/>.</remarks>
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(IScalarQuantity a, AngularAcceleration3 b) => b.Multiply(a, (x) => new Unhandled3(x));
    /// <summary>Division of the <see cref="AngularAcceleration3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    /// <param name="a">The <see cref="AngularAcceleration3"/>, which is divided by <paramref name="b"/>.</param>
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator /(AngularAcceleration3 a, IScalarQuantity b) => a.Divide(b, (x) => new Unhandled3(x));

    /// <summary>Converts the <see cref="AngularAcceleration3"/> to a (<see langword="double"/>, <see langword="double"/>, <see langword="double"/>) with 
    ...
    /// values (<see cref="MagnitudeX"/>, <see cref="MagnitudeY"/>, <see cref="MagnitudeZ"/>), when expressed in SI units.</summary>
    public static explicit operator (double x, double y, double z)(AngularAcceleration3 a) => (a.MagnitudeX, a.MagnitudeY, a.MagnitudeZ);

    /// <summary>Converts the <see cref="AngularAcceleration3"/> to the <see cref="Vector3"/> with components of equal magnitude, when expressed in SI units.</summary>
    ...
    public static explicit operator Vector3(AngularAcceleration3 a) => new(a.MagnitudeX, a.MagnitudeY, a.MagnitudeZ);

    /// <summary>Constructs the <see cref="AngularAcceleration3"/> with components equal to the values of <paramref name="components"/>, when expressed in SI units.</summary>
    ...
    /// <summary>Constructs the <see cref="AngularAcceleration3"/> with components <paramref name="a"/>, when expressed in SI units.</summary>
