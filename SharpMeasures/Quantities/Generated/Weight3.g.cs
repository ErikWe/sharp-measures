...
/// is expressed in <see cref="UnitOfForce"/>, with the SI unit being [m / s].
/// <para>
...
/// <item>
/// <code>
/// <see cref="Weight3"/> a = (3, 5, 7) * <see cref="Weight.OneNewton"/>;
/// </code>
/// </item>
/// <item>
/// <code>
/// <see cref="Weight3"/> d = <see cref="Weight3.From(Mass, GravitationalAcceleration3)"/>;
/// </code>
/// </item>
/// <item>
/// <code>
/// <see cref="Weight3"/> e = <see cref="Force3.AsWeight3"/>;
/// </code>
/// </item>
/// </list>
    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>Converts the <see cref="Weight3"/> to an instance of the associated quantity <see cref="Force"/>, with components of
    ...
    /// <summary>Normalizes the <see cref="Weight3"/> - if expressed in SI units.</summary>
    ...
    /// <summary>Computes the transformation of the existing <see cref="Weight3"/> by <paramref name="transform"/>, resulting in
    /// a new <see cref="Weight3"/>.</summary>
    ...
    /// <summary>Produces a formatted string from the magnitudes of the components of the <see cref="Weight3"/> (in SI units),
    ...
    /// <param name="a">Unary plus is applied to this instance of <see cref="Weight3"/>.</param>
    public static Weight3 operator +(Weight3 a) => a;
    /// <summary>Negation, resulting in a <see cref="Weight3"/> with components negated from that of <paramref name="a"/>.</summary>
    /// <param name="a">Negation is applied to this instance of <see cref="Weight3"/>.</param>
    public static Weight3 operator -(Weight3 a) => new(-a.X, -a.Y, -a.Z);

    /// <summary>Multiplies the <see cref="Weight3"/> by the <see cref="Unhandled"/> quantity <paramref name="factor"/>
    ...
    /// <summary>Multiplies the <see cref="Weight3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiplies the <see cref="Unhandled"/> quantity <paramref name="b"/> by the <see cref="Weight3"/> <paramref name="a"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="Weight3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <param name="b">The remainder is retrieved from division of <see cref="Weight3"/> <paramref name="a"/> by this value.</param>
    ...
    /// <summary>Scales the <see cref="Weight3"/> by <paramref name="factor"/>.</summary>
    /// <param name="factor">The factor by which the <see cref="Weight3"/> is scaled.</param>
    public Weight3 Multiply(Scalar factor) => new(X * factor.Magnitude, Y * factor.Magnitude, Z * factor.Magnitude);
    /// <summary>Scales the <see cref="Weight3"/> through division by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The divisor, by which the <see cref="Weight3"/> is divided.</param>
    ...
    /// <summary>Multiples the <see cref="Weight3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiples the quantity <paramref name="a"/> by the <see cref="Weight3"/> <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="Weight3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    /// <param name="a">The <see cref="Weight3"/>, which is divided by <paramref name="b"/>.</param>
    ...
    /// <summary>Converts the <see cref="Weight3"/> to a (<see langword="double"/>, <see langword="double"/>, <see langword="double"/>) with values
    ...
    /// <summary>Converts the <see cref="Weight3"/> to the <see cref="Vector3"/> with components of
    ...
    /// <summary>Constructs the <see cref="Weight3"/> with components equal to the values of <paramref name="components"/>,
    ...
    /// <summary>Converts <paramref name="a"/> to the <see cref="Weight3"/> with components of equal magnitude,
    /// when expressed in SI units.</summary>
