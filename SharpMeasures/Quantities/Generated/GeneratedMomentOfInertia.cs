...
public readonly partial record struct MomentOfInertia :
    ...
    IScalarQuantity<MomentOfInertia>,
    IAddableScalarQuantity<MomentOfInertia, MomentOfInertia>,
    ISubtractableScalarQuantity<MomentOfInertia, MomentOfInertia>,
    IDivisibleScalarQuantity<Scalar, MomentOfInertia>
{
    ...
    /// <summary>Constructs a new <see cref="MomentOfInertia"/>, with magnitude <paramref name="magnitude"/> in unit <paramref name="unitOfMomentOfInertia"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="MomentOfInertia"/>, in unit <paramref name="unitOfMomentOfInertia"/>.</param>
    /// <param name="unitOfMomentOfInertia">The unit in which the magnitude, <paramref name="magnitude"/>, is expressed.</param>
    /// <remarks>Instances may also be constructed according to:
    /// <list type="bullet">
    /// <item>
    /// <code>
    /// <see cref="MomentOfInertia"/> a = 2.6 * <see cref="MomentOfInertia.OneKilogramMetreSquared"/>;
    /// </code>
    /// </item>
    /// </list>
    /// </remarks>
    ...
    /// <remarks>Prefer using a constructor that requires a <see cref="UnitOfMomentOfInertia"/> to be specified.</remarks>
    ...
    /// <summary>Produces a <see cref="Scalar"/> with magnitude equal to that of the <see cref="MomentOfInertia"/>, expressed in unit <paramref name="unitOfMomentOfInertia"/>.</summary>
    /// <param name="unitOfMomentOfInertia">The unit in which the magnitude is expressed.</param>
    public Scalar InUnit(UnitOfMomentOfInertia unitOfMomentOfInertia) => InUnit(Magnitude, unitOfMomentOfInertia);
    /// <summary>Produces a <see cref="Scalar"/> from the magnitude of a <see cref="MomentOfInertia"/>, expressed in unit <paramref name="unitOfMomentOfInertia"/>.</summary>
    /// <param name="magnitude">The magnitude of the instance of <see cref="MomentOfInertia"/>.</param>
    /// <param name="unitOfMomentOfInertia">The unit in which the magnitude is expressed.</param>
    private static Scalar InUnit(double magnitude, UnitOfMomentOfInertia unitOfMomentOfInertia) => new(magnitude / unitOfMomentOfInertia.Factor);
    ...
    /// <summary>Adds this instance and the <see cref="MomentOfInertia"/> <paramref name="term"/>, producing another <see cref="MomentOfInertia"/>.</summary>
    /// <param name="term">This <see cref="MomentOfInertia"/> is added to this instance.</param>
    public MomentOfInertia Add(MomentOfInertia term) => new(Magnitude + term.Magnitude);
    /// <summary>Subtracts the <see cref="MomentOfInertia"/> <paramref name="term"/> from this instance, producing another <see cref="MomentOfInertia"/>.</summary>
    /// <param name="term">This <see cref="MomentOfInertia"/> is subtracted from this instance.</param>
    public MomentOfInertia Subtract(MomentOfInertia term) => new(Magnitude - term.Magnitude);
    /// <summary>Adds the instances of <see cref="MomentOfInertia"/>, <paramref name="x"/> and <paramref name="y"/> - producing another <see cref="MomentOfInertia"/>.</summary>
    /// <param name="x">This <see cref="MomentOfInertia"/> is added to the <see cref="MomentOfInertia"/> <paramref name="y"/>.</param>
    /// <param name="y">This <see cref="MomentOfInertia"/> is added to the <see cref="MomentOfInertia"/> <paramref name="x"/>.</param>
    public static MomentOfInertia operator +(MomentOfInertia x, MomentOfInertia y) => x.Add(y);
    /// <summary>Subtract the <see cref="MomentOfInertia"/> <paramref name="y"/> from the <see cref="MomentOfInertia"/> <paramref name="x"/>, producing another <see cref="MomentOfInertia"/>.</summary>
    /// <param name="x">The <see cref="MomentOfInertia"/> <paramref name="y"/> is subtracted from this <see cref="MomentOfInertia"/>.</param>
    /// <param name="y">This <see cref="MomentOfInertia"/> is subtracted from the <see cref="MomentOfInertia"/> <paramref name="x"/>.</param>
    public static MomentOfInertia operator -(MomentOfInertia x, MomentOfInertia y) => x.Subtract(y);

    /// <summary>Divides this <see cref="MomentOfInertia"/> by the <see cref="MomentOfInertia"/> <paramref name="divisor"/> - producing a <see cref="Scalar"/>.</summary>
    /// <param name="divisor">The <see cref="MomentOfInertia"/> is divided by this <see cref="MomentOfInertia"/>.</param>
    public Scalar Divide(MomentOfInertia divisor) => new(Magnitude / divisor.Magnitude);
    /// <summary>Divides the <see cref="MomentOfInertia"/> <paramref name="x"/> by the <see cref="MomentOfInertia"/> <paramref name="y"/> - producing a <see cref="Scalar"/>.</summary>
    /// <param name="x">This <see cref="MomentOfInertia"/> is divided by the <see cref="MomentOfInertia"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="MomentOfInertia"/> <paramref name="x"/> is divided by this <see cref="MomentOfInertia"/>.</param>
    public static Scalar operator /(MomentOfInertia x, MomentOfInertia y) => x.Divide(y)
;
    ...
    /// <param name="x"><paramref name="y"/> is compared against this value.</param>
    /// <param name="y"><paramref name="x"/> is compared against this value.</param>
    public static bool operator <=(MomentOfInertia x, MomentOfInertia y) => !(x > y);
    ...
    /// <summary>Converts <paramref name="x"/> to a <see cref="double"/> based on the magnitude of the <see cref="MomentOfInertia"/> <paramref name="x"/>.</summary>
