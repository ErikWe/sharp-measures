...
/// <list type="bullet">
/// <item>
/// <code><see cref="Time"/> a = 3 * <see cref="Time.OneSecond"/>;</code>
/// </item>
/// <item>
/// <code><see cref="Time"/> d = <see cref="Time.From(Distance, Speed)"/>;</code>
/// </item>
/// </list>
    ...
    IGenericallyDivisibleScalarQuantity
{
    ...
    /// <summary>Division of the <see cref="Unhandled"/> quantity <paramref name="x"/> by the <see cref="Time"/> <paramref name="y"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    /// <param name="x">The <see cref="Unhandled"/> quantity, which is divided by the <see cref="Time"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="Time"/> by which the <see cref="Unhandled"/> quantity <paramref name="x"/> is divided.</param>
    public static Unhandled operator /(Unhandled x, Time y) => new(x.Magnitude / y.Magnitude);
