...
/// <item>
/// <code>
/// <see cref="#Param:quantity"/> d = <see cref="Time.From(Distance, Speed)"/>;
/// </code>
/// </item>
/// </list>
    ...
    IGenericallyDivisibleScalarQuantity
{
    ...
    /// <summary>Computes <see cref="Time"/> according to { <see cref="Time"/> = 1 / <paramref name="frequency"/> }.</summary>
    ...
    /// <summary>Computes <see cref="Time"/> according to { <see cref="Time"/> = √<paramref name="timeSquared"/> }.</summary>
    ...
    /// <item>
    /// <code>
    /// <see cref="Time"/> a = 3 * <see cref="Time.OneFemtosecond"/>;
    /// </code>
    /// </item>
    /// </list>
    /// </remarks>
    ...
    /// <summary>Produces a <see cref="Time"/>, with magnitude equal to the absolute of the original magnitude.</summary>
    public Time Absolute() => new(Math.Abs(Magnitude));
    /// <summary>Produces a <see cref="Time"/>, with magnitude equal to the floor of the original magnitude.</summary>
    public Time Floor() => new(Math.Floor(Magnitude));
    /// <summary>Produces a <see cref="Time"/>, with magnitude equal to the ceiling of the original magnitude.</summary>
    public Time Ceiling() => new(Math.Ceiling(Magnitude));
    /// <summary>Produces a <see cref="Time"/>, with magnitude equal to the original magnitude, rounded to the nearest integer.</summary>
    ...
    /// <summary>Multiplies the <see cref="Unhandled"/> quantity <paramref name="y"/> by the <see cref="Time"/> <paramref name="x"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    ...
    /// <param name="y">The remainder is retrieved from division of <see cref="Time"/> <paramref name="x"/> by this value.</param>
...
/// <param name="y">The <see cref="Time"/>, which is inverted to a <see cref="Frequency"/> and scaled by <paramref name="x"/>.</param>
    ...
    /// by <paramref name="y"/>.</summary>
    /// <param name="x">The <see cref="Time"/>, which is divided by <paramref name="y"/> to produce a remainder.</param>
    /// <param name="y">The remainder is retrieved from division of the <see cref="Time"/> <paramref name="x"/> by this value.</param>
