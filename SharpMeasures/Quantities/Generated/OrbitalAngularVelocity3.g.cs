    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>Converts the <see cref="OrbitalAngularVelocity3"/> to an instance of the associated quantity <see cref="AngularVelocity"/>, with components of
    /// equal magnitudes.</summary>
    public AngularVelocity3 AsAngularVelocity3() => new(X, Y, Z);
    /// <summary>Converts the <see cref="OrbitalAngularVelocity3"/> to an instance of the associated quantity <see cref="SpinAngularVelocity"/>, with components of
    /// equal magnitudes.</summary>
    ...
    /// <summary>Retrieves the magnitudes of the components of the <see cref="OrbitalAngularVelocity3"/>, expressed in <see cref="UnitOfAngularVelocity.TurnPerSecond"/>.</summary>
    ...
    /// <summary>Normalizes the <see cref="OrbitalAngularVelocity3"/> - if expressed in SI units.</summary>
    ...
    /// <summary>Computes the transformation of the existing <see cref="OrbitalAngularVelocity3"/> by <paramref name="transform"/>, resulting in
    /// a new <see cref="OrbitalAngularVelocity3"/>.</summary>
    ...
    /// <cref name="OrbitalAngularSpeed"/>.</summary>
    ...
    /// <summary>Produces a formatted string from the magnitudes of the components of the <see cref="OrbitalAngularVelocity3"/> (in SI units),
    ...
    /// <param name="a">Unary plus is applied to this instance of <see cref="OrbitalAngularVelocity3"/>.</param>
    public static OrbitalAngularVelocity3 operator +(OrbitalAngularVelocity3 a) => a;
    /// <summary>Negation, resulting in a <see cref="OrbitalAngularVelocity3"/> with components negated from that of <paramref name="a"/>.</summary>
    /// <param name="a">Negation is applied to this instance of <see cref="OrbitalAngularVelocity3"/>.</param>
    public static OrbitalAngularVelocity3 operator -(OrbitalAngularVelocity3 a) => new(-a.X, -a.Y, -a.Z);

    /// <summary>Multiplies the <see cref="OrbitalAngularVelocity3"/> by the <see cref="Unhandled"/> quantity <paramref name="factor"/>
    ...
    /// <summary>Multiplies the <see cref="OrbitalAngularVelocity3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiplies the <see cref="Unhandled"/> quantity <paramref name="b"/> by the <see cref="OrbitalAngularVelocity3"/> <paramref name="a"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="OrbitalAngularVelocity3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <param name="b">The remainder is retrieved from division of <see cref="OrbitalAngularVelocity3"/> <paramref name="a"/> by this value.</param>
    ...
    /// <summary>Multiples the <see cref="OrbitalAngularVelocity3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiples the quantity <paramref name="a"/> by the <see cref="OrbitalAngularVelocity3"/> <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="OrbitalAngularVelocity3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    /// <param name="a">The <see cref="OrbitalAngularVelocity3"/>, which is divided by <paramref name="b"/>.</param>
    ...
    /// <summary>Converts the <see cref="OrbitalAngularVelocity3"/> to a (<see langword="double"/>, <see langword="double"/>, <see langword="double"/>) with values
    ...
    /// <summary>Converts the <see cref="OrbitalAngularVelocity3"/> to the <see cref="Vector3"/> with components of
    ...
    /// <summary>Converts <paramref name="a"/> to the <see cref="OrbitalAngularVelocity3"/> with components of equal magnitude,
    /// when expressed in SI units.</summary>
