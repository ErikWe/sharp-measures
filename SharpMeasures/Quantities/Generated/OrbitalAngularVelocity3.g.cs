...
/// </item>
/// <item>
/// <code><see cref="OrbitalAngularVelocity3"/> d = <see cref="OrbitalAngularVelocity3.From(Rotation3, Time)"/>; </code>
/// </item>
/// <item>
/// <code><see cref="OrbitalAngularVelocity3"/> e = <see cref="AngularVelocity3.AsOrbitalAngularVelocity"/>;</code>
/// </item>
/// </list>
    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>The X-component of the <see cref="OrbitalAngularVelocity3"/>.</summary>
    public OrbitalAngularSpeed X => new(MagnitudeX);
    /// <summary>The Y-component of the <see cref="OrbitalAngularVelocity3"/>.</summary>
    public OrbitalAngularSpeed Y => new(MagnitudeY);
    /// <summary>The Z-component of the <see cref="OrbitalAngularVelocity3"/>.</summary>
    public OrbitalAngularSpeed Z => new(MagnitudeZ);
    ...
    public OrbitalAngularVelocity3(Vector3 components) : this(components.MagnitudeX, components.MagnitudeY, components.MagnitudeZ) { }
    /// <summary>Constructs a new <see cref="OrbitalAngularVelocity3"/> with components of magnitudes <paramref name="components"/>.</summary>
    /// <param name="components">The magnitudes of the components of the <see cref="OrbitalAngularVelocity3"/>.</param>
    ...
    /// equal magnitudes.</summary>
    public SpinAngularVelocity3 AsSpinAngularVelocity => new(MagnitudeX, MagnitudeY, MagnitudeZ);
    ...
    public OrbitalAngularVelocity3 Negate() => new(-MagnitudeX, -MagnitudeY, -MagnitudeZ);
    ...
    public static OrbitalAngularVelocity3 operator -(OrbitalAngularVelocity3 a) => new(-a.MagnitudeX, -a.MagnitudeY, -a.MagnitudeZ);
    ...
    public static Unhandled3 operator *(OrbitalAngularVelocity3 a, Unhandled b) => new(a.MagnitudeX * b.Magnitude, a.MagnitudeY * b.Magnitude, a.MagnitudeZ * b.Magnitude);
    ...
    public static Unhandled3 operator *(Unhandled a, OrbitalAngularVelocity3 b) => new(a.Magnitude * b.MagnitudeX, a.Magnitude * b.MagnitudeY, a.Magnitude * b.MagnitudeZ);
    ...
    public OrbitalAngularVelocity3 Remainder(double divisor) => new(MagnitudeX % divisor, MagnitudeY % divisor, MagnitudeZ % divisor);
    ...
    public OrbitalAngularVelocity3 Multiply(double factor) => new(MagnitudeX * factor, MagnitudeY * factor, MagnitudeZ * factor);
    /// <summary>Scales the <see cref="OrbitalAngularVelocity3"/> through division by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The divisor, by which the <see cref="OrbitalAngularVelocity3"/> is divided.</param>
    public OrbitalAngularVelocity3 Divide(double divisor) => new(MagnitudeX / divisor, MagnitudeY / divisor, MagnitudeZ / divisor);
    /// <summary>Produces a <see cref="OrbitalAngularVelocity3"/>, with each component equal to the remainder from division of the
    ...
    public static OrbitalAngularVelocity3 operator %(OrbitalAngularVelocity3 a, double b) => new(a.MagnitudeX % b, a.MagnitudeY % b, a.MagnitudeZ % b);
    ...
    public static OrbitalAngularVelocity3 operator *(double a, OrbitalAngularVelocity3 b) => new(a * b.MagnitudeX, a * b.MagnitudeY, a * b.MagnitudeZ);
    ...
    /// magnitude of the original component by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The remainder is produced from division by this value.</param>
    public OrbitalAngularVelocity3 Remainder(Scalar divisor) => new(MagnitudeX % divisor.Magnitude, MagnitudeY % divisor.Magnitude, MagnitudeZ % divisor.Magnitude);
    /// <summary>Scales the <see cref="OrbitalAngularVelocity3"/> by <paramref name="factor"/>.</summary>
    /// <param name="factor">The factor by which the <see cref="OrbitalAngularVelocity3"/> is scaled.</param>
    public OrbitalAngularVelocity3 Multiply(Scalar factor) => new(MagnitudeX * factor.Magnitude, MagnitudeY * factor.Magnitude, MagnitudeZ * factor.Magnitude);
    /// <summary>Scales the <see cref="OrbitalAngularVelocity3"/> through division by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The divisor, by which the <see cref="OrbitalAngularVelocity3"/> is divided.</param>
    public OrbitalAngularVelocity3 Divide(Scalar divisor) => new(MagnitudeX / divisor.Magnitude, MagnitudeY / divisor.Magnitude, MagnitudeZ / divisor.Magnitude);
    /// <summary>Produces a <see cref="OrbitalAngularVelocity3"/>, with each component equal to the remainder from division of the
    /// magnitude of the component of <paramref name="a"/> by <paramref name="b"/>.</summary>
    /// <param name="a">The <see cref="OrbitalAngularVelocity3"/>, the components of which are divided by <paramref name="b"/> to produce a remainder.</param>
    /// <param name="b">The remainder is produced from division of <see cref="OrbitalAngularVelocity3"/> <paramref name="a"/> by this value.</param>
    public static OrbitalAngularVelocity3 operator %(OrbitalAngularVelocity3 a, Scalar b) => new(a.MagnitudeX % b.Magnitude, a.MagnitudeY % b.Magnitude, a.MagnitudeZ % b.Magnitude);
    /// <summary>Scales the <see cref="OrbitalAngularVelocity3"/> <paramref name="a"/> by <paramref name="b"/>.</summary>
    /// <param name="a">The <see cref="OrbitalAngularVelocity3"/>, which is scaled by <paramref name="b"/>.</param>
    /// <param name="b">This value is used to scale the <see cref="OrbitalAngularVelocity3"/> <paramref name="a"/>.</param>
    public static OrbitalAngularVelocity3 operator *(OrbitalAngularVelocity3 a, Scalar b) => new(a.MagnitudeX * b.Magnitude, a.MagnitudeY * b.Magnitude, a.MagnitudeZ * b.Magnitude);
    ...
    /// <param name="a">This value is used to scale the <see cref="OrbitalAngularVelocity3"/> <paramref name="b"/>.</param>
    /// <param name="b">The <see cref="OrbitalAngularVelocity3"/>, which is scaled by <paramref name="a"/>.</param>
    public static OrbitalAngularVelocity3 operator *(Scalar a, OrbitalAngularVelocity3 b) => new(a.Magnitude * b.MagnitudeX, a.Magnitude * b.MagnitudeY, a.Magnitude * b.MagnitudeZ);
    /// <summary>Scales the <see cref="OrbitalAngularVelocity3"/> <paramref name="a"/> through division by <paramref name="b"/>.</summary>
    /// <param name="a">The <see cref="OrbitalAngularVelocity3"/>, which is divided by <paramref name="b"/>.</param>
    /// <param name="b">This value is used to divide the <see cref="OrbitalAngularVelocity3"/> <paramref name="a"/>.</param>
    public static OrbitalAngularVelocity3 operator /(OrbitalAngularVelocity3 a, Scalar b) => new(a.MagnitudeX / b.Magnitude, a.MagnitudeY / b.Magnitude, a.MagnitudeZ / b.Magnitude);
    ...
    /// values (<see cref="MagnitudeX"/>, <see cref="MagnitudeY"/>, <see cref="MagnitudeZ"/>), when expressed in SI units.</summary>
    public static explicit operator (double x, double y, double z)(OrbitalAngularVelocity3 a) => (a.MagnitudeX, a.MagnitudeY, a.MagnitudeZ);
    ...
    public static explicit operator Vector3(OrbitalAngularVelocity3 a) => new(a.MagnitudeX, a.MagnitudeY, a.MagnitudeZ);
