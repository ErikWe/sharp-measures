...
/// This is the magnitude of the vector quantity <see cref="OrbitalAngularMomentum3"/>, and is expressed in <see cref="UnitOfSpinAngularMomentum"/>, with the SI unit being [kg * m² / s].
/// <para>
...
/// </item>
/// </list>
/// The magnitude of the <see cref="SpinAngularMomentum"/> can be retrieved in the desired <see cref="UnitOfSpinAngularMomentum"/> using pre-defined properties,
    ...
    IVector3MultiplicableScalarQuantity<SpinAngularMomentum3, Vector3>
{
    ...
    /// <summary>Constructs a new <see cref="SpinAngularMomentum"/> with magnitude <paramref name="magnitude"/>, expressed in <paramref name="unitOfSpinAngularMomentum"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="SpinAngularMomentum"/>, expressed in <paramref name="unitOfSpinAngularMomentum"/>.</param>
    ...
    /// <remarks>Consider preferring <see cref="SpinAngularMomentum(Scalar, UnitOfSpinAngularMomentum)"/>.</remarks>
    public SpinAngularMomentum(Scalar magnitude) : this(magnitude.Magnitude) { }
    /// <summary>Constructs a new <see cref="SpinAngularMomentum"/> with magnitude <paramref name="magnitude"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="SpinAngularMomentum"/>.</param>
    /// <remarks>Consider preferring <see cref="SpinAngularMomentum(double, UnitOfSpinAngularMomentum)"/>.</remarks>
    ...
    /// <summary>Retrieves the magnitude of the <see cref="SpinAngularMomentum"/>, expressed in <see cref="UnitOfSpinAngularMomentum.KilogramMetreSquaredPerSecond"/>.</summary>
    public Scalar KilogramMetresSquaredPerSecond => InUnit(UnitOfSpinAngularMomentum.KilogramMetreSquaredPerSecond);
    ...
    /// <summary>Produces a formatted string from the magnitude of the <see cref="SpinAngularMomentum"/> (in SI units), and the SI base unit of the quantity.</summary>
    ...
    /// expressed in <paramref name="unitOfSpinAngularMomentum"/>.</summary>
    /// <param name="spinAngularMomentum">The <see cref="SpinAngularMomentum"/> to be expressed in <paramref name="unitOfSpinAngularMomentum"/>.</param>
    /// <param name="unitOfSpinAngularMomentum">The <see cref="UnitOfSpinAngularMomentum"/> in which the magnitude is expressed.</param>
    ...
    public static Unhandled operator *(SpinAngularMomentum x, IScalarQuantity y) => x.Multiply<Unhandled, IScalarQuantity>(y, (m) => new Unhandled(m));
    ...
    public static Unhandled operator /(SpinAngularMomentum x, IScalarQuantity y) => x.Divide<Unhandled, IScalarQuantity>(y, (m) => new Unhandled(m));
    ...
    /// <summary>Multiplies the <see cref="SpinAngularMomentum"/> with the values of <paramref name="components"/> to produce a <see cref="SpinAngularMomentum3"/>.</summary>
    ...
    /// <summary>Multiplies the <see cref="SpinAngularMomentum"/> <paramref name="a"/> with the values of <paramref name="b"/> to produce a <see cref="SpinAngularMomentum3"/>.</summary>
    ...
    /// <summary>Multiplies the <see cref="SpinAngularMomentum"/> <parmref name="b"/> with the values of <paramref name="a"/> to produce a <see cref="SpinAngularMomentum3"/>.</summary>
    ...
    /// <summary>Converts <paramref name="x"/> to the <see cref="SpinAngularMomentum"/> of magnitude <paramref name="x"/>, when expressed
    /// in SI units.</summary>
    ...
    /// <summary>Converts <paramref name="x"/> to the <see cref="SpinAngularMomentum"/> of equivalent magnitude, when expressed in SI units.</summary>
