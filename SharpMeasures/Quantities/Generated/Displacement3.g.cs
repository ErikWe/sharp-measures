...
/// <item>
/// <code>
/// <see cref="Displacement3"/> a = (3, 5, 7) * <see cref="Length.OneFemtometre"/>;
/// </code>
/// </item>
/// <item>
/// <code>
...
/// <item>
/// <code>
/// <see cref="Displacement3"/> e = <see cref="Position3.AsDisplacement3()"/>;
/// </code>
/// </item>
/// </list>
    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>Normalizes the <see cref="Displacement3"/> - if expressed in SI units.</summary>
    ...
    /// <summary>Computes the transformation of the existing <see cref="Displacement3"/> by <paramref name="transform"/>, resulting in
    /// a new <see cref="Displacement3"/>.</summary>
    ...
    /// <cref see="Displacement3"/>.</summary>
    ...
    /// <summary>Produces a formatted string from the magnitudes of the components of the <see cref="Displacement3"/> (in SI units),
    ...
    /// <param name="a">Unary plus is applied to this instance of <see cref="Displacement3"/>.</param>
    public static Displacement3 operator +(Displacement3 a) => a;
    /// <summary>Negation, resulting in a <see cref="Displacement3"/> with components negated from that of <paramref name="a"/>.</summary>
    /// <param name="a">Negation is applied to this instance of <see cref="Displacement3"/>.</param>
    public static Displacement3 operator -(Displacement3 a) => new(-a.X, -a.Y, -a.Z);

    /// <summary>Multiplies the <see cref="Displacement3"/> by the <see cref="Unhandled"/> quantity <paramref name="factor"/>
    ...
    /// <summary>Multiplies the <see cref="Displacement3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiplies the <see cref="Unhandled"/> quantity <paramref name="b"/> by the <see cref="Displacement3"/> <paramref name="a"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="Displacement3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <param name="b">The remainder is retrieved from division of <see cref="Displacement3"/> <paramref name="a"/> by this value.</param>
    ...
    /// <summary>Multiples the <see cref="Displacement3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiples the quantity <paramref name="a"/> by the <see cref="Displacement3"/> <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="Displacement3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    /// <param name="a">The <see cref="Displacement3"/>, which is divided by <paramref name="b"/>.</param>
    ...
    /// <summary>Converts the <see cref="Displacement3"/> to a (<see langword="double"/>, <see langword="double"/>, <see langword="double"/>) with values
    ...
    /// <summary>Converts the <see cref="Displacement3"/> to the <see cref="Vector3"/> with components of
    ...
    /// <summary>Constructs the <see cref="Displacement3"/> with components equal to the values of <paramref name="components"/>,
    ...
    /// <summary>Converts <paramref name="a"/> to the <see cref="Displacement3"/> with components of equal magnitude,
    /// when expressed in SI units.</summary>
