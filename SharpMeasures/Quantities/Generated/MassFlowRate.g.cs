...
/// </item>
/// </list>
/// The magnitude of the measure can be retrieved using pre-defined properties, prefixed with 'In', followed by the desired <see cref="UnitOfMassFlowRate"/>.
/// </para>
/// </summary>
    ...
    IGenericallyDivisibleScalarQuantity
{
    ...
    /// <summary>Constructs a new <see cref="MassFlowRate"/>, with magnitude <paramref name="magnitude"/> in <see cref="UnitOfMassFlowRate"/> <paramref name="unitOfMassFlowRate"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="MassFlowRate"/>, in <see cref="UnitOfMassFlowRate"/> <paramref name="unitOfMassFlowRate"/>.</param>
    ...
    /// <remarks>Consider preffering a constructor that requires a <see cref="UnitOfMassFlowRate"/> to be specified.</remarks>
    public MassFlowRate(Scalar magnitude) : this(magnitude.Magnitude) { }
    /// <summary>Constructs a new <see cref="MassFlowRate"/>, with magnitude <paramref name="magnitude"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="MassFlowRate"/>.</param>
    /// <remarks>Consider preferring a constructor that requires a <see cref="UnitOfMassFlowRate"/> to be specified.</remarks>
    ...
    /// <summary>Produces a <see cref="Scalar"/> with magnitude equal to that of the <see cref="MassFlowRate"/>, expressed in <see cref="UnitOfMassFlowRate"/>
    /// <paramref name="unitOfMassFlowRate"/>.</summary>
    ...
    /// <summary>Produces a <see cref="Scalar"/> from the magnitude of a <see cref="MassFlowRate"/>, expressed in <see cref="UnitOfMassFlowRate"/>
    /// <paramref name="unitOfMassFlowRate"/>.</summary>
    /// <param name="massFlowRate">The <see cref="MassFlowRate"/> to be expressed in <see cref="UnitOfMassFlowRate"/> <paramref name="unitOfMassFlowRate"/>.</param>
    /// <param name="unitOfMassFlowRate">The <see cref="UnitOfMassFlowRate"/> in which the magnitude is expressed.</param>
    ...
    /// <summary>Converts the <see cref="MassFlowRate"/> to a <see cref="double"/> with value <see cref="Magnitude"/>.</summary>
    public double ToDouble() => Magnitude;
    /// <summary>Converts the <see cref="MassFlowRate"/> to a <see cref="double"/> based on the magnitude of the <see cref="MassFlowRate"/> <paramref name="x"/>.</summary>
    public static implicit operator double(MassFlowRate x) => x.ToDouble();

    /// <summary>Converts the <see cref="MassFlowRate"/> to the <see cref="Scalar"/> of equivalent magnitude.</summary>
