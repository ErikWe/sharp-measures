    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>Retrieves the magnitudes of the components of the <see cref="AngularVelocity3"/>, expressed in <see cref="UnitOfAngularVelocity.TurnPerSecond"/>.</summary>
    ...
    /// <summary>Normalizes the <see cref="AngularVelocity3"/> - if expressed in SI units.</summary>
    ...
    /// <summary>Computes the transformation of the existing <see cref="AngularVelocity3"/> by <paramref name="transform"/>, resulting in
    /// a new <see cref="AngularVelocity3"/>.</summary>
    ...
    /// <cref name="AngularSpeed"/>.</summary>
    ...
    /// <summary>Produces a formatted string from the magnitudes of the components of the <see cref="AngularVelocity3"/> (in SI units),
    ...
    /// <param name="a">Unary plus is applied to this instance of <see cref="AngularVelocity3"/>.</param>
    public static AngularVelocity3 operator +(AngularVelocity3 a) => a;
    /// <summary>Negation, resulting in a <see cref="AngularVelocity3"/> with components negated from that of <paramref name="a"/>.</summary>
    /// <param name="a">Negation is applied to this instance of <see cref="AngularVelocity3"/>.</param>
    public static AngularVelocity3 operator -(AngularVelocity3 a) => new(-a.X, -a.Y, -a.Z);

    /// <summary>Multiplies the <see cref="AngularVelocity3"/> by the <see cref="Unhandled"/> quantity <paramref name="factor"/>
    ...
    /// <summary>Multiplies the <see cref="AngularVelocity3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiplies the <see cref="Unhandled"/> quantity <paramref name="b"/> by the <see cref="AngularVelocity3"/> <paramref name="a"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="AngularVelocity3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <param name="b">The remainder is retrieved from division of <see cref="AngularVelocity3"/> <paramref name="a"/> by this value.</param>
    ...
    /// <summary>Multiples the <see cref="AngularVelocity3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiples the quantity <paramref name="a"/> by the <see cref="AngularVelocity3"/> <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="AngularVelocity3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    /// <param name="a">The <see cref="AngularVelocity3"/>, which is divided by <paramref name="b"/>.</param>
    ...
    /// <summary>Converts the <see cref="AngularVelocity3"/> to a (<see langword="double"/>, <see langword="double"/>, <see langword="double"/>) with values
    ...
    /// <summary>Converts the <see cref="AngularVelocity3"/> to the <see cref="Vector3"/> with components of
    ...
    /// <summary>Constructs the <see cref="AngularVelocity3"/> with components equal to the values of <paramref name="components"/>,
    ...
    /// <summary>Converts <paramref name="a"/> to the <see cref="AngularVelocity3"/> with components of equal magnitude,
    /// when expressed in SI units.</summary>
