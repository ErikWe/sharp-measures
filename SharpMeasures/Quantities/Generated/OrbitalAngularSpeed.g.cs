...
/// <list type="bullet">
/// <item>
/// <code><see cref="OrbitalAngularSpeed"/> a = 3 * <see cref="OrbitalAngularSpeed.OneRadianPerSecond"/>;</code>
/// </item>
/// <item>
/// <code><see cref="OrbitalAngularSpeed"/> d = <see cref="OrbitalAngularSpeed.From(Angle, Time)"/>;</code>
/// </item>
/// <item>
/// <code><see cref="OrbitalAngularSpeed"/> e = <see cref="AngularSpeed.AsOrbitalAngularSpeed"/>;</code>
/// </item>
/// </list>
    ...
    IVector3MultiplicableScalarQuantity<OrbitalAngularVelocity3, Vector3>
{
    ...
    /// <summary>Division of the <see cref="Unhandled"/> quantity <paramref name="x"/> by the <see cref="OrbitalAngularSpeed"/> <paramref name="y"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    /// <param name="x">The <see cref="Unhandled"/> quantity, which is divided by the <see cref="OrbitalAngularSpeed"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="OrbitalAngularSpeed"/> by which the <see cref="Unhandled"/> quantity <paramref name="x"/> is divided.</param>
    public static Unhandled operator /(Unhandled x, OrbitalAngularSpeed y) => new(x.Magnitude / y.Magnitude);
