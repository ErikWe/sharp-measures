    ...
    IVector3MultiplicableScalarQuantity<OrbitalAngularVelocity3, Vector3>
{
    ...
    /// <summary>Retrieves the magnitude of the <see cref="OrbitalAngularSpeed"/>, expressed in <see cref="UnitOfAngularVelocity.TurnPerSecond"/>.</summary>
    ...
    /// <summary>Produces a formatted string from the magnitude of the <see cref="OrbitalAngularSpeed"/> (in SI units), and the SI base unit of the quantity.</summary>
    ...
    public static Unhandled operator *(OrbitalAngularSpeed x, IScalarQuantity y) => x.Multiply<Unhandled, IScalarQuantity>(y, (m) => new Unhandled(m));
    ...
    public static Unhandled operator /(OrbitalAngularSpeed x, IScalarQuantity y) => x.Divide<Unhandled, IScalarQuantity>(y, (m) => new Unhandled(m));
    ...
    /// <summary>Multiplies the <see cref="OrbitalAngularSpeed"/> with the values of <paramref name="components"/> to produce a <see cref="OrbitalAngularVelocity3"/>.</summary>
    ...
    /// <summary>Multiplies the <see cref="OrbitalAngularSpeed"/> <paramref name="a"/> with the values of <paramref name="b"/> to produce a <see cref="OrbitalAngularVelocity3"/>.</summary>
    ...
    /// <summary>Multiplies the <see cref="OrbitalAngularSpeed"/> <parmref name="b"/> with the values of <paramref name="a"/> to produce a <see cref="OrbitalAngularVelocity3"/>.</summary>
    ...
    /// <summary>Converts <paramref name="x"/> to the <see cref="OrbitalAngularSpeed"/> of magnitude <paramref name="x"/>, when expressed
    /// in SI units.</summary>
    ...
    /// <summary>Converts <paramref name="x"/> to the <see cref="OrbitalAngularSpeed"/> of equivalent magnitude, when expressed in SI units.</summary>
