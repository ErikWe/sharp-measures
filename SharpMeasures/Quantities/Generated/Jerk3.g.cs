    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(Jerk3 a, IScalarQuantity b) => a.Multiply(b, (x, y, z) => new Unhandled3(x, y, z));
    ...
    /// Func{double, double, double, TProductVector3Quantity})"/>.</remarks>
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(IScalarQuantity a, Jerk3 b) => b.Multiply(a, (x, y, z) => new Unhandled3(x, y, z));
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator /(Jerk3 a, IScalarQuantity b) => a.Divide(b, (x, y, z) => new Unhandled3(x, y, z));
