...
/// </item>
/// </list>
/// The magnitude of the measure can be retrieved using pre-defined properties, prefixed with 'In', followed by the desired <see cref="UnitOfFrequencyDrift"/>.
/// </para>
/// </summary>
    ...
    IGenericallyDivisibleScalarQuantity
{
    ...
    /// <summary>Constructs a new <see cref="FrequencyDrift"/>, with magnitude <paramref name="magnitude"/> in <see cref="UnitOfFrequencyDrift"/> <paramref name="unitOfFrequencyDrift"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="FrequencyDrift"/>, in <see cref="UnitOfFrequencyDrift"/> <paramref name="unitOfFrequencyDrift"/>.</param>
    ...
    /// <remarks>Consider preffering a constructor that requires a <see cref="UnitOfFrequencyDrift"/> to be specified.</remarks>
    public FrequencyDrift(Scalar magnitude) : this(magnitude.Magnitude) { }
    /// <summary>Constructs a new <see cref="FrequencyDrift"/>, with magnitude <paramref name="magnitude"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="FrequencyDrift"/>.</param>
    /// <remarks>Consider preferring a constructor that requires a <see cref="UnitOfFrequencyDrift"/> to be specified.</remarks>
    ...
    /// <summary>Produces a <see cref="Scalar"/> with magnitude equal to that of the <see cref="FrequencyDrift"/>, expressed in <see cref="UnitOfFrequencyDrift"/>
    /// <paramref name="unitOfFrequencyDrift"/>.</summary>
    ...
    /// <summary>Produces a <see cref="Scalar"/> from the magnitude of a <see cref="FrequencyDrift"/>, expressed in <see cref="UnitOfFrequencyDrift"/>
    /// <paramref name="unitOfFrequencyDrift"/>.</summary>
    /// <param name="frequencyDrift">The <see cref="FrequencyDrift"/> to be expressed in <see cref="UnitOfFrequencyDrift"/> <paramref name="unitOfFrequencyDrift"/>.</param>
    /// <param name="unitOfFrequencyDrift">The <see cref="UnitOfFrequencyDrift"/> in which the magnitude is expressed.</param>
...
/// <param name="y">The <see cref="FrequencyDrift"/>, which is inverted to a <see cref="TimeSquared"/> and scaled by <paramref name="x"/>.</param>
    ...
    /// <summary>Converts the <see cref="FrequencyDrift"/> to a <see cref="double"/> with value <see cref="Magnitude"/>.</summary>
    public double ToDouble() => Magnitude;
    /// <summary>Converts the <see cref="FrequencyDrift"/> to a <see cref="double"/> based on the magnitude of the <see cref="FrequencyDrift"/> <paramref name="x"/>.</summary>
    public static implicit operator double(FrequencyDrift x) => x.ToDouble();

    /// <summary>Converts the <see cref="FrequencyDrift"/> to the <see cref="Scalar"/> of equivalent magnitude.</summary>
