    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>The X-component of the <see cref="SpinAngularAcceleration3"/>.</summary>
    public SpinAngularAcceleration X => new(MagnitudeX);
    /// <summary>The Y-component of the <see cref="SpinAngularAcceleration3"/>.</summary>
    public SpinAngularAcceleration Y => new(MagnitudeY);
    /// <summary>The Z-component of the <see cref="SpinAngularAcceleration3"/>.</summary>
    public SpinAngularAcceleration Z => new(MagnitudeZ);
    ...
    public SpinAngularAcceleration3(Vector3 components) : this(components.MagnitudeX, components.MagnitudeY, components.MagnitudeZ) { }
    /// <summary>Constructs a new <see cref="SpinAngularAcceleration3"/> with components of magnitudes <paramref name="components"/>.</summary>
    /// <param name="components">The magnitudes of the components of the <see cref="SpinAngularAcceleration3"/>.</param>
    ...
    /// <see cref="SpinAngularAcceleration3"/>.</summary>
    ...
    public SpinAngularAcceleration3 Negate() => new(-MagnitudeX, -MagnitudeY, -MagnitudeZ);
    ...
    public static SpinAngularAcceleration3 operator -(SpinAngularAcceleration3 a) => new(-a.MagnitudeX, -a.MagnitudeY, -a.MagnitudeZ);
    ...
    public static Unhandled3 operator *(SpinAngularAcceleration3 a, Unhandled b) => new(a.MagnitudeX * b.Magnitude, a.MagnitudeY * b.Magnitude, a.MagnitudeZ * b.Magnitude);
    ...
    public static Unhandled3 operator *(Unhandled a, SpinAngularAcceleration3 b) => new(a.Magnitude * b.MagnitudeX, a.Magnitude * b.MagnitudeY, a.Magnitude * b.MagnitudeZ);
    ...
    public SpinAngularAcceleration3 Remainder(double divisor) => new(MagnitudeX % divisor, MagnitudeY % divisor, MagnitudeZ % divisor);
    ...
    public SpinAngularAcceleration3 Multiply(double factor) => new(MagnitudeX * factor, MagnitudeY * factor, MagnitudeZ * factor);
    /// <summary>Scales the <see cref="SpinAngularAcceleration3"/> through division by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The divisor, by which the <see cref="SpinAngularAcceleration3"/> is divided.</param>
    public SpinAngularAcceleration3 Divide(double divisor) => new(MagnitudeX / divisor, MagnitudeY / divisor, MagnitudeZ / divisor);
    /// <summary>Produces a <see cref="SpinAngularAcceleration3"/>, with each component equal to the remainder from division of the
    ...
    public static SpinAngularAcceleration3 operator %(SpinAngularAcceleration3 a, double b) => new(a.MagnitudeX % b, a.MagnitudeY % b, a.MagnitudeZ % b);
    ...
    public static SpinAngularAcceleration3 operator *(double a, SpinAngularAcceleration3 b) => new(a * b.MagnitudeX, a * b.MagnitudeY, a * b.MagnitudeZ);
    ...
    /// magnitude of the original component by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The remainder is produced from division by this value.</param>
    public SpinAngularAcceleration3 Remainder(Scalar divisor) => new(MagnitudeX % divisor.Magnitude, MagnitudeY % divisor.Magnitude, MagnitudeZ % divisor.Magnitude);
    /// <summary>Scales the <see cref="SpinAngularAcceleration3"/> by <paramref name="factor"/>.</summary>
    /// <param name="factor">The factor by which the <see cref="SpinAngularAcceleration3"/> is scaled.</param>
    public SpinAngularAcceleration3 Multiply(Scalar factor) => new(MagnitudeX * factor.Magnitude, MagnitudeY * factor.Magnitude, MagnitudeZ * factor.Magnitude);
    /// <summary>Scales the <see cref="SpinAngularAcceleration3"/> through division by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The divisor, by which the <see cref="SpinAngularAcceleration3"/> is divided.</param>
    public SpinAngularAcceleration3 Divide(Scalar divisor) => new(MagnitudeX / divisor.Magnitude, MagnitudeY / divisor.Magnitude, MagnitudeZ / divisor.Magnitude);
    /// <summary>Produces a <see cref="SpinAngularAcceleration3"/>, with each component equal to the remainder from division of the
    /// magnitude of the component of <paramref name="a"/> by <paramref name="b"/>.</summary>
    /// <param name="a">The <see cref="SpinAngularAcceleration3"/>, the components of which are divided by <paramref name="b"/> to produce a remainder.</param>
    /// <param name="b">The remainder is produced from division of <see cref="SpinAngularAcceleration3"/> <paramref name="a"/> by this value.</param>
    public static SpinAngularAcceleration3 operator %(SpinAngularAcceleration3 a, Scalar b) => new(a.MagnitudeX % b.Magnitude, a.MagnitudeY % b.Magnitude, a.MagnitudeZ % b.Magnitude);
    /// <summary>Scales the <see cref="SpinAngularAcceleration3"/> <paramref name="a"/> by <paramref name="b"/>.</summary>
    /// <param name="a">The <see cref="SpinAngularAcceleration3"/>, which is scaled by <paramref name="b"/>.</param>
    /// <param name="b">This value is used to scale the <see cref="SpinAngularAcceleration3"/> <paramref name="a"/>.</param>
    public static SpinAngularAcceleration3 operator *(SpinAngularAcceleration3 a, Scalar b) => new(a.MagnitudeX * b.Magnitude, a.MagnitudeY * b.Magnitude, a.MagnitudeZ * b.Magnitude);
    ...
    /// <param name="a">This value is used to scale the <see cref="SpinAngularAcceleration3"/> <paramref name="b"/>.</param>
    /// <param name="b">The <see cref="SpinAngularAcceleration3"/>, which is scaled by <paramref name="a"/>.</param>
    public static SpinAngularAcceleration3 operator *(Scalar a, SpinAngularAcceleration3 b) => new(a.Magnitude * b.MagnitudeX, a.Magnitude * b.MagnitudeY, a.Magnitude * b.MagnitudeZ);
    /// <summary>Scales the <see cref="SpinAngularAcceleration3"/> <paramref name="a"/> through division by <paramref name="b"/>.</summary>
    /// <param name="a">The <see cref="SpinAngularAcceleration3"/>, which is divided by <paramref name="b"/>.</param>
    /// <param name="b">This value is used to divide the <see cref="SpinAngularAcceleration3"/> <paramref name="a"/>.</param>
    public static SpinAngularAcceleration3 operator /(SpinAngularAcceleration3 a, Scalar b) => new(a.MagnitudeX / b.Magnitude, a.MagnitudeY / b.Magnitude, a.MagnitudeZ / b.Magnitude);
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(SpinAngularAcceleration3 a, IScalarQuantity b) => a.Multiply(b, (x) => new Unhandled3(x));
    ...
    /// Func{ValueTuple{double, double, double}, TProductVector3Quantity})"/>.</remarks>
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(IScalarQuantity a, SpinAngularAcceleration3 b) => b.Multiply(a, (x) => new Unhandled3(x));
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator /(SpinAngularAcceleration3 a, IScalarQuantity b) => a.Divide(b, (x) => new Unhandled3(x));
    ...
    /// values (<see cref="MagnitudeX"/>, <see cref="MagnitudeY"/>, <see cref="MagnitudeZ"/>), when expressed in SI units.</summary>
    public static explicit operator (double x, double y, double z)(SpinAngularAcceleration3 a) => (a.MagnitudeX, a.MagnitudeY, a.MagnitudeZ);
    ...
    public static explicit operator Vector3(SpinAngularAcceleration3 a) => new(a.MagnitudeX, a.MagnitudeY, a.MagnitudeZ);
