...
/// in <see cref="UnitOfSpinAngularAcceleration"/>, with the SI unit being [rad / s²].
/// <para>
...
/// </item>
/// </list>
/// The components of the measure can be retrieved as a <see cref="Vector3"/> using pre-defined properties, prefixed with 'In', followed by the desired <see cref="UnitOfSpinAngularAcceleration"/>.
/// </para>
/// </summary>
/// <remarks>
    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <param name="components">The magnitudes of the components of the <see cref="SpinAngularAcceleration3"/>, expressed in <paramref name="unitOfSpinAngularAcceleration"/>.</param>
    /// <param name="unitOfSpinAngularAcceleration">The <see cref="UnitOfSpinAngularAcceleration"/> in which the magnitudes of the components, <paramref name="components"/>, are expressed.</param>
    ...
    /// expressed in <paramref name="unitOfSpinAngularAcceleration"/>.</summary>
    /// <param name="x">The magnitude of the X-component of the <see cref="SpinAngularAcceleration3"/>, expressed in <paramref name="unitOfSpinAngularAcceleration"/>.</param>
    /// <param name="y">The magnitude of the Y-component of the <see cref="SpinAngularAcceleration3"/>, expressed in <paramref name="unitOfSpinAngularAcceleration"/>.</param>
    /// <param name="z">The magnitude of the Z-component of the <see cref="SpinAngularAcceleration3"/>, expressed in <paramref name="unitOfSpinAngularAcceleration"/>.</param>
    /// <param name="unitOfSpinAngularAcceleration">The <see cref="UnitOfSpinAngularAcceleration"/> in which the magnitudes of the components,
    ...
    /// <remarks>Consider preferring <see cref="SpinAngularAcceleration3(ValueTuple{Scalar, Scalar, Scalar}, UnitOfSpinAngularAcceleration)"/>.</remarks>
    ...
    /// <remarks>Consider preferring <see cref="SpinAngularAcceleration3(Scalar, Scalar, Scalar, UnitOfSpinAngularAcceleration)"/>.</remarks>
    public SpinAngularAcceleration3(Scalar x, Scalar y, Scalar z) : this(x.Magnitude, y.Magnitude, z.Magnitude) { }
    /// <summary>Constructs a new <see cref="SpinAngularAcceleration3"/> with components of magnitudes <paramref name="components"/>.</summary>
    /// <param name="components">The magnitudes of the components of the <see cref="SpinAngularAcceleration3"/>.</param>
    /// <remarks>Consider preferring <see cref="SpinAngularAcceleration3(Vector3, UnitOfSpinAngularAcceleration)"/>.</remarks>
    public SpinAngularAcceleration3(Vector3 components) : this(components.X, components.Y, components.Z) { }
    /// <summary>Constructs a new <see cref="SpinAngularAcceleration3"/> with components of magnitudes <paramref name="components"/>.</summary>
    /// <param name="components">The magnitudes of the components of the <see cref="SpinAngularAcceleration3"/>.</param>
    /// <remarks>Consider preferring <see cref="SpinAngularAcceleration3(ValueTuple{double, double, double}, UnitOfSpinAngularAcceleration)"/>.</remarks>
    public SpinAngularAcceleration3((double x, double y, double z) components) : this(components.x, components.y, components.z) { }
    /// <summary>Constructs a new <see cref="SpinAngularAcceleration3"/> with components of magnitudes (<paramref name="x"/>, <paramref name="y"/>, <paramref name="z"/>).</summary>
    /// <param name="x">The magnitude of the X-component of the <see cref="SpinAngularAcceleration3"/>.</param>
    /// <param name="y">The magnitude of the Y-component of the <see cref="SpinAngularAcceleration3"/>.</param>
    /// <param name="z">The magnitude of the Z-component of the <see cref="SpinAngularAcceleration3"/>.</param>
    /// <remarks>Consider preferring <see cref="SpinAngularAcceleration3(double, double, double, UnitOfSpinAngularAcceleration)"/>.</remarks>
    ...
    /// <remarks>For clarity, consider first extracting the magnitudes of the components in the desired <see cref="UnitOfSpinAngularAcceleration"/>.</remarks>
    public Scalar SquaredMagnitude() => Maths.Vectors.Dot(this, this);

    /// <summary>Normalizes the <see cref="SpinAngularAcceleration3"/> - if expressed in SI units.</summary>
    ...
    /// <summary>Computes the transformation of the existing <see cref="SpinAngularAcceleration3"/> by <paramref name="transform"/>, resulting in
    /// a new <see cref="SpinAngularAcceleration3"/>.</summary>
    ...
    /// <cref name="SpinAngularAcceleration"/>.</summary>
    ...
    /// <summary>Produces a formatted string from the magnitudes of the components of the <see cref="SpinAngularAcceleration3"/> (in SI units),
    ...
    /// <summary>Produces a <see cref="Vector3"/> with components equal to that of the <see cref="SpinAngularAcceleration3"/>,
    /// expressed in <paramref name="unitOfSpinAngularAcceleration"/>.</summary>
    /// <param name="spinAngularAcceleration3">The <see cref="SpinAngularAcceleration3"/> to be expressed in <paramref name="unitOfSpinAngularAcceleration"/>.</param>
    /// <param name="unitOfSpinAngularAcceleration">The <see cref="UnitOfSpinAngularAcceleration"/> in which the magnitude is expressed.</param>
    ...
    /// <param name="a">Unary plus is applied to this instance of <see cref="SpinAngularAcceleration3"/>.</param>
    public static SpinAngularAcceleration3 operator +(SpinAngularAcceleration3 a) => a;
    /// <summary>Negation, resulting in a <see cref="SpinAngularAcceleration3"/> with components negated from that of <paramref name="a"/>.</summary>
    /// <param name="a">Negation is applied to this instance of <see cref="SpinAngularAcceleration3"/>.</param>
    public static SpinAngularAcceleration3 operator -(SpinAngularAcceleration3 a) => new(-a.X, -a.Y, -a.Z);

    /// <summary>Multiplies the <see cref="SpinAngularAcceleration3"/> by the <see cref="Unhandled"/> quantity <paramref name="factor"/>
    ...
    /// <summary>Multiplies the <see cref="SpinAngularAcceleration3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiplies the <see cref="Unhandled"/> quantity <paramref name="b"/> by the <see cref="SpinAngularAcceleration3"/> <paramref name="a"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="SpinAngularAcceleration3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <param name="b">The remainder is retrieved from division of <see cref="SpinAngularAcceleration3"/> <paramref name="a"/> by this value.</param>
    ...
    /// <summary>Multiples the <see cref="SpinAngularAcceleration3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiples the quantity <paramref name="a"/> by the <see cref="SpinAngularAcceleration3"/> <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="SpinAngularAcceleration3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    /// <param name="a">The <see cref="SpinAngularAcceleration3"/>, which is divided by <paramref name="b"/>.</param>
    ...
    /// <summary>Converts the <see cref="SpinAngularAcceleration3"/> to a (<see langword="double"/>, <see langword="double"/>, <see langword="double"/>) with values
    ...
    /// <summary>Converts the <see cref="SpinAngularAcceleration3"/> to the <see cref="Vector3"/> with components of
    ...
    /// <summary>Converts <paramref name="a"/> to the <see cref="SpinAngularAcceleration3"/> with components of equal magnitude,
    /// when expressed in SI units.</summary>
