    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>Normalizes the <see cref="Absement3"/> - if expressed in SI units.</summary>
    ...
    /// <summary>Computes the transformation of the existing <see cref="Absement3"/> by <paramref name="transform"/>, resulting in
    /// a new <see cref="Absement3"/>.</summary>
    ...
    /// <summary>Produces a formatted string from the magnitudes of the components of the <see cref="Absement3"/> (in SI units),
    ...
    /// <param name="a">Unary plus is applied to this instance of <see cref="Absement3"/>.</param>
    public static Absement3 operator +(Absement3 a) => a;
    /// <summary>Negation, resulting in a <see cref="Absement3"/> with components negated from that of <paramref name="a"/>.</summary>
    /// <param name="a">Negation is applied to this instance of <see cref="Absement3"/>.</param>
    public static Absement3 operator -(Absement3 a) => new(-a.X, -a.Y, -a.Z);

    /// <summary>Multiplies the <see cref="Absement3"/> by the <see cref="Unhandled"/> quantity <paramref name="factor"/>
    ...
    /// <summary>Multiplies the <see cref="Absement3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiplies the <see cref="Unhandled"/> quantity <paramref name="b"/> by the <see cref="Absement3"/> <paramref name="a"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="Absement3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <param name="b">The remainder is retrieved from division of <see cref="Absement3"/> <paramref name="a"/> by this value.</param>
    ...
    /// <summary>Scales the <see cref="Absement3"/> by <paramref name="factor"/>.</summary>
    /// <param name="factor">The factor by which the <see cref="Absement3"/> is scaled.</param>
    public Absement3 Multiply(Scalar factor) => new(X * factor.Magnitude, Y * factor.Magnitude, Z * factor.Magnitude);
    /// <summary>Scales the <see cref="Absement3"/> through division by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The divisor, by which the <see cref="Absement3"/> is divided.</param>
    ...
    /// <summary>Multiples the <see cref="Absement3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiples the quantity <paramref name="a"/> by the <see cref="Absement3"/> <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="Absement3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    /// <param name="a">The <see cref="Absement3"/>, which is divided by <paramref name="b"/>.</param>
    ...
    /// <summary>Converts the <see cref="Absement3"/> to a (<see langword="double"/>, <see langword="double"/>, <see langword="double"/>) with values
    ...
    /// <summary>Converts the <see cref="Absement3"/> to the <see cref="Vector3"/> with components of
    ...
    /// <summary>Constructs the <see cref="Absement3"/> with components equal to the values of <paramref name="components"/>,
    ...
    /// <summary>Converts <paramref name="a"/> to the <see cref="Absement3"/> with components of equal magnitude,
    /// when expressed in SI units.</summary>
