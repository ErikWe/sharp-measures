...
/// <list type="bullet">
/// <item>
/// <code><see cref="KineticEnergy"/> a = 3 * <see cref="KineticEnergy.OneJoule"/>;</code>
/// </item>
/// <item>
    ...
    IGenericallyDivisibleScalarQuantity
{
    ...
    /// <summary>Division of the <see cref="Unhandled"/> quantity <paramref name="x"/> by the <see cref="KineticEnergy"/> <paramref name="y"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    /// <param name="x">The <see cref="Unhandled"/> quantity, which is divided by the <see cref="KineticEnergy"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="KineticEnergy"/> by which the <see cref="Unhandled"/> quantity <paramref name="x"/> is divided.</param>
    public static Unhandled operator /(Unhandled x, KineticEnergy y) => new(x.Magnitude / y.Magnitude);
