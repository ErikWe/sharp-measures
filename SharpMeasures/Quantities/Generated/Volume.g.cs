...
/// <list type="bullet">
/// <item>
/// <code><see cref="Volume"/> a = 3 * <see cref="Volume.OneLitre"/>;</code>
/// </item>
/// <item>
/// <code><see cref="Volume"/> d = <see cref="Volume.From(Mass, Density)"/>;</code>
/// </item>
/// </list>
    ...
    IGenericallyDivisibleScalarQuantity
{
    ...
    /// <summary>Division of the <see cref="Unhandled"/> quantity <paramref name="x"/> by the <see cref="Volume"/> <paramref name="y"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    /// <param name="x">The <see cref="Unhandled"/> quantity, which is divided by the <see cref="Volume"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="Volume"/> by which the <see cref="Unhandled"/> quantity <paramref name="x"/> is divided.</param>
    public static Unhandled operator /(Unhandled x, Volume y) => new(x.Magnitude / y.Magnitude);
