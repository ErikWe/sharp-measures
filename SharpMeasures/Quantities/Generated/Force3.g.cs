...
/// <item>
/// <code>
/// <see cref="Force3"/> e = <see cref="Weight3.AsForce3"/>;
/// </code>
/// </item>
/// </list>
    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>Scales the <see cref="Force3"/> by <paramref name="factor"/>.</summary>
    /// <param name="factor">The factor by which the <see cref="Force3"/> is scaled.</param>
    public Force3 Multiply(Scalar factor) => new(X * factor.Magnitude, Y * factor.Magnitude, Z * factor.Magnitude);
    /// <summary>Scales the <see cref="Force3"/> through division by <paramref name="divisor"/>.</summary>
    /// <param name="divisor">The divisor, by which the <see cref="Force3"/> is divided.</param>
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(Force3 a, IScalarQuantity b) => a.Multiply(b, (x, y, z) => new Unhandled3(x, y, z));
    ...
    /// Func{double, double, double, TProductVector3Quantity})"/>.</remarks>
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(IScalarQuantity a, Force3 b) => b.Multiply(a, (x, y, z) => new Unhandled3(x, y, z));
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator /(Force3 a, IScalarQuantity b) => a.Divide(b, (x, y, z) => new Unhandled3(x, y, z));
