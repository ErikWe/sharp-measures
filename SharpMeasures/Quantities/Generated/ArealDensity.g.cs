...
/// <list type="bullet">
/// <item>
/// <code><see cref="ArealDensity"/> a = 3 * <see cref="ArealDensity.OneKilogramPerSquareMetre"/>;</code>
/// </item>
/// <item>
/// <code><see cref="ArealDensity"/> d = <see cref="ArealDensity.From(Mass, Area)"/>;</code>
/// </item>
/// </list>
    ...
    IGenericallyDivisibleScalarQuantity
{
    ...
    /// <summary>Division of the <see cref="Unhandled"/> quantity <paramref name="x"/> by the <see cref="ArealDensity"/> <paramref name="y"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    /// <param name="x">The <see cref="Unhandled"/> quantity, which is divided by the <see cref="ArealDensity"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="ArealDensity"/> by which the <see cref="Unhandled"/> quantity <paramref name="x"/> is divided.</param>
    public static Unhandled operator /(Unhandled x, ArealDensity y) => new(x.Magnitude / y.Magnitude);
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled operator *(ArealDensity x, IScalarQuantity y) => x.Multiply(y, (m) => new Unhandled(m));
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled operator /(ArealDensity x, IScalarQuantity y) => x.Divide(y, (m) => new Unhandled(m));
