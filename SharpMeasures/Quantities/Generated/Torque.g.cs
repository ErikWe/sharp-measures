    ...
    IVector3MultiplicableScalarQuantity<Torque3, Vector3>
{
    ...
    /// <summary>Produces a formatted string from the magnitude of the <see cref="Torque"/> (in SI units), and the SI base unit of the quantity.</summary>
    ...
    public static Unhandled operator *(Torque x, IScalarQuantity y) => x.Multiply<Unhandled, IScalarQuantity>(y, (m) => new Unhandled(m));
    ...
    public static Unhandled operator /(Torque x, IScalarQuantity y) => x.Divide<Unhandled, IScalarQuantity>(y, (m) => new Unhandled(m));
    ...
    /// <summary>Multiplies the <see cref="Torque"/> with the values of <paramref name="components"/> to produce a <see cref="Torque3"/>.</summary>
    ...
    /// <summary>Multiplies the <see cref="Torque"/> <paramref name="a"/> with the values of <paramref name="b"/> to produce a <see cref="Torque3"/>.</summary>
    ...
    /// <summary>Multiplies the <see cref="Torque"/> <parmref name="b"/> with the values of <paramref name="a"/> to produce a <see cref="Torque3"/>.</summary>
    ...
    /// <summary>Converts <paramref name="x"/> to the <see cref="Torque"/> of magnitude <paramref name="x"/>, when expressed
    /// in SI units.</summary>
    ...
    /// <summary>Converts <paramref name="x"/> to the <see cref="Torque"/> of equivalent magnitude, when expressed in SI units.</summary>
