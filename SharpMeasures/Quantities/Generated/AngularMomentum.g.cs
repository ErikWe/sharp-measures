    ...
    IVector3MultiplicableScalarQuantity<AngularMomentum3, Vector3>
{
    ...
    /// <summary>Retrieves the magnitude of the <see cref="AngularMomentum"/>, expressed in <see cref="UnitOfAngularMomentum.KilogramMetreSquaredPerSecond"/>.</summary>
    public Scalar KilogramMetresSquaredPerSecond => InUnit(UnitOfAngularMomentum.KilogramMetreSquaredPerSecond);
    ...
    /// <summary>Produces a formatted string from the magnitude of the <see cref="AngularMomentum"/> (in SI units), and the SI base unit of the quantity.</summary>
    ...
    public static Unhandled operator *(AngularMomentum x, IScalarQuantity y) => x.Multiply<Unhandled, IScalarQuantity>(y, (m) => new Unhandled(m));
    ...
    public static Unhandled operator /(AngularMomentum x, IScalarQuantity y) => x.Divide<Unhandled, IScalarQuantity>(y, (m) => new Unhandled(m));
    ...
    /// <summary>Multiplies the <see cref="AngularMomentum"/> with the values of <paramref name="components"/> to produce a <see cref="AngularMomentum3"/>.</summary>
    ...
    /// <summary>Multiplies the <see cref="AngularMomentum"/> <paramref name="a"/> with the values of <paramref name="b"/> to produce a <see cref="AngularMomentum3"/>.</summary>
    ...
    /// <summary>Multiplies the <see cref="AngularMomentum"/> <parmref name="b"/> with the values of <paramref name="a"/> to produce a <see cref="AngularMomentum3"/>.</summary>
    ...
    /// <summary>Converts <paramref name="x"/> to the <see cref="AngularMomentum"/> of magnitude <paramref name="x"/>, when expressed
    /// in SI units.</summary>
    ...
    /// <summary>Converts <paramref name="x"/> to the <see cref="AngularMomentum"/> of equivalent magnitude, when expressed in SI units.</summary>
