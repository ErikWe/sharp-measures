...
/// <list type="bullet">
/// <item>
/// <code><see cref="AngularMomentum"/> a = 3 * <see cref="AngularMomentum.OneKilogramSquareMetrePerSecond"/>;</code>
/// </item>
/// <item>
    ...
    IVector3MultiplicableScalarQuantity<AngularMomentum3, Vector3>
{
    ...
    /// <summary>Division of the <see cref="Unhandled"/> quantity <paramref name="x"/> by the <see cref="AngularMomentum"/> <paramref name="y"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    /// <param name="x">The <see cref="Unhandled"/> quantity, which is divided by the <see cref="AngularMomentum"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="AngularMomentum"/> by which the <see cref="Unhandled"/> quantity <paramref name="x"/> is divided.</param>
    public static Unhandled operator /(Unhandled x, AngularMomentum y) => new(x.Magnitude / y.Magnitude);
