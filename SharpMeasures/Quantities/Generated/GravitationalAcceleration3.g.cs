...
/// <para>
/// New instances of <see cref="GravitationalAcceleration3"/> can be constructed by multiplying a <see cref="GravitationalAcceleration"/> with a Vector3 or (double, double, double).
...
/// <item>
/// <code>
/// <see cref="GravitationalAcceleration3"/> a = (3, 5, 7) * <see cref="GravitationalAcceleration.OneStandardGravity"/>;
/// </code>
/// </item>
/// <item>
/// <code>
...
/// <item>
/// <code>
/// <see cref="GravitationalAcceleration3"/> e = <see cref="Acceleration3.AsGravitationalAcceleration3"/>;
/// </code>
/// </item>
/// </list>
/// The components of the measure can be retrieved as a <see cref="Vector3"/> using pre-defined properties, prefixed with 'In', followed by the desired <see cref="UnitOfAcceleration"/>.
/// </para>
/// </summary>
/// <remarks>
    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>Normalizes the <see cref="GravitationalAcceleration3"/> - if expressed in SI units.</summary>
    ...
    /// <summary>Computes the transformation of the existing <see cref="GravitationalAcceleration3"/> by <paramref name="transform"/>, resulting in
    /// a new <see cref="GravitationalAcceleration3"/>.</summary>
    ...
    /// <cref name="GravitationalAcceleration"/>.</summary>
    ...
    /// <summary>Produces a formatted string from the magnitudes of the components of the <see cref="GravitationalAcceleration3"/> (in SI units),
    ...
    /// <param name="a">Unary plus is applied to this instance of <see cref="GravitationalAcceleration3"/>.</param>
    public static GravitationalAcceleration3 operator +(GravitationalAcceleration3 a) => a;
    /// <summary>Negation, resulting in a <see cref="GravitationalAcceleration3"/> with components negated from that of <paramref name="a"/>.</summary>
    /// <param name="a">Negation is applied to this instance of <see cref="GravitationalAcceleration3"/>.</param>
    public static GravitationalAcceleration3 operator -(GravitationalAcceleration3 a) => new(-a.X, -a.Y, -a.Z);

    /// <summary>Multiplies the <see cref="GravitationalAcceleration3"/> by the <see cref="Unhandled"/> quantity <paramref name="factor"/>
    ...
    /// <summary>Multiplies the <see cref="GravitationalAcceleration3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiplies the <see cref="Unhandled"/> quantity <paramref name="b"/> by the <see cref="GravitationalAcceleration3"/> <paramref name="a"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="GravitationalAcceleration3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <param name="b">The remainder is retrieved from division of <see cref="GravitationalAcceleration3"/> <paramref name="a"/> by this value.</param>
    ...
    /// <summary>Multiples the <see cref="GravitationalAcceleration3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiples the quantity <paramref name="a"/> by the <see cref="GravitationalAcceleration3"/> <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="GravitationalAcceleration3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    /// <param name="a">The <see cref="GravitationalAcceleration3"/>, which is divided by <paramref name="b"/>.</param>
    ...
    /// <summary>Converts the <see cref="GravitationalAcceleration3"/> to a (<see langword="double"/>, <see langword="double"/>, <see langword="double"/>) with values
    ...
    /// <summary>Converts the <see cref="GravitationalAcceleration3"/> to the <see cref="Vector3"/> with components of
    ...
    /// <summary>Converts <paramref name="a"/> to the <see cref="GravitationalAcceleration3"/> with components of equal magnitude,
    /// when expressed in SI units.</summary>
