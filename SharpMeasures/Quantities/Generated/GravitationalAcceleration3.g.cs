...
/// <list type="bullet">
/// <item>
/// <code><see cref="GravitationalAcceleration3"/> a = (3, 5, 7) * <see cref="GravitationalAcceleration.OneMetrePerSecondSquared"/>;</code>
/// </item>
/// <item>
/// <code><see cref="GravitationalAcceleration3"/> d = <see cref="GravitationalAcceleration3.From(Weight3, Mass)"/>; </code>
/// </item>
/// </list>
    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>Retrieves the magnitudes of the components of the <see cref="GravitationalAcceleration3"/>, expressed in <see cref="UnitOfAcceleration.KilometrePerHourPerSecond"/>.</summary>
    public Vector3 KilometresPerHourPerSecond => InUnit(UnitOfAcceleration.KilometrePerHourPerSecond);
    /// <summary>Retrieves the magnitudes of the components of the <see cref="GravitationalAcceleration3"/>, expressed in <see cref="UnitOfAcceleration.MilePerHourPerSecond"/>.</summary>
    ...
    /// <see cref="GravitationalAcceleration3"/>.</summary>
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(GravitationalAcceleration3 a, IScalarQuantity b) => a.Multiply(b, (x) => new Unhandled3(x));
    ...
    /// Func{ValueTuple{double, double, double}, TProductVector3Quantity})"/>.</remarks>
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled3 operator *(IScalarQuantity a, GravitationalAcceleration3 b) => b.Multiply(a, (x) => new Unhandled3(x));
