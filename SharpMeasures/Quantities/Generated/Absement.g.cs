    ...
    IVector3MultiplicableScalarQuantity<Absement3, Vector3>
{
    ...
    /// <summary>Division of the <see cref="Unhandled"/> quantity <paramref name="x"/> by the <see cref="Absement"/> <paramref name="y"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    /// <param name="x">The <see cref="Unhandled"/> quantity, which is divided by the <see cref="Absement"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="Absement"/> by which the <see cref="Unhandled"/> quantity <paramref name="x"/> is divided.</param>
    public static Unhandled operator /(Unhandled x, Absement y) => new(x.Magnitude / y.Magnitude);
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled operator *(Absement x, IScalarQuantity y) => x.Multiply(y, (m) => new Unhandled(m));
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled operator /(Absement x, IScalarQuantity y) => x.Divide(y, (m) => new Unhandled(m));
