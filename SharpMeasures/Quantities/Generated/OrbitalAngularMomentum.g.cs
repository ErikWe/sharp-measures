...
/// <list type="bullet">
/// <item>
/// <code><see cref="OrbitalAngularMomentum"/> a = 3 * <see cref="OrbitalAngularMomentum.OneKilogramSquareMetrePerSecond"/>;</code>
/// </item>
/// <item>
/// <code><see cref="OrbitalAngularMomentum"/> d = <see cref="OrbitalAngularMomentum.From(MomentOfInertia, OrbitalAngularSpeed)"/>;</code>
/// </item>
/// <item>
/// <code><see cref="OrbitalAngularMomentum"/> e = <see cref="AngularMomentum.AsOrbitalAngularMomentum"/>;</code>
/// </item>
/// </list>
    ...
    IVector3MultiplicableScalarQuantity<OrbitalAngularMomentum3, Vector3>
{
    ...
    /// <summary>Division of the <see cref="Unhandled"/> quantity <paramref name="x"/> by the <see cref="OrbitalAngularMomentum"/> <paramref name="y"/> -
    /// resulting in an <see cref="Unhandled"/> quantity.</summary>
    /// <param name="x">The <see cref="Unhandled"/> quantity, which is divided by the <see cref="OrbitalAngularMomentum"/> <paramref name="y"/>.</param>
    /// <param name="y">The <see cref="OrbitalAngularMomentum"/> by which the <see cref="Unhandled"/> quantity <paramref name="x"/> is divided.</param>
    public static Unhandled operator /(Unhandled x, OrbitalAngularMomentum y) => new(x.Magnitude / y.Magnitude);
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled operator *(OrbitalAngularMomentum x, IScalarQuantity y) => x.Multiply(y, (m) => new Unhandled(m));
    ...
    /// <exception cref="ArgumentNullException"/>
    public static Unhandled operator /(OrbitalAngularMomentum x, IScalarQuantity y) => x.Divide(y, (m) => new Unhandled(m));
