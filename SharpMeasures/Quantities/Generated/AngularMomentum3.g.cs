...
/// <item>
/// <code>
/// <see cref="AngularMomentum3"/> a = (3, 5, 7) * <see cref="AngularMomentum.OneKilogramMetreSquaredPerSecond"/>;
/// </code>
/// </item>
/// <item>
/// <code>
/// <see cref="#Param:quantity"/> d = <see cref="AngularMomentum3.From(MomentOfInertia, AngularVelocity3)"/>;
/// </code>
/// </item>
/// <item>
/// <code>
/// <see cref="AngularMomentum3"/> e = <see cref="SpinAngularMomentum3.AsAngularMomentum3"/>;
/// </code>
/// </item>
/// </list>
/// The components of the measure can be retrieved as a <see cref="Vector3"/> using pre-defined properties, prefixed with 'In', followed by the desired <see cref="UnitOfAngularMomentum"/>.
/// </para>
/// </summary>
/// <remarks>
    ...
    IGenericallyCrossableVector3Quantity
{
    ...
    /// <summary>Converts the <see cref="AngularMomentum3"/> to an instance of the associated quantity <see cref="OrbitalAngularMomentum"/>, with components of
    /// equal magnitudes.</summary>
    public OrbitalAngularMomentum3 AsOrbitalAngularMomentum3() => new(X, Y, Z);
    /// <summary>Converts the <see cref="AngularMomentum3"/> to an instance of the associated quantity <see cref="SpinAngularMomentum"/>, with components of
    /// equal magnitudes.</summary>
    public SpinAngularMomentum3 AsSpinAngularMomentum3() => new(X, Y, Z);

    /// <summary>Retrieves the magnitudes of the components of the <see cref="AngularMomentum3"/>, expressed in <see cref="UnitOfAngularMomentum.KilogramMetreSquaredPerSecond"/>.</summary>
    ...
    /// <summary>Normalizes the <see cref="AngularMomentum3"/> - if expressed in SI units.</summary>
    ...
    /// <summary>Computes the transformation of the existing <see cref="AngularMomentum3"/> by <paramref name="transform"/>, resulting in
    /// a new <see cref="AngularMomentum3"/>.</summary>
    ...
    /// <cref name="AngularMomentum"/>.</summary>
    ...
    /// <cref see="AngularMomentum3"/>.</summary>
    ...
    /// <summary>Produces a formatted string from the magnitudes of the components of the <see cref="AngularMomentum3"/> (in SI units),
    ...
    /// <param name="a">Unary plus is applied to this instance of <see cref="AngularMomentum3"/>.</param>
    public static AngularMomentum3 operator +(AngularMomentum3 a) => a;
    /// <summary>Negation, resulting in a <see cref="AngularMomentum3"/> with components negated from that of <paramref name="a"/>.</summary>
    /// <param name="a">Negation is applied to this instance of <see cref="AngularMomentum3"/>.</param>
    public static AngularMomentum3 operator -(AngularMomentum3 a) => new(-a.X, -a.Y, -a.Z);

    /// <summary>Multiplies the <see cref="AngularMomentum3"/> by the <see cref="Unhandled"/> quantity <paramref name="factor"/>
    ...
    /// <summary>Multiplies the <see cref="AngularMomentum3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiplies the <see cref="Unhandled"/> quantity <paramref name="b"/> by the <see cref="AngularMomentum3"/> <paramref name="a"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="AngularMomentum3"/> <paramref name="a"/> by the <see cref="Unhandled"/> quantity <paramref name="b"/> -
    /// resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <param name="b">The remainder is retrieved from division of <see cref="AngularMomentum3"/> <paramref name="a"/> by this value.</param>
    ...
    /// <summary>Multiples the <see cref="AngularMomentum3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Multiples the quantity <paramref name="a"/> by the <see cref="AngularMomentum3"/> <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    ...
    /// <summary>Divides the <see cref="AngularMomentum3"/> <paramref name="a"/> by the quantity <paramref name="b"/>
    /// - resulting in an <see cref="Unhandled3"/> quantity.</summary>
    /// <param name="a">The <see cref="AngularMomentum3"/>, which is divided by <paramref name="b"/>.</param>
    ...
    /// <summary>Converts the <see cref="AngularMomentum3"/> to a (<see langword="double"/>, <see langword="double"/>, <see langword="double"/>) with values
    ...
    /// <summary>Converts the <see cref="AngularMomentum3"/> to the <see cref="Vector3"/> with components of
    ...
    /// <summary>Constructs the <see cref="AngularMomentum3"/> with components equal to the values of <paramref name="components"/>,
    ...
    /// <summary>Converts <paramref name="a"/> to the <see cref="AngularMomentum3"/> with components of equal magnitude,
    /// when expressed in SI units.</summary>
