...
/// This is the magnitude of the vector quantity <see cref="SpecificAngularMomentum3"/>, and is expressed in <see cref="UnitOfSpecificAngularMomentum"/>, with the SI unit being [m^2 / s].
/// <para>
...
/// </item>
/// </list>
/// The magnitude of the measure can be retrieved using pre-defined properties, prefixed with 'In', followed by the desired <see cref="UnitOfSpecificAngularMomentum"/>.
/// </para>
/// </summary>
    ...
    IVector3MultiplicableScalarQuantity<SpecificAngularMomentum3, Vector3>
{
    ...
    /// <summary>Constructs a new <see cref="SpecificAngularMomentum"/>, with magnitude <paramref name="magnitude"/> in <see cref="UnitOfSpecificAngularMomentum"/> <paramref name="unitOfSpecificAngularMomentum"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="SpecificAngularMomentum"/>, in <see cref="UnitOfSpecificAngularMomentum"/> <paramref name="unitOfSpecificAngularMomentum"/>.</param>
    ...
    /// <remarks>Consider preffering a constructor that requires a <see cref="UnitOfSpecificAngularMomentum"/> to be specified.</remarks>
    public SpecificAngularMomentum(Scalar magnitude) : this(magnitude.Magnitude) { }
    /// <summary>Constructs a new <see cref="SpecificAngularMomentum"/>, with magnitude <paramref name="magnitude"/>.</summary>
    /// <param name="magnitude">The magnitude of the <see cref="SpecificAngularMomentum"/>.</param>
    /// <remarks>Consider preferring a constructor that requires a <see cref="UnitOfSpecificAngularMomentum"/> to be specified.</remarks>
    ...
    /// <summary>Produces a <see cref="Scalar"/> with magnitude equal to that of the <see cref="SpecificAngularMomentum"/>, expressed in <see cref="UnitOfSpecificAngularMomentum"/>
    /// <paramref name="unitOfSpecificAngularMomentum"/>.</summary>
    ...
    /// <summary>Produces a <see cref="Scalar"/> from the magnitude of a <see cref="SpecificAngularMomentum"/>, expressed in <see cref="UnitOfSpecificAngularMomentum"/>
    /// <paramref name="unitOfSpecificAngularMomentum"/>.</summary>
    /// <param name="specificAngularMomentum">The <see cref="SpecificAngularMomentum"/> to be expressed in <see cref="UnitOfSpecificAngularMomentum"/> <paramref name="unitOfSpecificAngularMomentum"/>.</param>
    /// <param name="unitOfSpecificAngularMomentum">The <see cref="UnitOfSpecificAngularMomentum"/> in which the magnitude is expressed.</param>
    ...
    /// <summary>Multiplies the <see cref="SpecificAngularMomentum"/> with the <see cref="ValueTuple"/> <paramref name="components"/> to produce a <see cref="SpecificAngularMomentum3"/>.</summary>
    /// <param name="components">This <see cref="ValueTuple"/> is multiplied by the <see cref="SpecificAngularMomentum"/>.</param>
    ...
    /// <summary>Multiplies the <see cref="SpecificAngularMomentum"/> <parmref name="b"/> with the <see cref="ValueTuple"/> <paramref name="a"/> to produce a <see cref="SpecificAngularMomentum3"/>.</summary>
    ...
    /// <summary>Converts the <see cref="SpecificAngularMomentum"/> to a <see cref="double"/> with value <see cref="Magnitude"/>.</summary>
    public double ToDouble() => Magnitude;
    /// <summary>Converts the <see cref="SpecificAngularMomentum"/> to a <see cref="double"/> based on the magnitude of the <see cref="SpecificAngularMomentum"/> <paramref name="x"/>.</summary>
    public static implicit operator double(SpecificAngularMomentum x) => x.ToDouble();

    /// <summary>Converts the <see cref="SpecificAngularMomentum"/> to the <see cref="Scalar"/> of equivalent magnitude.</summary>
