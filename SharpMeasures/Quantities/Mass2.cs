...
{
    public class Mass2 : IEquatable<Mass2>, IQuantity2
    {
        public Mass X { get; }
        public Mass Y { get; }
        ...
        public static bool operator ==(Mass2? a, Mass2? b)
        {
            if (a is null)
            {
                return b is null;
        ...
        public static UnhandledQuantity2 operator *(Mass2 a, IQuantity2 b) => new((a.X * b.X).Magnitude, (a.Y * b.Y).Magnitude);
        public static UnhandledQuantity2 operator /(Mass2 a, IQuantity2 b) => new((a.X / b.X).Magnitude, (a.Y / b.Y).Magnitude);
