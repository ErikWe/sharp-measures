...
{
    /// <summary>Computes <see cref="TranslationalKineticEnergy"/> according to { <see cref="TranslationalKineticEnergy"/>
    /// = 1/2 ∗ <paramref name="mass"/> ∗ <paramref name="speed"/>² }.</summary>
