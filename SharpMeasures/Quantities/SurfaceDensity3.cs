...
{
    public class SurfaceDensity3 : IEquatable<SurfaceDensity3>, IQuantity3<SurfaceDensity>
    {
        ...
        public override bool Equals(object? obj) => Equals(obj as SurfaceDensity3);
        ...
        public static bool operator ==(SurfaceDensity3? a, SurfaceDensity3? b) => a?.Equals(b) ?? b is null;
        ...
        public static UnhandledQuantity3 operator *(SurfaceDensity3 a, IQuantity3 b) => new(a.X * b.XMagnitude, a.Y * b.YMagnitude, a.Z * b.ZMagnitude);
        public static UnhandledQuantity3 operator /(SurfaceDensity3 a, IQuantity3 b) => new(a.X / b.XMagnitude, a.Y / b.YMagnitude, a.Z / b.ZMagnitude);
