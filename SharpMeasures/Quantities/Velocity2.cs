...
{
    public class Velocity2 : IEquatable<Velocity2>, IQuantity2<Velocity>
    {
        ...
        public override bool Equals(object? obj) => Equals(obj as Velocity2);

        public override int GetHashCode() => (X, Y).GetHashCode();
        public override string ToString() => $"({X.MetresPerSecond}, {Y.MetresPerSecond}) [m/s]";

        public static bool operator ==(Velocity2? a, Velocity2? b) => a?.Equals(b) ?? b is null;
        ...
        public static UnhandledQuantity2 operator *(Velocity2 a, IQuantity2 b) => new(a.X * b.XMagnitude, a.Y * b.YMagnitude);
        public static UnhandledQuantity2 operator /(Velocity2 a, IQuantity2 b) => new(a.X / b.XMagnitude, a.Y / b.YMagnitude);
