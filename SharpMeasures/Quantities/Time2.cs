...
{
    public class Time2 : IEquatable<Time2>, IQuantity2<Time>
    {
        public Time X { get; }
        public Time Y { get; }
        ...
        public override bool Equals(object? obj) => Equals(obj as Time2);

        public override int GetHashCode() => (X, Y).GetHashCode();
        public override string ToString() => $"({X.Seconds}, {Y.Seconds}) [s]";

        public static bool operator ==(Time2? a, Time2? b) => a?.Equals(b) ?? b is null;
        ...
        public static UnhandledQuantity2 operator *(Time2 a, IQuantity2 b) => new(a.X * b.XMagnitude, a.Y * b.YMagnitude);
        public static UnhandledQuantity2 operator /(Time2 a, IQuantity2 b) => new(a.X / b.XMagnitude, a.Y / b.YMagnitude);
