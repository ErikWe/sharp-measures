...
{
    public class Density2 : IEquatable<Density2>, IQuantity2<Density>
    {
        ...
        public override bool Equals(object? obj) => Equals(obj as Density2);

        public override int GetHashCode() => (X, Y).GetHashCode();
        public override string ToString() => $"({X.KilogramsPerCubicMetre}, {Y.KilogramsPerCubicMetre}) [kg/(m^3)]";

        public static bool operator ==(Density2? a, Density2? b) => a?.Equals(b) ?? b is null;
        ...
        public static UnhandledQuantity2 operator *(Density2 a, IQuantity2 b) => new(a.X * b.XMagnitude, a.Y * b.YMagnitude);
        public static UnhandledQuantity2 operator /(Density2 a, IQuantity2 b) => new(a.X / b.XMagnitude, a.Y / b.YMagnitude);
