...
{
    /// <summary>Computes average <see cref="SpinAngularAcceleration"/> according to { <see cref="SpinAngularAcceleration"/>
    /// = <paramref name="spinAngularSpeed"/> / <paramref name="time"/> }, where <paramref name="spinAngularSpeed"/> is the change in
