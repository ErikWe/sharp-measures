    ...
    composeToVectorText(scalar) {
        ...
        if (Array.isArray(scalar.vectorDimensionalities)) {
            for (let dimensionality of scalar.vectorDimensionalities) {
                ...
                let doubleTupleDefinition = '';
                let scalarTupleDefinition = '';
                for (let componentName of (0, Utility_1.getVectorComponentNames)(dimensionality)) {
                    doubleTupleDefinition += 'double ' + (0, Utility_1.lowerCase)(componentName) + ', ';
                    scalarTupleDefinition += 'Scalar ' + (0, Utility_1.lowerCase)(componentName) + ', ';
                }
...
//# sourceMappingURL=ScalarGenerator.js.map